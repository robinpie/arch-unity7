...
G_DEFINE_TYPE_WITH_PRIVATE (GsdBGSlideShow, gsd_bg_slide_show, G_TYPE_OBJECT)

static void
gsd_bg_slide_show_set_property (GObject       *object,
                                  guint          property_id,
                                  const GValue  *value,
                                  GParamSpec    *pspec)
{
        ...
        g_assert (GSD_BG_IS_SLIDE_SHOW (object));

        self = GSD_BG_SLIDE_SHOW (object);
...
static void
gsd_bg_slide_show_get_property (GObject     *object,
                                  guint        property_id,
                                  GValue      *value,
                                  GParamSpec  *pspec)
{
...
static void
gsd_bg_slide_show_finalize (GObject *object)
{
        GsdBGSlideShow *self;
...
static void
gsd_bg_slide_show_class_init (GsdBGSlideShowClass *self_class)
{
        GObjectClass *gobject_class;

        gobject_class = G_OBJECT_CLASS (self_class);

        gobject_class->get_property = gsd_bg_slide_show_get_property;
        gobject_class->set_property = gsd_bg_slide_show_set_property;
        gobject_class->finalize = gsd_bg_slide_show_finalize;
...
static void
gsd_bg_slide_show_init (GsdBGSlideShow *self)
{
        self->priv = gsd_bg_slide_show_get_instance_private (self);
 ...
 *
 * Return value: the new #GsdBGSlideShow
 **/
GsdBGSlideShow *
gsd_bg_slide_show_new (const char *filename)
{
	GFile *file;
	GsdBGSlideShow *self;
	...
	file = g_file_new_for_path (filename);
        ...
        self = GSD_BG_SLIDE_SHOW (g_object_new (GSD_BG_TYPE_SLIDE_SHOW,
                                                  "file", file,
                                                  NULL));
	g_object_unref (file);
...
static gboolean stack_is (GsdBGSlideShow *self, const char *s1, ...);
...
/**
 * gsd_bg_slide_show_get_current_slide:
 * @self: a #GsdBGSlideShow
 * @width: monitor width
 ...
 **/
void
gsd_bg_slide_show_get_current_slide (GsdBGSlideShow  *self,
                                       int                width,
                                       int                height,
                                       gdouble           *progress,
                                       double            *duration,
 ...
 **/
gboolean
gsd_bg_slide_show_get_slide (GsdBGSlideShow  *self,
                               int                frame_number,
                               int                width,
                               int                height,
                               double            *progress,
...
static gboolean
parse_file_contents (GsdBGSlideShow  *self,
                     const char        *contents,
                     gsize              len,
                     GError           **error)
{
 ...
 **/
gboolean
gsd_bg_slide_show_load (GsdBGSlideShow  *self,
                          GError           **error)
{
        char  *contents;
        gsize  length;
 ...
 **/
void
gsd_bg_slide_show_load_async (GsdBGSlideShow    *self,
...
/**
 * gsd_bg_slide_show_get_start_time:
 * @self: a #GsdBGSlideShow
 *
 ...
 **/
double
gsd_bg_slide_show_get_start_time (GsdBGSlideShow *self)
{
        return self->priv->start_time;
}

/**
 * gsd_bg_slide_show_get_total_duration:
 * @self: a #GsdBGSlideShow
 *
 ...
 **/
double
gsd_bg_slide_show_get_total_duration (GsdBGSlideShow *self)
{
        return self->priv->total_duration;
}

/**
 * gsd_bg_slide_show_get_has_multiple_sizes:
 * @self: a #GsdBGSlideShow
 *
 ...
 **/
gboolean
gsd_bg_slide_show_get_has_multiple_sizes (GsdBGSlideShow *self)
{
        return self->priv->has_multiple_sizes;
}

/**
 * gsd_bg_slide_show_get_num_slides:
 * @self: a #GsdBGSlideShow
 *
 * Returns number of slides in slide show
 **/
int
gsd_bg_slide_show_get_num_slides (GsdBGSlideShow *self)
{
