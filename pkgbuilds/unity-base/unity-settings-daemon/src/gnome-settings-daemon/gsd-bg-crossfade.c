...
G_DEFINE_TYPE_WITH_PRIVATE (GsdBGCrossfade, gsd_bg_crossfade, G_TYPE_OBJECT)

static void
gsd_bg_crossfade_set_property (GObject      *object,
				 guint         property_id,
				 const GValue *value,
				 GParamSpec   *pspec)
{
	...
	g_assert (GSD_IS_BG_CROSSFADE (object));

	fade = GSD_BG_CROSSFADE (object);
...
static void
gsd_bg_crossfade_get_property (GObject    *object,
			     guint       property_id,
			     GValue     *value,
			     GParamSpec *pspec)
{
...
static void
gsd_bg_crossfade_finalize (GObject *object)
{
	GsdBGCrossfade *fade;

	fade = GSD_BG_CROSSFADE (object);

	gsd_bg_crossfade_stop (fade);
...
static void
gsd_bg_crossfade_class_init (GsdBGCrossfadeClass *fade_class)
{
	GObjectClass *gobject_class;

	gobject_class = G_OBJECT_CLASS (fade_class);

	gobject_class->get_property = gsd_bg_crossfade_get_property;
	gobject_class->set_property = gsd_bg_crossfade_set_property;
	gobject_class->finalize = gsd_bg_crossfade_finalize;

	/**
	 * GsdBGCrossfade:width:
	 *
	...
	/**
	 * GsdBGCrossfade::finished:
	 * @fade: the #GsdBGCrossfade that received the signal
...
static void
gsd_bg_crossfade_init (GsdBGCrossfade *fade)
{
	fade->priv = gsd_bg_crossfade_get_instance_private (fade);
 ...
 *
 * Return value: the new #GsdBGCrossfade
 **/
GsdBGCrossfade *
gsd_bg_crossfade_new (int width,
			int height)
{
	GObject *object;

	object = g_object_new (GSD_TYPE_BG_CROSSFADE,
			       "width", width,
			       "height", height, NULL);

	return (GsdBGCrossfade *) object;
}
...
/**
 * gsd_bg_crossfade_set_start_surface:
 * @fade: a #GsdBGCrossfade
 * @surface: The cairo surface to fade from
 *
 * Before initiating a crossfade with gsd_bg_crossfade_start()
 ...
 **/
gboolean
gsd_bg_crossfade_set_start_surface (GsdBGCrossfade *fade,
				      cairo_surface_t  *surface)
{
	g_return_val_if_fail (GSD_IS_BG_CROSSFADE (fade), FALSE);
...
/**
 * gsd_bg_crossfade_set_end_surface:
 * @fade: a #GsdBGCrossfade
 ...
 **/
gboolean
gsd_bg_crossfade_set_end_surface (GsdBGCrossfade *fade,
				    cairo_surface_t  *surface)
{
	g_return_val_if_fail (GSD_IS_BG_CROSSFADE (fade), FALSE);
...
static gboolean
animations_are_disabled (GsdBGCrossfade *fade)
{
...
static void
send_root_property_change_notification (GsdBGCrossfade *fade)
{
...
static void
draw_background (GsdBGCrossfade *fade)
{
...
static void
on_finished (GsdBGCrossfade *fade)
{
        cairo_pattern_t *pattern;
 ...
 **/
void
gsd_bg_crossfade_stop (GsdBGCrossfade *fade)
{
	g_return_if_fail (GSD_IS_BG_CROSSFADE (fade));

	if (!gsd_bg_crossfade_is_started (fade))
		return;
