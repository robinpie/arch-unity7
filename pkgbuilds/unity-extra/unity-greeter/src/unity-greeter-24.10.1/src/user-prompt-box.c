/* user-prompt-box.c generated by valac 0.56.19, the Vala compiler
...
enum  {
	USER_PROMPT_BOX_0_PROPERTY,
	USER_PROMPT_BOX_NUM_PROPERTIES
};
static GParamSpec* user_prompt_box_properties[USER_PROMPT_BOX_NUM_PROPERTIES];
...
static GType user_prompt_box_get_type_once (void);
static inline gpointer _vala_memdup2 (gconstpointer mem,
                        gsize byte_size);

UserPromptBox*
user_prompt_box_construct (GType object_type,
                           const gchar* name)
{
	UserPromptBox * self = NULL;
#line 32 "user-prompt-box.vala"
	g_return_val_if_fail (name != NULL, NULL);
#line 34 "user-prompt-box.vala"
	self = (UserPromptBox*) g_object_new (object_type, "id", name, NULL);
#line 32 "user-prompt-box.vala"
	return self;
#line 212 "user-prompt-box.c"
}

UserPromptBox*
user_prompt_box_new (const gchar* name)
{
#line 32 "user-prompt-box.vala"
	return user_prompt_box_construct (TYPE_USER_PROMPT_BOX, name);
#line 220 "user-prompt-box.c"
}

static void
user_prompt_box_class_init (UserPromptBoxClass * klass,
                            gpointer klass_data)
{
#line 21 "user-prompt-box.vala"
	user_prompt_box_parent_class = g_type_class_peek_parent (klass);
#line 21 "user-prompt-box.vala"
	G_OBJECT_CLASS (klass)->finalize = user_prompt_box_finalize;
#line 231 "user-prompt-box.c"
}

static void
user_prompt_box_instance_init (UserPromptBox * self,
                               gpointer klass)
{
}

static void
user_prompt_box_finalize (GObject * obj)
{
	UserPromptBox * self;
#line 21 "user-prompt-box.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, TYPE_USER_PROMPT_BOX, UserPromptBox);
#line 24 "user-prompt-box.vala"
	_g_free0 (self->background);
#line 27 "user-prompt-box.vala"
	_g_free0 (self->session);
#line 21 "user-prompt-box.vala"
	G_OBJECT_CLASS (user_prompt_box_parent_class)->finalize (obj);
#line 252 "user-prompt-box.c"
}

static GType
user_prompt_box_get_type_once (void)
{
	...
	return user_prompt_box_type_id;
}

GType
user_prompt_box_get_type (void)
{
	static volatile gsize user_prompt_box_type_id__once = 0;
	if (g_once_init_enter (&user_prompt_box_type_id__once)) {
		GType user_prompt_box_type_id;
		user_prompt_box_type_id = user_prompt_box_get_type_once ();
		g_once_init_leave (&user_prompt_box_type_id__once, user_prompt_box_type_id);
	}
	return user_prompt_box_type_id__once;
}
