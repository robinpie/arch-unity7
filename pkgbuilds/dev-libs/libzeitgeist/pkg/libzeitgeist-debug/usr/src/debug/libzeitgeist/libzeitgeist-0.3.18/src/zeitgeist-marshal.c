...
void
_zeitgeist_cclosure_marshal_VOID__OBJECT_OBJECT (GClosure     *closure,
...
void
_zeitgeist_cclosure_marshal_VOID__OBJECT_BOXED (GClosure     *closure,
                                                GValue       *return_value G_GNUC_UNUSED,
                                                guint         n_param_values,
                                                const GValue *param_values,
                                                gpointer      invocation_hint G_GNUC_UNUSED,
...
void
_zeitgeist_cclosure_marshal_VOID__STRING_BOOLEAN (GClosure     *closure,
                                                  GValue       *return_value G_GNUC_UNUSED,
                                                  guint         n_param_values,
                                                  const GValue *param_values,
                                                  gpointer      invocation_hint G_GNUC_UNUSED,
