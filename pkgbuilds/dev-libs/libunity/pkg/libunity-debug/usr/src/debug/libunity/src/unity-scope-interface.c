/* unity-scope-interface.c generated by valac 0.56.19, the Vala compiler
...
static gint UnityFilterSet_private_offset;
static gpointer unity_filter_set_parent_class = NULL;
static gint UnityCategorySet_private_offset;
static gpointer unity_category_set_parent_class = NULL;
static gint UnitySchema_private_offset;
...
static gint UnitySearchMetadata_private_offset;
static gpointer unity_search_metadata_parent_class = NULL;
static gint UnityGeoCoordinate_private_offset;
...
static GType unity_filter_set_get_type_once (void);
...
static GType unity_category_set_get_type_once (void);
...
static GType unity_schema_get_type_once (void);
...
static GType unity_cancellable_get_type_once (void);
...
static GType unity_scope_search_base_get_type_once (void);
...
static GType unity_result_set_get_type_once (void);
static guint8* unity_abstract_preview_real_serialize_as (UnityAbstractPreview* self,
                                                  ...
                                                  gint* result_length1);
static GType unity_abstract_preview_get_type_once (void);
...
static GType unity_result_previewer_get_type_once (void);
...
static GType unity_abstract_scope_get_type_once (void);
static inline gpointer _vala_memdup2 (gconstpointer mem,
                        gsize byte_size);

static GType
unity_search_type_get_type_once (void)
{
	...
	return unity_search_type_type_id;
}

GType
unity_search_type_get_type (void)
{
	static volatile gsize unity_search_type_type_id__once = 0;
	if (g_once_init_enter (&unity_search_type_type_id__once)) {
		GType unity_search_type_type_id;
		unity_search_type_type_id = unity_search_type_get_type_once ();
		g_once_init_leave (&unity_search_type_type_id__once, unity_search_type_type_id);
	}
	return unity_search_type_type_id__once;
}

static GType
unity_result_type_get_type_once (void)
{
	...
	return unity_result_type_type_id;
}

GType
unity_result_type_get_type (void)
{
	static volatile gsize unity_result_type_type_id__once = 0;
	if (g_once_init_enter (&unity_result_type_type_id__once)) {
		GType unity_result_type_type_id;
		unity_result_type_type_id = unity_result_type_get_type_once ();
		g_once_init_leave (&unity_result_type_type_id__once, unity_result_type_type_id);
	}
	return unity_result_type_type_id__once;
}

static inline gpointer
unity_filter_set_get_instance_private (UnityFilterSet* self)
{
	return G_STRUCT_MEMBER_P (self, UnityFilterSet_private_offset);
}
...
unity_filter_set_add (UnityFilterSet* self,
                      UnityFilter* filter)
{
	UnityFilterSetClass* _klass_;
	g_return_if_fail (self != NULL);
	_klass_ = UNITY_FILTER_SET_GET_CLASS (self);
	if (_klass_->add) {
		_klass_->add (self, filter);
	}
}
                                   ...
                                   const gchar* filter_id)
{
	...
	_klass_ = UNITY_FILTER_SET_GET_CLASS (self);
	if (_klass_->get_filter_by_id) {
		return _klass_->get_filter_by_id (self, filter_id);
	}
	return NULL;
}
...
unity_filter_set_get_filters (UnityFilterSet* self)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_FILTER_SET_GET_CLASS (self);
	if (_klass_->get_filters) {
		return _klass_->get_filters (self);
	}
	return NULL;
}
                             ...
                             gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityFilterSet_private_offset);
...
unity_filter_set_instance_init (UnityFilterSet * self,
                                gpointer klass)
{
	self->priv = unity_filter_set_get_instance_private (self);
}
...
static GType
unity_filter_set_get_type_once (void)
{
	...
	UnityFilterSet_private_offset = g_type_add_instance_private (unity_filter_set_type_id, sizeof (UnityFilterSetPrivate));
	return unity_filter_set_type_id;
}

GType
unity_filter_set_get_type (void)
{
	static volatile gsize unity_filter_set_type_id__once = 0;
	if (g_once_init_enter (&unity_filter_set_type_id__once)) {
		GType unity_filter_set_type_id;
		unity_filter_set_type_id = unity_filter_set_get_type_once ();
		g_once_init_leave (&unity_filter_set_type_id__once, unity_filter_set_type_id);
	}
	return unity_filter_set_type_id__once;
}

static inline gpointer
unity_category_set_get_instance_private (UnityCategorySet* self)
{
	return G_STRUCT_MEMBER_P (self, UnityCategorySet_private_offset);
}
...
unity_category_set_add (UnityCategorySet* self,
                        UnityCategory* category)
{
	UnityCategorySetClass* _klass_;
	g_return_if_fail (self != NULL);
	_klass_ = UNITY_CATEGORY_SET_GET_CLASS (self);
	if (_klass_->add) {
		_klass_->add (self, category);
	}
}
...
unity_category_set_get_categories (UnityCategorySet* self)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_CATEGORY_SET_GET_CLASS (self);
	if (_klass_->get_categories) {
		return _klass_->get_categories (self);
	}
	return NULL;
}
                               ...
                               gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityCategorySet_private_offset);
...
unity_category_set_instance_init (UnityCategorySet * self,
                                  gpointer klass)
{
	self->priv = unity_category_set_get_instance_private (self);
}
...
static GType
unity_category_set_get_type_once (void)
{
	...
	UnityCategorySet_private_offset = g_type_add_instance_private (unity_category_set_type_id, sizeof (UnityCategorySetPrivate));
	return unity_category_set_type_id;
}

GType
unity_category_set_get_type (void)
{
	static volatile gsize unity_category_set_type_id__once = 0;
	if (g_once_init_enter (&unity_category_set_type_id__once)) {
		GType unity_category_set_type_id;
		unity_category_set_type_id = unity_category_set_get_type_once ();
		g_once_init_leave (&unity_category_set_type_id__once, unity_category_set_type_id);
	}
	return unity_category_set_type_id__once;
}

static inline gpointer
unity_schema_get_instance_private (UnitySchema* self)
{
	return G_STRUCT_MEMBER_P (self, UnitySchema_private_offset);
}

static GType
unity_schema_field_type_get_type_once (void)
{
	...
	return unity_schema_field_type_type_id;
}

GType
unity_schema_field_type_get_type (void)
{
	static volatile gsize unity_schema_field_type_type_id__once = 0;
	if (g_once_init_enter (&unity_schema_field_type_type_id__once)) {
		GType unity_schema_field_type_type_id;
		unity_schema_field_type_type_id = unity_schema_field_type_get_type_once ();
		g_once_init_leave (&unity_schema_field_type_type_id__once, unity_schema_field_type_type_id);
	}
	return unity_schema_field_type_type_id__once;
}
...
unity_schema_add_field (UnitySchema* self,
                        ...
                        UnitySchemaFieldType type)
{
	UnitySchemaClass* _klass_;
	g_return_if_fail (self != NULL);
	_klass_ = UNITY_SCHEMA_GET_CLASS (self);
	if (_klass_->add_field) {
		_klass_->add_field (self, name, schema, type);
	}
}
...
unity_schema_get_fields (UnitySchema* self)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_SCHEMA_GET_CLASS (self);
	if (_klass_->get_fields) {
		return _klass_->get_fields (self);
	}
	return NULL;
}
...
static GType
unity_schema_field_info_get_type_once (void)
{
	...
	return unity_schema_field_info_type_id;
}

GType
unity_schema_field_info_get_type (void)
{
	static volatile gsize unity_schema_field_info_type_id__once = 0;
	if (g_once_init_enter (&unity_schema_field_info_type_id__once)) {
		GType unity_schema_field_info_type_id;
		unity_schema_field_info_type_id = unity_schema_field_info_get_type_once ();
		g_once_init_leave (&unity_schema_field_info_type_id__once, unity_schema_field_info_type_id);
	}
	return unity_schema_field_info_type_id__once;
}
                         ...
                         gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnitySchema_private_offset);
...
unity_schema_instance_init (UnitySchema * self,
                            gpointer klass)
{
	self->priv = unity_schema_get_instance_private (self);
}
...
static GType
unity_schema_get_type_once (void)
{
	...
	UnitySchema_private_offset = g_type_add_instance_private (unity_schema_type_id, sizeof (UnitySchemaPrivate));
	return unity_schema_type_id;
}

GType
unity_schema_get_type (void)
{
	static volatile gsize unity_schema_type_id__once = 0;
	if (g_once_init_enter (&unity_schema_type_id__once)) {
		GType unity_schema_type_id;
		unity_schema_type_id = unity_schema_get_type_once ();
		g_once_init_leave (&unity_schema_type_id__once, unity_schema_type_id);
	}
	return unity_schema_type_id__once;
}
...
"\"%s\", got \"%s\"", EXPECTED_SIG, _tmp1_);
	...
	_tmp2_ = real_result;
	_result_ = _tmp2_;
	g_variant_get (variant, "(&s&suu&s&s&s&s@a{sv})", &_tmp3_, &_tmp4_, &_tmp5_, &_tmp6_, &_tmp7_, &_tmp8_, &_tmp9_, &_tmp10_, &_tmp11_, NULL);
	_g_free0 (_result_.uri);
	_result_.uri = _tmp3_;
	_g_free0 (_result_.icon_hint);
	_result_.icon_hint = _tmp4_;
	_result_.category = _tmp5_;
	_result_.result_type = _tmp6_;
	_g_free0 (_result_.mimetype);
	_result_.mimetype = _tmp7_;
	_g_free0 (_result_.title);
	_result_.title = _tmp8_;
	_g_free0 (_result_.comment);
	_result_.comment = _tmp9_;
	_g_free0 (_result_.dnd_uri);
	_result_.dnd_uri = _tmp10_;
	...
	_g_hash_table_unref0 (_result_.metadata);
	_result_.metadata = _tmp15_;
	_tmp16_ = _result_;
	_tmp17_ = _tmp16_;
	_tmp18_ = _unity_scope_result_dup0 (&_tmp17_);
	result = _tmp18_;
                         ...
                         UnityScopeResult* dest)
{
	...
	(*dest).result_type = (*self).result_type;
...
static GType
unity_scope_result_get_type_once (void)
{
	...
	return unity_scope_result_type_id;
}

GType
unity_scope_result_get_type (void)
{
	static volatile gsize unity_scope_result_type_id__once = 0;
	if (g_once_init_enter (&unity_scope_result_type_id__once)) {
		GType unity_scope_result_type_id;
		unity_scope_result_type_id = unity_scope_result_get_type_once ();
		g_once_init_leave (&unity_scope_result_type_id__once, unity_scope_result_type_id);
	}
	return unity_scope_result_type_id__once;
}
...
{
	UnityCancellableClass* _klass_;
	g_return_if_fail (self != NULL);
	_klass_ = UNITY_CANCELLABLE_GET_CLASS (self);
	if (_klass_->cancel) {
		_klass_->cancel (self);
	}
}
...
unity_cancellable_is_cancelled (UnityCancellable* self)
{
	...
	_klass_ = UNITY_CANCELLABLE_GET_CLASS (self);
	if (_klass_->is_cancelled) {
		return _klass_->is_cancelled (self);
	}
	return FALSE;
}
...
unity_cancellable_get_gcancellable (UnityCancellable* self)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_CANCELLABLE_GET_CLASS (self);
	if (_klass_->get_gcancellable) {
		return _klass_->get_gcancellable (self);
	}
	return NULL;
}
...
static GType
unity_cancellable_get_type_once (void)
{
	...
	return unity_cancellable_type_id;
}

GType
unity_cancellable_get_type (void)
{
	static volatile gsize unity_cancellable_type_id__once = 0;
	if (g_once_init_enter (&unity_cancellable_type_id__once)) {
		GType unity_cancellable_type_id;
		unity_cancellable_type_id = unity_cancellable_get_type_once ();
		g_once_init_leave (&unity_cancellable_type_id__once, unity_cancellable_type_id);
	}
	return unity_cancellable_type_id__once;
}
...
{
	UnityScopeSearchBaseClass* _klass_;
	g_return_if_fail (self != NULL);
	_klass_ = UNITY_SCOPE_SEARCH_BASE_GET_CLASS (self);
	if (_klass_->run) {
		_klass_->run (self);
	}
}
                                   ...
                                   gpointer async_callback_target)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = UNITY_SCOPE_SEARCH_BASE_GET_CLASS (self);
	if (_klass_->run_async) {
		_klass_->run_async (self, async_callback, async_callback_target);
	}
}
                                            ...
                                            UnitySearchContext* ctx)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = UNITY_SCOPE_SEARCH_BASE_GET_CLASS (self);
	if (_klass_->set_search_context) {
		_klass_->set_search_context (self, ctx);
	}
}
...
static GType
unity_scope_search_base_get_type_once (void)
{
	...
	return unity_scope_search_base_type_id;
}

GType
unity_scope_search_base_get_type (void)
{
	static volatile gsize unity_scope_search_base_type_id__once = 0;
	if (g_once_init_enter (&unity_scope_search_base_type_id__once)) {
		GType unity_scope_search_base_type_id;
		unity_scope_search_base_type_id = unity_scope_search_base_get_type_once ();
		g_once_init_leave (&unity_scope_search_base_type_id__once, unity_scope_search_base_type_id);
	}
	return unity_scope_search_base_type_id__once;
}

static GType
unity_serialization_type_get_type_once (void)
{
	...
	return unity_serialization_type_type_id;
}

GType
unity_serialization_type_get_type (void)
{
	static volatile gsize unity_serialization_type_type_id__once = 0;
	if (g_once_init_enter (&unity_serialization_type_type_id__once)) {
		GType unity_serialization_type_type_id;
		unity_serialization_type_type_id = unity_serialization_type_get_type_once ();
		g_once_init_leave (&unity_serialization_type_type_id__once, unity_serialization_type_type_id);
	}
	return unity_serialization_type_type_id__once;
}
...
unity_result_set_add_result (UnityResultSet* self,
                             UnityScopeResult* _result_)
{
	UnityResultSetClass* _klass_;
	g_return_if_fail (self != NULL);
	_klass_ = UNITY_RESULT_SET_GET_CLASS (self);
	if (_klass_->add_result) {
		_klass_->add_result (self, _result_);
	}
}
...
"\"%s\", got \"%s\"", EXPECTED_SIG, _tmp1_);
	...
	_result_.metadata = _tmp15_;
	_tmp16_ = _result_;
	unity_result_set_add_result (self, &_tmp16_);
	_g_hash_table_unref0 (metadata);
	unity_scope_result_destroy (&real_result);
	_g_variant_unref0 (dict);
}
                                          ...
                                          GVariant* variant)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = UNITY_RESULT_SET_GET_CLASS (self);
	if (_klass_->add_result_from_variant) {
		_klass_->add_result_from_variant (self, variant);
	}
}
...
static GType
unity_result_set_get_type_once (void)
{
	...
	return unity_result_set_type_id;
}

GType
unity_result_set_get_type (void)
{
	static volatile gsize unity_result_set_type_id__once = 0;
	if (g_once_init_enter (&unity_result_set_type_id__once)) {
		GType unity_result_set_type_id;
		unity_result_set_type_id = unity_result_set_get_type_once ();
		g_once_init_leave (&unity_result_set_type_id__once, unity_result_set_type_id);
	}
	return unity_result_set_type_id__once;
}
...
unity_abstract_preview_serialize_as (UnityAbstractPreview* self,
                                     ...
                                     gint* result_length1)
{
	UnityAbstractPreviewClass* _klass_;
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_ABSTRACT_PREVIEW_GET_CLASS (self);
	if (_klass_->serialize_as) {
		return _klass_->serialize_as (self, serialization_type, result_length1);
	}
	return NULL;
}
                                   ...
                                   gpointer klass_data)
{
	...
	((UnityAbstractPreviewClass *) klass)->serialize_as = (guint8* (*) (UnityAbstractPreview*, UnitySerializationType, gint*)) unity_abstract_preview_real_serialize_as;
}
...
static GType
unity_abstract_preview_get_type_once (void)
{
	...
	return unity_abstract_preview_type_id;
}

GType
unity_abstract_preview_get_type (void)
{
	static volatile gsize unity_abstract_preview_type_id__once = 0;
	if (g_once_init_enter (&unity_abstract_preview_type_id__once)) {
		GType unity_abstract_preview_type_id;
		unity_abstract_preview_type_id = unity_abstract_preview_get_type_once ();
		g_once_init_leave (&unity_abstract_preview_type_id__once, unity_abstract_preview_type_id);
	}
	return unity_abstract_preview_type_id__once;
}
...
{
	UnityResultPreviewerClass* _klass_;
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_RESULT_PREVIEWER_GET_CLASS (self);
	if (_klass_->run) {
		return _klass_->run (self);
	}
	return NULL;
}
...
static GType
unity_result_previewer_get_type_once (void)
{
	...
	return unity_result_previewer_type_id;
}

GType
unity_result_previewer_get_type (void)
{
	static volatile gsize unity_result_previewer_type_id__once = 0;
	if (g_once_init_enter (&unity_result_previewer_type_id__once)) {
		GType unity_result_previewer_type_id;
		unity_result_previewer_type_id = unity_result_previewer_get_type_once ();
		g_once_init_leave (&unity_result_previewer_type_id__once, unity_result_previewer_type_id);
	}
	return unity_result_previewer_type_id__once;
}

static inline gpointer
unity_search_metadata_get_instance_private (UnitySearchMetadata* self)
{
	return G_STRUCT_MEMBER_P (self, UnitySearchMetadata_private_offset);
}
...
unity_search_metadata_get_location (UnitySearchMetadata* self)
{
	...
	_tmp10_ = location_v;
	g_variant_get (_tmp10_, EXPECTED_TYPE, &_tmp11_, &_tmp12_, &_tmp13_, &_tmp14_, NULL);
	loc_type = _tmp11_;
	lat = _tmp12_;
	lon = _tmp13_;
	alt = _tmp14_;
	if (loc_type == ((gint) UNITY_GEO_COORDINATE_COORDINATE_TYPE_COORDINATE_3D)) {
		UnityGeoCoordinate* _tmp15_;
		_tmp15_ = unity_geo_coordinate_new_with_altitude (lat, lon, alt);
		_g_object_unref0 (self->priv->geo_coordinate);
		self->priv->geo_coordinate = _tmp15_;
	} else {
		UnityGeoCoordinate* _tmp16_;
		_tmp16_ = unity_geo_coordinate_new (lat, lon);
		_g_object_unref0 (self->priv->geo_coordinate);
		self->priv->geo_coordinate = _tmp16_;
	}
	_tmp17_ = self->priv->geo_coordinate;
	result = _tmp17_;
	_g_variant_unref0 (location_v);
	return result;
}
                                  ...
                                  gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnitySearchMetadata_private_offset);
...
unity_search_metadata_instance_init (UnitySearchMetadata * self,
                                     gpointer klass)
{
	self->priv = unity_search_metadata_get_instance_private (self);
}
...
static GType
unity_search_metadata_get_type_once (void)
{
	...
	UnitySearchMetadata_private_offset = g_type_add_instance_private (unity_search_metadata_type_id, sizeof (UnitySearchMetadataPrivate));
	return unity_search_metadata_type_id;
}

GType
unity_search_metadata_get_type (void)
{
	static volatile gsize unity_search_metadata_type_id__once = 0;
	if (g_once_init_enter (&unity_search_metadata_type_id__once)) {
		GType unity_search_metadata_type_id;
		unity_search_metadata_type_id = unity_search_metadata_get_type_once ();
		g_once_init_leave (&unity_search_metadata_type_id__once, unity_search_metadata_type_id);
	}
	return unity_search_metadata_type_id__once;
}
...
static inline gpointer
unity_geo_coordinate_get_instance_private (UnityGeoCoordinate* self)
{
	return G_STRUCT_MEMBER_P (self, UnityGeoCoordinate_private_offset);
}

static GType
unity_geo_coordinate_coordinate_type_get_type_once (void)
{
	...
	return unity_geo_coordinate_coordinate_type_type_id;
}

static GType
unity_geo_coordinate_coordinate_type_get_type (void)
{
	static volatile gsize unity_geo_coordinate_coordinate_type_type_id__once = 0;
	if (g_once_init_enter (&unity_geo_coordinate_coordinate_type_type_id__once)) {
		GType unity_geo_coordinate_coordinate_type_type_id;
		unity_geo_coordinate_coordinate_type_type_id = unity_geo_coordinate_coordinate_type_get_type_once ();
		g_once_init_leave (&unity_geo_coordinate_coordinate_type_type_id__once, unity_geo_coordinate_coordinate_type_type_id);
	}
	return unity_geo_coordinate_coordinate_type_type_id__once;
}
...
unity_geo_coordinate_has_valid_altitude (UnityGeoCoordinate* self)
{
	gboolean result;
	g_return_val_if_fail (self != NULL, FALSE);
	result = self->priv->coord_type == UNITY_GEO_COORDINATE_COORDINATE_TYPE_COORDINATE_3D;
	return result;
}
                                 ...
                                 gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityGeoCoordinate_private_offset);
...
unity_geo_coordinate_instance_init (UnityGeoCoordinate * self,
                                    gpointer klass)
{
	self->priv = unity_geo_coordinate_get_instance_private (self);
}
...
static GType
unity_geo_coordinate_get_type_once (void)
{
	...
	UnityGeoCoordinate_private_offset = g_type_add_instance_private (unity_geo_coordinate_type_id, sizeof (UnityGeoCoordinatePrivate));
	return unity_geo_coordinate_type_id;
}

GType
unity_geo_coordinate_get_type (void)
{
	static volatile gsize unity_geo_coordinate_type_id__once = 0;
	if (g_once_init_enter (&unity_geo_coordinate_type_id__once)) {
		GType unity_geo_coordinate_type_id;
		unity_geo_coordinate_type_id = unity_geo_coordinate_get_type_once ();
		g_once_init_leave (&unity_geo_coordinate_type_id__once, unity_geo_coordinate_type_id);
	}
	return unity_geo_coordinate_type_id__once;
}
                           ...
                           UnitySearchContext* dest)
{
	...
	(*dest).search_type = (*self).search_type;
	_tmp2_ = (*self).filter_state;
	_tmp3_ = _g_object_ref0 (_tmp2_);
	_g_object_unref0 ((*dest).filter_state);
	(*dest).filter_state = _tmp3_;
	_tmp4_ = (*self).search_metadata;
	_tmp5_ = _g_object_ref0 (_tmp4_);
	_g_object_unref0 ((*dest).search_metadata);
	(*dest).search_metadata = _tmp5_;
	_tmp6_ = (*self).result_set;
	_tmp7_ = _g_object_ref0 (_tmp6_);
	_g_object_unref0 ((*dest).result_set);
	(*dest).result_set = _tmp7_;
	_tmp8_ = (*self).cancellable;
	_tmp9_ = _g_object_ref0 (_tmp8_);
	_g_object_unref0 ((*dest).cancellable);
	(*dest).cancellable = _tmp9_;
}
...
static GType
unity_search_context_get_type_once (void)
{
	...
	return unity_search_context_type_id;
}

GType
unity_search_context_get_type (void)
{
	static volatile gsize unity_search_context_type_id__once = 0;
	if (g_once_init_enter (&unity_search_context_type_id__once)) {
		GType unity_search_context_type_id;
		unity_search_context_type_id = unity_search_context_get_type_once ();
		g_once_init_leave (&unity_search_context_type_id__once, unity_search_context_type_id);
	}
	return unity_search_context_type_id__once;
}
...
unity_abstract_scope_create_search_for_query (UnityAbstractScope* self,
                                              UnitySearchContext* search_context)
{
	UnityAbstractScopeClass* _klass_;
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_ABSTRACT_SCOPE_GET_CLASS (self);
	if (_klass_->create_search_for_query) {
		return _klass_->create_search_for_query (self, search_context);
	}
	return NULL;
}
                                       ...
                                       UnitySearchMetadata* metadata)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_ABSTRACT_SCOPE_GET_CLASS (self);
	if (_klass_->create_previewer) {
		return _klass_->create_previewer (self, _result_, metadata);
	}
	return NULL;
}
...
unity_abstract_scope_get_schema (UnityAbstractScope* self)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_ABSTRACT_SCOPE_GET_CLASS (self);
	if (_klass_->get_schema) {
		return _klass_->get_schema (self);
	}
	return NULL;
}
...
unity_abstract_scope_get_search_hint (UnityAbstractScope* self)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_ABSTRACT_SCOPE_GET_CLASS (self);
	if (_klass_->get_search_hint) {
		return _klass_->get_search_hint (self);
	}
	return NULL;
}
...
unity_abstract_scope_get_group_name (UnityAbstractScope* self)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_ABSTRACT_SCOPE_GET_CLASS (self);
	if (_klass_->get_group_name) {
		return _klass_->get_group_name (self);
	}
	return NULL;
}
...
unity_abstract_scope_get_unique_name (UnityAbstractScope* self)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_ABSTRACT_SCOPE_GET_CLASS (self);
	if (_klass_->get_unique_name) {
		return _klass_->get_unique_name (self);
	}
	return NULL;
}
                               ...
                               const gchar* action_id)
{
	...
	_klass_ = UNITY_ABSTRACT_SCOPE_GET_CLASS (self);
	if (_klass_->activate) {
		return _klass_->activate (self, _result_, metadata, action_id);
	}
	return NULL;
}
                                             ...
                                             const gchar* search_query)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_ABSTRACT_SCOPE_GET_CLASS (self);
	if (_klass_->normalize_search_query) {
		return _klass_->normalize_search_query (self, search_query);
	}
	return NULL;
}
...
static GType
unity_abstract_scope_get_type_once (void)
{
	...
	return unity_abstract_scope_type_id;
}

GType
unity_abstract_scope_get_type (void)
{
	static volatile gsize unity_abstract_scope_type_id__once = 0;
	if (g_once_init_enter (&unity_abstract_scope_type_id__once)) {
		GType unity_abstract_scope_type_id;
		unity_abstract_scope_type_id = unity_abstract_scope_get_type_once ();
		g_once_init_leave (&unity_abstract_scope_type_id__once, unity_abstract_scope_type_id);
	}
	return unity_abstract_scope_type_id__once;
}
