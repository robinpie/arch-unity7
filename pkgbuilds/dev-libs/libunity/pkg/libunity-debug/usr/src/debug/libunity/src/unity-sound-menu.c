/* unity-sound-menu.c generated by valac 0.56.19, the Vala compiler
...
static GType unity_playlist_get_type_once (void);
...
static GType unity_music_player_get_type_once (void);
...
unity_track_metadata_get_instance_private (UnityTrackMetadata* self)
{
	return G_STRUCT_MEMBER_P (self, UnityTrackMetadata_private_offset);
}
                              ...
                              const gchar* value)
{
	...
	old_value = unity_track_metadata_get_uri (self);
                                   ...
                                   gint value)
{
	gint old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_track_metadata_get_track_no (self);
	if (old_value != value) {
                                 ...
                                 const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_track_metadata_get_artist (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                ...
                                const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_track_metadata_get_title (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                ...
                                const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_track_metadata_get_album (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                 ...
                                 guint value)
{
	guint old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_track_metadata_get_length (self);
	if (old_value != value) {
                                 ...
                                 gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityTrackMetadata_private_offset);
...
unity_track_metadata_instance_init (UnityTrackMetadata * self,
                                    gpointer klass)
{
	self->priv = unity_track_metadata_get_instance_private (self);
}
...
static GType
unity_track_metadata_get_type_once (void)
{
	...
	UnityTrackMetadata_private_offset = g_type_add_instance_private (unity_track_metadata_type_id, sizeof (UnityTrackMetadataPrivate));
	return unity_track_metadata_type_id;
}

GType
unity_track_metadata_get_type (void)
{
	static volatile gsize unity_track_metadata_type_id__once = 0;
	if (g_once_init_enter (&unity_track_metadata_type_id__once)) {
		GType unity_track_metadata_type_id;
		unity_track_metadata_type_id = unity_track_metadata_get_type_once ();
		g_once_init_leave (&unity_track_metadata_type_id__once, unity_track_metadata_type_id);
	}
	return unity_track_metadata_type_id__once;
}
...
static inline gpointer
unity_playlist_get_instance_private (UnityPlaylist* self)
{
	return G_STRUCT_MEMBER_P (self, UnityPlaylist_private_offset);
}
                       ...
                       const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_playlist_get_id (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                         ...
                         const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_playlist_get_name (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                         ...
                         GIcon* value)
{
	GIcon* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_playlist_get_icon (self);
	if (old_value != value) {
		GIcon* _tmp0_;
		_tmp0_ = _g_object_ref0 (value);
                                  ...
                                  GDateTime* value)
{
	GDateTime* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_playlist_get_creation_date (self);
	if (old_value != value) {
		GDateTime* _tmp0_;
                                      ...
                                      GDateTime* value)
{
	GDateTime* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_playlist_get_modification_date (self);
	if (old_value != value) {
		GDateTime* _tmp0_;
		_tmp0_ = _g_date_time_ref0 (value);
                                   ...
                                   GDateTime* value)
{
	GDateTime* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_playlist_get_last_play_date (self);
	if (old_value != value) {
		GDateTime* _tmp0_;
		_tmp0_ = _g_date_time_ref0 (value);
                           ...
                           gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityPlaylist_private_offset);
...
unity_playlist_instance_init (UnityPlaylist * self,
                              gpointer klass)
{
	self->priv = unity_playlist_get_instance_private (self);
}
...
static GType
unity_playlist_get_type_once (void)
{
	...
	UnityPlaylist_private_offset = g_type_add_instance_private (unity_playlist_type_id, sizeof (UnityPlaylistPrivate));
	return unity_playlist_type_id;
}

GType
unity_playlist_get_type (void)
{
	static volatile gsize unity_playlist_type_id__once = 0;
	if (g_once_init_enter (&unity_playlist_type_id__once)) {
		GType unity_playlist_type_id;
		unity_playlist_type_id = unity_playlist_get_type_once ();
		g_once_init_leave (&unity_playlist_type_id__once, unity_playlist_type_id);
	}
	return unity_playlist_type_id__once;
}
...
static GType
unity_playback_state_get_type_once (void)
{
	...
	return unity_playback_state_type_id;
}

GType
unity_playback_state_get_type (void)
{
	static volatile gsize unity_playback_state_type_id__once = 0;
	if (g_once_init_enter (&unity_playback_state_type_id__once)) {
		GType unity_playback_state_type_id;
		unity_playback_state_type_id = unity_playback_state_get_type_once ();
		g_once_init_leave (&unity_playback_state_type_id__once, unity_playback_state_type_id);
	}
	return unity_playback_state_type_id__once;
}

static inline gpointer
unity_music_player_get_instance_private (UnityMusicPlayer* self)
{
	return G_STRUCT_MEMBER_P (self, UnityMusicPlayer_private_offset);
}
                                  ...
                                  gint* result_length1)
{
	...
	_tmp2_ = (_tmp1_ != NULL) ? _vala_array_dup10 (_tmp1_, _tmp1__length1) : _tmp1_;
                                 ...
                                 GAppInfo* value)
{
	GAppInfo* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_app_info (self);
	if (old_value != value) {
		GAppInfo* _tmp0_;
		_tmp0_ = _g_object_ref0 (value);
                                          ...
                                          const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_desktop_file_name (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                       ...
                                       gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_is_blacklisted (self);
	if (old_value != value) {
                              ...
                              const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_title (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
		_g_free0 (self->priv->_title);
                                    ...
                                    gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_can_go_next (self);
	if (old_value != value) {
                                        ...
                                        gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_can_go_previous (self);
	if (old_value != value) {
                                 ...
                                 gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_can_play (self);
	if (old_value != value) {
                                  ...
                                  gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_can_pause (self);
	if (old_value != value) {
...
{
	UnityTrackMetadata* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_current_track (self);
	if (old_value != value) {
		UnityTrackMetadata* _tmp0_;
		_tmp0_ = _g_object_ref0 (value);
...
{
	UnityPlaybackState old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_playback_state (self);
	if (old_value != value) {
                                         ...
                                         UnityPlaylist* value)
{
	...
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_current_playlist (self);
	if (old_value != value) {
		UnityPlaylist* _tmp0_;
		_tmp0_ = _g_object_ref0 (value);
...
{
	DbusmenuMenuitem* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_track_menu (self);
	if (old_value != value) {
		DbusmenuMenuitem* _tmp0_;
		_tmp0_ = _g_object_ref0 (value);
                                    ...
                                    DbusmenuMenuitem* value)
{
	DbusmenuMenuitem* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_music_player_get_player_menu (self);
	if (old_value != value) {
		DbusmenuMenuitem* _tmp0_;
		_tmp0_ = _g_object_ref0 (value);
                               ...
                               gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityMusicPlayer_private_offset);
...
unity_music_player_instance_init (UnityMusicPlayer * self,
                                  gpointer klass)
{
	self->priv = unity_music_player_get_instance_private (self);
}
...
static GType
unity_music_player_get_type_once (void)
{
	...
	UnityMusicPlayer_private_offset = g_type_add_instance_private (unity_music_player_type_id, sizeof (UnityMusicPlayerPrivate));
	return unity_music_player_type_id;
}

GType
unity_music_player_get_type (void)
{
	static volatile gsize unity_music_player_type_id__once = 0;
	if (g_once_init_enter (&unity_music_player_type_id__once)) {
		GType unity_music_player_type_id;
		unity_music_player_type_id = unity_music_player_get_type_once ();
		g_once_init_leave (&unity_music_player_type_id__once, unity_music_player_type_id);
	}
	return unity_music_player_type_id__once;
}
