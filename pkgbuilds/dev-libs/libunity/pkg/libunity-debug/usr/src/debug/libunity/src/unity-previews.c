/* unity-previews.c generated by valac 0.56.19, the Vala compiler
...
static gint UnityPreview_private_offset;
...
static gint UnityPreviewAction_private_offset;
...
static GType unity_preview_get_type_once (void);
...
static GType unity_preview_action_get_type_once (void);
...
static GType unity_info_hint_get_type_once (void);
...
static GType unity_generic_preview_get_type_once (void);
...
static GType unity_application_preview_get_type_once (void);
...
static GType unity_music_preview_get_type_once (void);
...
static GType unity_payment_preview_get_type_once (void);
...
static GType unity_movie_preview_get_type_once (void);
...
static GType unity_social_preview_comment_get_type_once (void);
...
static GType unity_social_preview_get_type_once (void);
...
unity_preview_get_instance_private (UnityPreview* self)
{
	return G_STRUCT_MEMBER_P (self, UnityPreview_private_offset);
}
...
{
	UnityPreviewClass* _klass_;
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_PREVIEW_GET_CLASS (self);
	if (_klass_->create_raw) {
		return _klass_->create_raw (self);
	}
	return NULL;
}
                        ...
                        UnityInfoHint* info_hint)
{
	...
	_tmp1_ = _g_object_ref0 (UNITY_IS_INFO_HINT (_tmp0_) ? ((UnityInfoHint*) _tmp0_) : NULL);
	sunk = _tmp1_;
	_tmp2_ = self->priv->_raw;
                                 ...
                                 gint* result_length1)
{
	...
	switch (serialize_type) {
		...
		case UNITY_SERIALIZATION_TYPE_JSON:
		{
			...
			_tmp6_ = string_get_data ("{\"error\": \"JSON serialization not supported\"}", &_tmp7_);
			_tmp6__length1 = _tmp7_;
			_tmp8_ = _tmp6_;
			_tmp8__length1 = _tmp6__length1;
			_tmp9_ = (_tmp8_ != NULL) ? _vala_array_dup7 (_tmp8_, _tmp8__length1) : _tmp8_;
                          ...
                          gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityPreview_private_offset);
	((UnityPreviewClass *) klass)->create_raw = (GObject* (*) (UnityPreview*)) unity_preview_real_create_raw;
	((UnityAbstractPreviewClass *) klass)->serialize_as = (guint8* (*) (UnityAbstractPreview*, UnitySerializationType, gint*)) unity_preview_real_serialize_as;
...
{
	GPtrArray* _tmp0_;
	self->priv = unity_preview_get_instance_private (self);
...
static GType
unity_preview_get_type_once (void)
{
	...
	UnityPreview_private_offset = g_type_add_instance_private (unity_preview_type_id, sizeof (UnityPreviewPrivate));
	return unity_preview_type_id;
}

GType
unity_preview_get_type (void)
{
	static volatile gsize unity_preview_type_id__once = 0;
	if (g_once_init_enter (&unity_preview_type_id__once)) {
		GType unity_preview_type_id;
		unity_preview_type_id = unity_preview_get_type_once ();
		g_once_init_leave (&unity_preview_type_id__once, unity_preview_type_id);
	}
	return unity_preview_type_id__once;
}
...
static GType
unity_layout_hint_get_type_once (void)
{
	...
	return unity_layout_hint_type_id;
}

GType
unity_layout_hint_get_type (void)
{
	static volatile gsize unity_layout_hint_type_id__once = 0;
	if (g_once_init_enter (&unity_layout_hint_type_id__once)) {
		GType unity_layout_hint_type_id;
		unity_layout_hint_type_id = unity_layout_hint_get_type_once ();
		g_once_init_leave (&unity_layout_hint_type_id__once, unity_layout_hint_type_id);
	}
	return unity_layout_hint_type_id__once;
}

static inline gpointer
unity_preview_action_get_instance_private (UnityPreviewAction* self)
{
	return G_STRUCT_MEMBER_P (self, UnityPreviewAction_private_offset);
}
...
_variant_new24 (GHashTable* value)
{
	...
	gpointer _tmp15_;
	gpointer _tmp16_;
	g_hash_table_iter_init (&_tmp14_, value);
...
unity_preview_action_real_serialize (DeeSerializable* base)
{
	...
	_tmp9_ = g_variant_new_string (_tmp4_);
	g_variant_ref_sink (_tmp9_);
	_g_variant_unref0 (tuple[2]);
	tuple[2] = _tmp9_;
	_tmp10_ = self->priv->_layout_hint;
	_tmp11_ = _variant_new23 ((guint) _tmp10_);
	_g_variant_unref0 (tuple[3]);
	tuple[3] = _tmp11_;
	_tmp12_ = unity_preview_action_get_hints_internal (self);
	_tmp17_ = _variant_new24 (_tmp12_);
	_g_variant_unref0 (tuple[4]);
	tuple[4] = _tmp17_;
	_tmp18_ = g_variant_new_tuple (tuple, 5);
                             ...
                             const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_preview_action_get_id (self);
                                       ...
                                       const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_preview_action_get_display_name (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                     ...
                                     const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_preview_action_get_extra_text (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                    ...
                                    GIcon* value)
{
	GIcon* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_preview_action_get_icon_hint (self);
	if (old_value != value) {
		GIcon* _tmp0_;
...
{
	UnityLayoutHint old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_preview_action_get_layout_hint (self);
	if (old_value != value) {
	...
	if (_tmp4_) {
		{
			...
			GIcon* _tmp10_;
			_tmp8_ = icon_hint;
			_tmp9_ = g_icon_new_for_string (_tmp8_, &_inner_error0_);
			_tmp7_ = _tmp9_;
                                 ...
                                 gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityPreviewAction_private_offset);
                                    ...
                                    gpointer klass)
{
	...
	GEqualFunc _tmp1_;
	GHashTable* _tmp2_;
	self->priv = unity_preview_action_get_instance_private (self);
	_tmp0_ = g_str_hash;
	_tmp1_ = g_str_equal;
...
static GType
unity_preview_action_get_type_once (void)
{
	...
	UnityPreviewAction_private_offset = g_type_add_instance_private (unity_preview_action_type_id, sizeof (UnityPreviewActionPrivate));
	return unity_preview_action_type_id;
}

GType
unity_preview_action_get_type (void)
{
	static volatile gsize unity_preview_action_type_id__once = 0;
	if (g_once_init_enter (&unity_preview_action_type_id__once)) {
		GType unity_preview_action_type_id;
		unity_preview_action_type_id = unity_preview_action_get_type_once ();
		g_once_init_leave (&unity_preview_action_type_id__once, unity_preview_action_type_id);
	}
	return unity_preview_action_type_id__once;
}
...
static inline gpointer
unity_info_hint_get_instance_private (UnityInfoHint* self)
{
	return G_STRUCT_MEMBER_P (self, UnityInfoHint_private_offset);
}
                        ...
                        const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_info_hint_get_id (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
		_g_free0 (self->priv->_id);
                                  ...
                                  const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_info_hint_get_display_name (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
		_g_free0 (self->priv->_display_name);
                               ...
                               GIcon* value)
{
	GIcon* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_info_hint_get_icon_hint (self);
	if (old_value != value) {
		GIcon* _tmp0_;
		_tmp0_ = _g_object_ref0 (value);
		_g_object_unref0 (self->priv->_icon_hint);
                          ...
                          GVariant* value)
{
	GVariant* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_info_hint_get_data (self);
	if (old_value != value) {
		GVariant* _tmp0_;
                            ...
                            gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityInfoHint_private_offset);
...
unity_info_hint_instance_init (UnityInfoHint * self,
                               gpointer klass)
{
	self->priv = unity_info_hint_get_instance_private (self);
}
...
static GType
unity_info_hint_get_type_once (void)
{
	...
	UnityInfoHint_private_offset = g_type_add_instance_private (unity_info_hint_type_id, sizeof (UnityInfoHintPrivate));
	return unity_info_hint_type_id;
}

GType
unity_info_hint_get_type (void)
{
	static volatile gsize unity_info_hint_type_id__once = 0;
	if (g_once_init_enter (&unity_info_hint_type_id__once)) {
		GType unity_info_hint_type_id;
		unity_info_hint_type_id = unity_info_hint_get_type_once ();
		g_once_init_leave (&unity_info_hint_type_id__once, unity_info_hint_type_id);
	}
	return unity_info_hint_type_id__once;
}
...
static GType
unity_generic_preview_get_type_once (void)
{
	...
	return unity_generic_preview_type_id;
}

GType
unity_generic_preview_get_type (void)
{
	static volatile gsize unity_generic_preview_type_id__once = 0;
	if (g_once_init_enter (&unity_generic_preview_type_id__once)) {
		GType unity_generic_preview_type_id;
		unity_generic_preview_type_id = unity_generic_preview_get_type_once ();
		g_once_init_leave (&unity_generic_preview_type_id__once, unity_generic_preview_type_id);
	}
	return unity_generic_preview_type_id__once;
}

static inline gpointer
unity_application_preview_get_instance_private (UnityApplicationPreview* self)
{
	return G_STRUCT_MEMBER_P (self, UnityApplicationPreview_private_offset);
}
                                      ...
                                      gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityApplicationPreview_private_offset);
...
unity_application_preview_instance_init (UnityApplicationPreview * self,
                                         gpointer klass)
{
	self->priv = unity_application_preview_get_instance_private (self);
}
...
static GType
unity_application_preview_get_type_once (void)
{
	...
	UnityApplicationPreview_private_offset = g_type_add_instance_private (unity_application_preview_type_id, sizeof (UnityApplicationPreviewPrivate));
	return unity_application_preview_type_id;
}

GType
unity_application_preview_get_type (void)
{
	static volatile gsize unity_application_preview_type_id__once = 0;
	if (g_once_init_enter (&unity_application_preview_type_id__once)) {
		GType unity_application_preview_type_id;
		unity_application_preview_type_id = unity_application_preview_get_type_once ();
		g_once_init_leave (&unity_application_preview_type_id__once, unity_application_preview_type_id);
	}
	return unity_application_preview_type_id__once;
}
...
static inline gpointer
unity_music_preview_get_instance_private (UnityMusicPreview* self)
{
	return G_STRUCT_MEMBER_P (self, UnityMusicPreview_private_offset);
}

static GType
unity_music_preview_track_state_get_type_once (void)
{
	...
	return unity_music_preview_track_state_type_id;
}

GType
unity_music_preview_track_state_get_type (void)
{
	static volatile gsize unity_music_preview_track_state_type_id__once = 0;
	if (g_once_init_enter (&unity_music_preview_track_state_type_id__once)) {
		GType unity_music_preview_track_state_type_id;
		unity_music_preview_track_state_type_id = unity_music_preview_track_state_get_type_once ();
		g_once_init_leave (&unity_music_preview_track_state_type_id__once, unity_music_preview_track_state_type_id);
	}
	return unity_music_preview_track_state_type_id__once;
}

static GType
unity_music_preview_track_data_columns_get_type_once (void)
{
	...
	return unity_music_preview_track_data_columns_type_id;
}

static GType
unity_music_preview_track_data_columns_get_type (void)
{
	static volatile gsize unity_music_preview_track_data_columns_type_id__once = 0;
	if (g_once_init_enter (&unity_music_preview_track_data_columns_type_id__once)) {
		GType unity_music_preview_track_data_columns_type_id;
		unity_music_preview_track_data_columns_type_id = unity_music_preview_track_data_columns_get_type_once ();
		g_once_init_leave (&unity_music_preview_track_data_columns_type_id__once, unity_music_preview_track_data_columns_type_id);
	}
	return unity_music_preview_track_data_columns_type_id__once;
}
                                ...
                                gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityMusicPreview_private_offset);
...
unity_music_preview_instance_init (UnityMusicPreview * self,
                                   gpointer klass)
{
	self->priv = unity_music_preview_get_instance_private (self);
}
...
static GType
unity_music_preview_get_type_once (void)
{
	...
	UnityMusicPreview_private_offset = g_type_add_instance_private (unity_music_preview_type_id, sizeof (UnityMusicPreviewPrivate));
	return unity_music_preview_type_id;
}

GType
unity_music_preview_get_type (void)
{
	static volatile gsize unity_music_preview_type_id__once = 0;
	if (g_once_init_enter (&unity_music_preview_type_id__once)) {
		GType unity_music_preview_type_id;
		unity_music_preview_type_id = unity_music_preview_get_type_once ();
		g_once_init_leave (&unity_music_preview_type_id__once, unity_music_preview_type_id);
	}
	return unity_music_preview_type_id__once;
}

static inline gpointer
unity_payment_preview_get_instance_private (UnityPaymentPreview* self)
{
	return G_STRUCT_MEMBER_P (self, UnityPaymentPreview_private_offset);
}

static GType
unity_payment_preview_type_get_type_once (void)
{
	...
	return unity_payment_preview_type_type_id;
}

GType
unity_payment_preview_type_get_type (void)
{
	static volatile gsize unity_payment_preview_type_type_id__once = 0;
	if (g_once_init_enter (&unity_payment_preview_type_type_id__once)) {
		GType unity_payment_preview_type_type_id;
		unity_payment_preview_type_type_id = unity_payment_preview_type_get_type_once ();
		g_once_init_leave (&unity_payment_preview_type_type_id__once, unity_payment_preview_type_type_id);
	}
	return unity_payment_preview_type_type_id__once;
}
                                  ...
                                  gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityPaymentPreview_private_offset);
...
unity_payment_preview_instance_init (UnityPaymentPreview * self,
                                     gpointer klass)
{
	self->priv = unity_payment_preview_get_instance_private (self);
}
...
static GType
unity_payment_preview_get_type_once (void)
{
	...
	UnityPaymentPreview_private_offset = g_type_add_instance_private (unity_payment_preview_type_id, sizeof (UnityPaymentPreviewPrivate));
	return unity_payment_preview_type_id;
}

GType
unity_payment_preview_get_type (void)
{
	static volatile gsize unity_payment_preview_type_id__once = 0;
	if (g_once_init_enter (&unity_payment_preview_type_id__once)) {
		GType unity_payment_preview_type_id;
		unity_payment_preview_type_id = unity_payment_preview_get_type_once ();
		g_once_init_leave (&unity_payment_preview_type_id__once, unity_payment_preview_type_id);
	}
	return unity_payment_preview_type_id__once;
}
...
static inline gpointer
unity_movie_preview_get_instance_private (UnityMoviePreview* self)
{
	return G_STRUCT_MEMBER_P (self, UnityMoviePreview_private_offset);
}
                                ...
                                gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityMoviePreview_private_offset);
...
unity_movie_preview_instance_init (UnityMoviePreview * self,
                                   gpointer klass)
{
	self->priv = unity_movie_preview_get_instance_private (self);
}
...
static GType
unity_movie_preview_get_type_once (void)
{
	...
	UnityMoviePreview_private_offset = g_type_add_instance_private (unity_movie_preview_type_id, sizeof (UnityMoviePreviewPrivate));
	return unity_movie_preview_type_id;
}

GType
unity_movie_preview_get_type (void)
{
	static volatile gsize unity_movie_preview_type_id__once = 0;
	if (g_once_init_enter (&unity_movie_preview_type_id__once)) {
		GType unity_movie_preview_type_id;
		unity_movie_preview_type_id = unity_movie_preview_get_type_once ();
		g_once_init_leave (&unity_movie_preview_type_id__once, unity_movie_preview_type_id);
	}
	return unity_movie_preview_type_id__once;
}
...
static inline gpointer
unity_social_preview_get_instance_private (UnitySocialPreview* self)
{
	return G_STRUCT_MEMBER_P (self, UnitySocialPreview_private_offset);
}
                                  ...
                                  UnitySocialPreviewComment* comment)
{
	...
	_tmp1_ = _g_object_ref0 (UNITY_SOCIAL_PREVIEW_IS_COMMENT (_tmp0_) ? ((UnitySocialPreviewComment*) _tmp0_) : NULL);
	sunk = _tmp1_;
	_tmp2_ = self->priv->_raw;
...
static inline gpointer
unity_social_preview_comment_get_instance_private (UnitySocialPreviewComment* self)
{
	return G_STRUCT_MEMBER_P (self, UnitySocialPreviewComment_private_offset);
}
                                     ...
                                     const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_social_preview_comment_get_id (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
		_g_free0 (self->priv->_id);
                                       ...
                                       const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_social_preview_comment_get_name (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                       ...
                                       const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_social_preview_comment_get_text (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                       ...
                                       const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_social_preview_comment_get_time (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                         ...
                                         gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnitySocialPreviewComment_private_offset);
...
unity_social_preview_comment_instance_init (UnitySocialPreviewComment * self,
                                            gpointer klass)
{
	self->priv = unity_social_preview_comment_get_instance_private (self);
}
...
static GType
unity_social_preview_comment_get_type_once (void)
{
	...
	UnitySocialPreviewComment_private_offset = g_type_add_instance_private (unity_social_preview_comment_type_id, sizeof (UnitySocialPreviewCommentPrivate));
	return unity_social_preview_comment_type_id;
}

GType
unity_social_preview_comment_get_type (void)
{
	static volatile gsize unity_social_preview_comment_type_id__once = 0;
	if (g_once_init_enter (&unity_social_preview_comment_type_id__once)) {
		GType unity_social_preview_comment_type_id;
		unity_social_preview_comment_type_id = unity_social_preview_comment_get_type_once ();
		g_once_init_leave (&unity_social_preview_comment_type_id__once, unity_social_preview_comment_type_id);
	}
	return unity_social_preview_comment_type_id__once;
}
                                 ...
                                 gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnitySocialPreview_private_offset);
...
unity_social_preview_instance_init (UnitySocialPreview * self,
                                    gpointer klass)
{
	self->priv = unity_social_preview_get_instance_private (self);
}
...
static GType
unity_social_preview_get_type_once (void)
{
	...
	UnitySocialPreview_private_offset = g_type_add_instance_private (unity_social_preview_type_id, sizeof (UnitySocialPreviewPrivate));
	return unity_social_preview_type_id;
}

GType
unity_social_preview_get_type (void)
{
	static volatile gsize unity_social_preview_type_id__once = 0;
	if (g_once_init_enter (&unity_social_preview_type_id__once)) {
		GType unity_social_preview_type_id;
		unity_social_preview_type_id = unity_social_preview_get_type_once ();
		g_once_init_leave (&unity_social_preview_type_id__once, unity_social_preview_type_id);
	}
	return unity_social_preview_type_id__once;
}
