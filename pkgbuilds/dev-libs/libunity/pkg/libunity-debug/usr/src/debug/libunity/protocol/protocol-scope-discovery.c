/* protocol-scope-discovery.c generated by valac 0.56.19, the Vala compiler
...
#define UNITY_PROTOCOL_TYPE_PARSE_ERROR (unity_protocol_parse_error_get_type ())
...
static gint UnityProtocolMetaDataColumnInfo_private_offset;
...
static gint UnityProtocolCategoryDefinition_private_offset;
static gpointer unity_protocol_category_definition_parent_class = NULL;
static gint UnityProtocolFilterDefinition_private_offset;
static gpointer unity_protocol_filter_definition_parent_class = NULL;
static gint UnityProtocolScopeRegistry_private_offset;
...
static gint UnityProtocolScopeRegistryScopeMetadata_private_offset;
...
VALA_EXTERN GQuark unity_protocol_parse_error_quark (void);
VALA_EXTERN GType unity_protocol_parse_error_get_type (void) G_GNUC_CONST ;
VALA_EXTERN void unity_protocol_meta_data_column_info_set_name (UnityProtocolMetaDataColumnInfo* self,
                                                    const gchar* value);
VALA_EXTERN void unity_protocol_meta_data_column_info_set_type_id (UnityProtocolMetaDataColumnInfo* self,
                                                       const gchar* value);
...
static GType unity_protocol_meta_data_column_info_get_type_once (void);
...
static GType unity_protocol_meta_data_schema_info_get_type_once (void);
VALA_EXTERN UnityProtocolCategoryDefinition* unity_protocol_category_definition_create (const gchar* id,
                                                                            const gchar* name,
                                                                            const gchar* icon,
...
static GType unity_protocol_category_definition_get_type_once (void);
...
static void _vala_array_add6 (gchar** * array,
                       ...
                       gint* size,
                       gchar* value);
VALA_EXTERN UnityProtocolFilterDefinition* unity_protocol_filter_definition_create (const gchar* id,
...
static GType unity_protocol_filter_definition_get_type_once (void);
...
VALA_EXTERN void unity_protocol_scope_registry_init_scope_file_prefixes (void);
VALA_EXTERN void unity_protocol_scope_registry_init_scope_directories (void);
...
static void unity_protocol_scope_registry_build_scope_node_tree_ready (GObject* source_object,
                                                                GAsyncResult* _res_,
                                                                gpointer _user_data_);
VALA_EXTERN gboolean unity_protocol_scope_registry_scope_metadata_get_overrides_subscopes (UnityProtocolScopeRegistryScopeMetadata* self);
VALA_EXTERN gchar* unity_protocol_scope_registry_remove_scope_extension (const gchar* scope_id);
...
VALA_EXTERN void unity_protocol_scope_registry_scope_metadata_update_hidden_scope_ids (void);
...
static GType unity_protocol_scope_registry_scope_metadata_get_type_once (void);
static void unity_protocol_scope_registry_scope_registry_node_finalize (UnityProtocolScopeRegistryScopeRegistryNode * obj);
static GType unity_protocol_scope_registry_scope_registry_node_get_type_once (void);
static void unity_protocol_scope_registry_finalize (UnityProtocolScopeRegistry * obj);
static GType unity_protocol_scope_registry_get_type_once (void);
...
static GType unity_protocol_scope_group_config_get_type_once (void);
...
{
	return g_quark_from_static_string ("unity-protocol-parse-error-quark");
}

static GType
unity_protocol_parse_error_get_type_once (void)
{
	static const GEnumValue values[] = {{UNITY_PROTOCOL_PARSE_ERROR_INVALID_METADATA, "UNITY_PROTOCOL_PARSE_ERROR_INVALID_METADATA", "invalid-metadata"}, {UNITY_PROTOCOL_PARSE_ERROR_FILE_NOT_FOUND, "UNITY_PROTOCOL_PARSE_ERROR_FILE_NOT_FOUND", "file-not-found"}, {UNITY_PROTOCOL_PARSE_ERROR_INVALID_PATH, "UNITY_PROTOCOL_PARSE_ERROR_INVALID_PATH", "invalid-path"}, {UNITY_PROTOCOL_PARSE_ERROR_UNKNOWN_FILE, "UNITY_PROTOCOL_PARSE_ERROR_UNKNOWN_FILE", "unknown-file"}, {0, NULL, NULL}};
	GType unity_protocol_parse_error_type_id;
	unity_protocol_parse_error_type_id = g_enum_register_static ("UnityProtocolParseError", values);
	return unity_protocol_parse_error_type_id;
}

GType
unity_protocol_parse_error_get_type (void)
{
	static volatile gsize unity_protocol_parse_error_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_parse_error_type_id__once)) {
		GType unity_protocol_parse_error_type_id;
		unity_protocol_parse_error_type_id = unity_protocol_parse_error_get_type_once ();
		g_once_init_leave (&unity_protocol_parse_error_type_id__once, unity_protocol_parse_error_type_id);
	}
	return unity_protocol_parse_error_type_id__once;
}

static inline gpointer
unity_protocol_meta_data_column_info_get_instance_private (UnityProtocolMetaDataColumnInfo* self)
{
	return G_STRUCT_MEMBER_P (self, UnityProtocolMetaDataColumnInfo_private_offset);
}
                                                ...
                                                GError** error)
{
	...
	if (idx > 0) {
		...
		_tmp1_ = strlen (v);
		_tmp2_ = _tmp1_;
		_tmp0_ = string_index_of (v, "]", 0) == (_tmp2_ - 1);
	} else {
		_tmp0_ = FALSE;
	}
	if (_tmp0_) {
		...
		gchar* _tmp7_;
		gchar* _tmp8_;
		_tmp3_ = string_substring (v, (glong) 0, (glong) idx);
		_tmp4_ = _tmp3_;
		unity_protocol_meta_data_column_info_set_name (self, _tmp4_);
		_g_free0 (_tmp4_);
		_tmp5_ = strlen (v);
		_tmp6_ = _tmp5_;
		_tmp7_ = string_slice (v, (glong) (idx + 1), (glong) (_tmp6_ - 1));
		_tmp8_ = _tmp7_;
		unity_protocol_meta_data_column_info_set_type_id (self, _tmp8_);
		_g_free0 (_tmp8_);
	} else {
		GError* _tmp9_;
		_tmp9_ = g_error_new_literal (UNITY_PROTOCOL_PARSE_ERROR, UNITY_PROTOCOL_PARSE_ERROR_INVALID_METADATA, "Invalid format of meta data string");
...
unity_protocol_meta_data_column_info_equals (UnityProtocolMetaDataColumnInfo* self,
                                             UnityProtocolMetaDataColumnInfo* m)
{
	UnityProtocolMetaDataColumnInfoClass* _klass_;
	g_return_val_if_fail (self != NULL, FALSE);
	_klass_ = UNITY_PROTOCOL_META_DATA_COLUMN_INFO_GET_CLASS (self);
	if (_klass_->equals) {
		return _klass_->equals (self, m);
	}
	return FALSE;
}
                                                 ...
                                                 gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityProtocolMetaDataColumnInfo_private_offset);
...
unity_protocol_meta_data_column_info_instance_init (UnityProtocolMetaDataColumnInfo * self,
                                                    gpointer klass)
{
	self->priv = unity_protocol_meta_data_column_info_get_instance_private (self);
	self->ref_count = 1;
}
...
static GType
unity_protocol_meta_data_column_info_get_type_once (void)
{
	...
	UnityProtocolMetaDataColumnInfo_private_offset = g_type_add_instance_private (unity_protocol_meta_data_column_info_type_id, sizeof (UnityProtocolMetaDataColumnInfoPrivate));
	return unity_protocol_meta_data_column_info_type_id;
}

GType
unity_protocol_meta_data_column_info_get_type (void)
{
	static volatile gsize unity_protocol_meta_data_column_info_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_meta_data_column_info_type_id__once)) {
		GType unity_protocol_meta_data_column_info_type_id;
		unity_protocol_meta_data_column_info_type_id = unity_protocol_meta_data_column_info_get_type_once ();
		g_once_init_leave (&unity_protocol_meta_data_column_info_type_id__once, unity_protocol_meta_data_column_info_type_id);
	}
	return unity_protocol_meta_data_column_info_type_id__once;
}
                                                  ...
                                                  GError** error)
{
	...
	gchar** _tmp4_;
	GError* _inner_error0_ = NULL;
	UnityProtocolMetaDataSchemaInfo* result;
		...
		for (m_it = 0; m_it < m_collection_length1; m_it = m_it + 1) {
			...
			m = _tmp5_;
			{
				...
				if (_tmp8_ > 0) {
					...
					_tmp9_ = m;
					_tmp10_ = unity_protocol_meta_data_column_info_new (_tmp9_, &_inner_error0_);
					info = _tmp10_;
	...
	ret = _tmp2_;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				GHashTable* _tmp10_;
				UnityProtocolMetaDataColumnInfo* _tmp11_;
				const gchar* _tmp12_;
				const gchar* _tmp13_;
				gchar* _tmp14_;
				UnityProtocolMetaDataColumnInfo* _tmp15_;
				const gchar* _tmp16_;
				const gchar* _tmp17_;
				gchar* _tmp18_;
				if (!_tmp3_) {
				...
				info = (UnityProtocolMetaDataColumnInfo*) _tmp9_;
				_tmp10_ = ret;
				_tmp11_ = info;
				_tmp12_ = unity_protocol_meta_data_column_info_get_name (_tmp11_);
				_tmp13_ = _tmp12_;
				_tmp14_ = g_strdup (_tmp13_);
				_tmp15_ = info;
				_tmp16_ = unity_protocol_meta_data_column_info_get_type_id (_tmp15_);
				_tmp17_ = _tmp16_;
				_tmp18_ = g_strdup (_tmp17_);
				g_hash_table_insert (_tmp10_, _tmp14_, _tmp18_);
			}
		}
	}
	result = ret;
	...
	}
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp11_ = self->columns;
				_tmp12_ = g_ptr_array_index (_tmp11_, (guint) i);
				_tmp13_ = s->columns;
				_tmp14_ = g_ptr_array_index (_tmp13_, (guint) i);
				if (!unity_protocol_meta_data_column_info_equals ((UnityProtocolMetaDataColumnInfo*) _tmp12_, (UnityProtocolMetaDataColumnInfo*) _tmp14_)) {
					result = FALSE;
					return result;
				}
			}
...
static GType
unity_protocol_meta_data_schema_info_get_type_once (void)
{
	...
	return unity_protocol_meta_data_schema_info_type_id;
}

GType
unity_protocol_meta_data_schema_info_get_type (void)
{
	static volatile gsize unity_protocol_meta_data_schema_info_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_meta_data_schema_info_type_id__once)) {
		GType unity_protocol_meta_data_schema_info_type_id;
		unity_protocol_meta_data_schema_info_type_id = unity_protocol_meta_data_schema_info_get_type_once ();
		g_once_init_leave (&unity_protocol_meta_data_schema_info_type_id__once, unity_protocol_meta_data_schema_info_type_id);
	}
	return unity_protocol_meta_data_schema_info_type_id__once;
}
...
static inline gpointer
unity_protocol_category_definition_get_instance_private (UnityProtocolCategoryDefinition* self)
{
	return G_STRUCT_MEMBER_P (self, UnityProtocolCategoryDefinition_private_offset);
}
                                               ...
                                               gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityProtocolCategoryDefinition_private_offset);
}
...
unity_protocol_category_definition_instance_init (UnityProtocolCategoryDefinition * self,
                                                  gpointer klass)
{
	self->priv = unity_protocol_category_definition_get_instance_private (self);
	self->ref_count = 1;
}
...
static GType
unity_protocol_category_definition_get_type_once (void)
{
	...
	UnityProtocolCategoryDefinition_private_offset = g_type_add_instance_private (unity_protocol_category_definition_type_id, sizeof (UnityProtocolCategoryDefinitionPrivate));
	return unity_protocol_category_definition_type_id;
}

GType
unity_protocol_category_definition_get_type (void)
{
	static volatile gsize unity_protocol_category_definition_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_category_definition_type_id__once)) {
		GType unity_protocol_category_definition_type_id;
		unity_protocol_category_definition_type_id = unity_protocol_category_definition_get_type_once ();
		g_once_init_leave (&unity_protocol_category_definition_type_id__once, unity_protocol_category_definition_type_id);
	}
	return unity_protocol_category_definition_type_id__once;
}
...
static inline gpointer
unity_protocol_filter_definition_get_instance_private (UnityProtocolFilterDefinition* self)
{
	return G_STRUCT_MEMBER_P (self, UnityProtocolFilterDefinition_private_offset);
}
                                             ...
                                             const gchar* name)
{
	...
	_tmp0_ = g_strdup (id);
	_vala_array_add5 (&self->priv->option_ids, &self->priv->option_ids_length1, &self->priv->_option_ids_size_, _tmp0_);
	_tmp1_ = g_strdup (name);
	_vala_array_add6 (&self->priv->option_names, &self->priv->option_names_length1, &self->priv->_option_names_size_, _tmp1_);
}
                                             ...
                                             gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityProtocolFilterDefinition_private_offset);
}
...
unity_protocol_filter_definition_instance_init (UnityProtocolFilterDefinition * self,
                                                gpointer klass)
{
	self->priv = unity_protocol_filter_definition_get_instance_private (self);
	self->ref_count = 1;
}
...
static GType
unity_protocol_filter_definition_get_type_once (void)
{
	...
	UnityProtocolFilterDefinition_private_offset = g_type_add_instance_private (unity_protocol_filter_definition_type_id, sizeof (UnityProtocolFilterDefinitionPrivate));
	return unity_protocol_filter_definition_type_id;
}

GType
unity_protocol_filter_definition_get_type (void)
{
	static volatile gsize unity_protocol_filter_definition_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_filter_definition_type_id__once)) {
		GType unity_protocol_filter_definition_type_id;
		unity_protocol_filter_definition_type_id = unity_protocol_filter_definition_get_type_once ();
		g_once_init_leave (&unity_protocol_filter_definition_type_id__once, unity_protocol_filter_definition_type_id);
	}
	return unity_protocol_filter_definition_type_id__once;
}
...
static inline gpointer
unity_protocol_scope_registry_get_instance_private (UnityProtocolScopeRegistry* self)
{
	return G_STRUCT_MEMBER_P (self, UnityProtocolScopeRegistry_private_offset);
}
...
unity_protocol_scope_registry_init_scope_file_prefixes (void)
{
	...
	_tmp2__length1 = unity_protocol_scope_registry_scope_directories_length1;
	{
		...
		for (scope_dir_it = 0; scope_dir_it < scope_dir_collection_length1; scope_dir_it = scope_dir_it + 1) {
			...
			scope_dir = scope_dir_collection[scope_dir_it];
			{
				...
				_vala_array_add7 (&unity_protocol_scope_registry_scope_file_prefixes, &unity_protocol_scope_registry_scope_file_prefixes_length1, &_unity_protocol_scope_registry_scope_file_prefixes_size_, _tmp8_);
				_g_free0 (_tmp7_);
				_g_object_unref0 (f);
			}
		}
...
unity_protocol_scope_registry_init_scope_directories (void)
{
	...
	if (_tmp3_ == NULL) {
		...
		_tmp7_ = (_tmp6_ != NULL) ? _vala_array_dup5 (_tmp6_, _vala_array_length (_tmp5_)) : _tmp6_;
		...
		_tmp8__length1 = data_dirs_length1;
		{
			...
			for (data_dir_it = 0; data_dir_it < data_dir_collection_length1; data_dir_it = data_dir_it + 1) {
				...
				data_dir = data_dir_collection[data_dir_it];
				{
					...
					gchar* _tmp10_;
					_tmp9_ = data_dir;
					_tmp10_ = g_build_filename (_tmp9_, UNITY_PROTOCOL_SCOPES_DIR, NULL);
					_vala_array_add8 (&unity_protocol_scope_registry_scope_directories, &unity_protocol_scope_registry_scope_directories_length1, &_unity_protocol_scope_registry_scope_directories_size_, _tmp10_);
				}
			}
		}
		...
		gchar** _tmp12_;
		gchar** _tmp13_;
		_tmp11_ = overriden_dirs;
		_tmp13_ = _tmp12_ = g_strsplit (_tmp11_, ":", 0);
		unity_protocol_scope_registry_scope_directories = (_vala_array_free (unity_protocol_scope_registry_scope_directories, unity_protocol_scope_registry_scope_directories_length1, (GDestroyNotify) g_free), NULL);
		unity_protocol_scope_registry_scope_directories = _tmp13_;
		unity_protocol_scope_registry_scope_directories_length1 = _vala_array_length (_tmp12_);
		_unity_protocol_scope_registry_scope_directories_size_ = unity_protocol_scope_registry_scope_directories_length1;
	}
...
unity_protocol_scope_registry_find_scopes_co (UnityProtocolScopeRegistryFindScopesData* _data_)
{
	...
	if (_data_->start_path == NULL) {
		...
		_data_->_tmp2__length1 = unity_protocol_scope_registry_scope_directories_length1;
		{
			...
			for (_data_->scope_dir_it = 0; _data_->scope_dir_it < _data_->scope_dir_collection_length1; _data_->scope_dir_it = _data_->scope_dir_it + 1) {
				_data_->scope_dir = _data_->scope_dir_collection[_data_->scope_dir_it];
				{
					...
					}
					{
						...
						return FALSE;
						_state_1:
						unity_protocol_scope_registry_build_scope_node_tree_finish (_data_->_res_, &_data_->_inner_error0_);
...
"%s", g_node_depth (_data_->root_node), _data_->start_path);
	if (g_file_test (_data_->start_path, G_FILE_TEST_IS_DIR)) {
		_data_->_tmp0_ = g_dir_open (_data_->start_path, (guint) 0, &_data_->_inner_error0_);
		...
		_data_->_tmp13_ = unity_protocol_scope_registry_scope_metadata_for_path (_data_->start_path, &_data_->_inner_error0_);
		...
		if (!_data_->scope_id_present) {
			_data_->_tmp19_ = _data_->scope_data;
			_data_->_tmp20_ = _unity_protocol_scope_registry_scope_metadata_ref0 (_data_->_tmp19_);
			_data_->_tmp21_ = g_node_append_data (_data_->root_node, _data_->_tmp20_);
			_data_->child_node = _data_->_tmp21_;
		}
		_data_->_tmp22_ = _data_->child_node;
		_vala_assert (_data_->_tmp22_ != NULL, "child_node != null");
		_data_->_tmp23_ = _data_->child_node;
		_data_->_tmp24_ = _data_->_tmp23_->data;
		if (((UnityProtocolScopeRegistryScopeMetadata*) _data_->_tmp24_)->is_master) {
			_data_->_tmp26_ = _data_->child_node;
			_data_->_tmp27_ = _data_->_tmp26_->data;
			if (unity_protocol_scope_registry_scope_metadata_get_overrides_subscopes ((UnityProtocolScopeRegistryScopeMetadata*) _data_->_tmp27_)) {
				_data_->_tmp28_ = _data_->child_node;
				_data_->_tmp25_ = g_node_n_children (_data_->_tmp28_) == ((guint) 0);
			} else {
				_data_->_tmp25_ = FALSE;
			}
			if (_data_->_tmp25_) {
				_data_->_tmp29_ = _data_->child_node;
				_data_->_tmp30_ = _data_->_tmp29_->data;
				_data_->_tmp31_ = ((UnityProtocolScopeRegistryScopeMetadata*) _data_->_tmp30_)->id;
				g_debug ("protocol-scope-discovery.vala:770: Scope %s overrides its children", _data_->_tmp31_);
				_data_->_tmp32_ = _data_->child_node;
				_data_->_tmp33_ = _data_->_tmp32_->data;
				_data_->_tmp34_ = 0;
				_data_->_tmp35_ = unity_protocol_scope_registry_scope_metadata_get_subscope_ids ((UnityProtocolScopeRegistryScopeMetadata*) _data_->_tmp33_, &_data_->_tmp34_);
				_data_->subscopes = _data_->_tmp35_;
				_data_->subscopes_length1 = _data_->_tmp34_;
				_data_->_subscopes_size_ = _data_->subscopes_length1;
				_data_->_tmp36_ = _data_->subscopes;
				_data_->_tmp36__length1 = _data_->subscopes_length1;
				{
					_data_->subscope_id_collection_length1 = 0;
					_data_->_subscope_id_collection_size_ = 0;
					_data_->subscope_id_collection = _data_->_tmp36_;
					_data_->subscope_id_collection_length1 = _data_->_tmp36__length1;
					for (_data_->subscope_id_it = 0; _data_->subscope_id_it < _data_->subscope_id_collection_length1; _data_->subscope_id_it = _data_->subscope_id_it + 1) {
						_data_->subscope_id = _data_->subscope_id_collection[_data_->subscope_id_it];
						{
							{
								_data_->_tmp37_ = _data_->subscope_id;
								_data_->_tmp38_ = unity_protocol_scope_registry_scope_metadata_for_id (_data_->_tmp37_, &_data_->_inner_error0_);
								_data_->subscope_data = _data_->_tmp38_;
								if (G_UNLIKELY (_data_->_inner_error0_ != NULL)) {
									goto __catch1_g_error;
								}
								_data_->_tmp40_ = _data_->subscope_data;
								if (_data_->_tmp40_ != NULL) {
									_data_->_tmp41_ = _data_->child_node;
									_data_->_tmp42_ = _data_->subscope_data;
									_data_->_tmp43_ = _data_->_tmp42_->id;
									_data_->_tmp39_ = !unity_protocol_scope_registry_node_has_child_with_id (_data_->_tmp41_, _data_->_tmp43_, NULL);
								} else {
									_data_->_tmp39_ = FALSE;
								}
								if (_data_->_tmp39_) {
									_data_->_tmp44_ = _data_->child_node;
									_data_->_tmp45_ = _data_->subscope_data;
									_data_->_tmp46_ = _unity_protocol_scope_registry_scope_metadata_ref0 (_data_->_tmp45_);
									g_node_append_data (_data_->_tmp44_, _data_->_tmp46_);
								}
							...
							__catch1_g_error:
							{
								...
								_data_->_inner_error0_ = NULL;
								_data_->_tmp47_ = _data_->subscope_id;
								_data_->_tmp48_ = _data_->_vala1_e;
								_data_->_tmp49_ = _data_->_tmp48_->message;
								g_warning ("protocol-scope-discovery.vala:787: Failed to process '%s': %s", _data_->_tmp47_, _data_->_tmp49_);
				...
				_data_->_tmp50_ = _data_->scope_data;
				_data_->_tmp51_ = _data_->_tmp50_->full_path;
				_data_->_tmp52_ = g_file_new_for_path (_data_->_tmp51_);
				_data_->scopefile = _data_->_tmp52_;
				_data_->_tmp53_ = _data_->scopefile;
				_data_->_tmp54_ = g_file_get_parent (_data_->_tmp53_);
				_data_->parent = _data_->_tmp54_;
				_data_->_tmp55_ = _data_->parent;
				...
				_data_->_tmp56_ = _data_->scope_data;
				_data_->_tmp57_ = _data_->_tmp56_->id;
				_data_->_tmp58_ = unity_protocol_scope_registry_remove_scope_extension (_data_->_tmp57_);
				_data_->scope_name = _data_->_tmp58_;
				_data_->_tmp59_ = _data_->parent;
				_data_->_tmp60_ = g_file_get_path (_data_->_tmp59_);
				_data_->_tmp61_ = _data_->_tmp60_;
				_data_->_tmp62_ = _data_->scope_name;
				_data_->_tmp63_ = g_build_filename (_data_->_tmp61_, _data_->_tmp62_, NULL);
				_data_->_tmp64_ = _data_->_tmp63_;
				_g_free0 (_data_->_tmp61_);
				_data_->check_path = _data_->_tmp64_;
				_data_->_tmp65_ = _data_->check_path;
				if (!g_file_test (_data_->_tmp65_, G_FILE_TEST_IS_DIR)) {
				...
				_data_->_tmp66_ = _data_->child_node;
				_data_->_tmp67_ = _data_->check_path;
				_data_->_state_ = 2;
				unity_protocol_scope_registry_build_scope_node_tree (_data_->_tmp66_, _data_->_tmp67_, unity_protocol_scope_registry_build_scope_node_tree_ready, _data_);
				return FALSE;
				_state_2:
				unity_protocol_scope_registry_build_scope_node_tree_finish (_data_->_res_, &_data_->_inner_error0_);
				if (G_UNLIKELY (_data_->_inner_error0_ != NULL)) {
...
unity_protocol_scope_registry_find_scopes_for_id_co (UnityProtocolScopeRegistryFindScopesForIdData* _data_)
{
	...
	_data_->root_node = _data_->_tmp1_;
	{
		_data_->_tmp2_ = unity_protocol_scope_registry_scope_metadata_for_id (_data_->scope_id, &_data_->_inner_error0_);
	...
	if (_data_->root_path == NULL) {
		...
		_data_->_tmp9_ = (_data_->_tmp8_ != NULL) ? _vala_array_dup6 (_data_->_tmp8_, _data_->_tmp8__length1) : _data_->_tmp8_;
...
static inline gpointer
unity_protocol_scope_registry_scope_metadata_get_instance_private (UnityProtocolScopeRegistryScopeMetadata* self)
{
	return G_STRUCT_MEMBER_P (self, UnityProtocolScopeRegistryScopeMetadata_private_offset);
}
...
unity_protocol_scope_registry_scope_metadata_get_overrides_subscopes (UnityProtocolScopeRegistryScopeMetadata* self)
{
	gboolean result;
	g_return_val_if_fail (self != NULL, FALSE);
	result = self->priv->overrides_subscopes;
	return result;
}
                                                                 ...
                                                                 GError** error)
{
	...
	if (g_key_file_has_group (file, UNITY_PROTOCOL_SCOPE_REGISTRY_DESKTOP_GROUP)) {
		gboolean _tmp1_ = FALSE;
		_tmp1_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_DESKTOP_GROUP, "X-Ubuntu-Gettext-Domain", &_inner_error0_);
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			return;
		}
	...
	if (_tmp0_) {
		...
		gchar* _tmp3_;
		gchar* _tmp4_;
		_tmp3_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_DESKTOP_GROUP, "X-Ubuntu-Gettext-Domain", &_inner_error0_);
		_tmp2_ = _tmp3_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			return;
	...
	_tmp6_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Name", &_inner_error0_);
	_tmp5_ = _tmp6_;
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		return;
	...
	_g_free0 (self->name);
	self->name = _tmp8_;
	_tmp9_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "DBusName", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp5_);
		return;
	...
	if (_tmp9_) {
		...
		gchar* _tmp11_;
		gchar* _tmp12_;
		_tmp11_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "DBusName", &_inner_error0_);
		_tmp10_ = _tmp11_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp5_);
		...
		gchar* _tmp14_;
		gchar* _tmp15_;
		_tmp14_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "GroupName", &_inner_error0_);
		_tmp13_ = _tmp14_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp5_);
	...
	_tmp16_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "DBusPath", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp5_);
		return;
	...
	if (_tmp16_) {
		...
		gchar* _tmp18_;
		gchar* _tmp19_;
		_tmp18_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "DBusPath", &_inner_error0_);
		_tmp17_ = _tmp18_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp5_);
		...
		gchar* _tmp21_;
		gchar* _tmp22_;
		_tmp21_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "UniqueName", &_inner_error0_);
		_tmp20_ = _tmp21_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp5_);
	...
	_tmp24_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Icon", &_inner_error0_);
	_tmp23_ = _tmp24_;
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp5_);
	...
	_g_free0 (self->icon);
	self->icon = _tmp25_;
	_tmp27_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Type", &_inner_error0_);
	_tmp26_ = _tmp27_;
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp23_);
	...
	_g_free0 (self->type);
	self->type = _tmp28_;
	_tmp29_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "IsMaster", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp29_) {
		...
		_tmp30_ = g_key_file_get_boolean (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "IsMaster", &_inner_error0_);
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
			_g_free0 (_tmp23_);
	...
	_tmp31_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Module", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp31_) {
		...
		gchar* _tmp33_;
		gchar* _tmp34_;
		_tmp33_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Module", &_inner_error0_);
		_tmp32_ = _tmp33_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
	...
	_tmp35_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "ModuleType", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp35_) {
		...
		gchar* _tmp37_;
		gchar* _tmp38_;
		_tmp37_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "ModuleType", &_inner_error0_);
		_tmp36_ = _tmp37_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
	...
	_tmp39_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Visible", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp39_) {
		...
		_tmp40_ = g_key_file_get_boolean (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Visible", &_inner_error0_);
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
			_g_free0 (_tmp23_);
	...
	_tmp41_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "GlobalSearches", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp41_) {
		...
		_tmp42_ = g_key_file_get_boolean (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "GlobalSearches", &_inner_error0_);
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
			_g_free0 (_tmp23_);
	...
	_tmp43_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "RemoteContent", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp43_) {
		...
		_tmp44_ = g_key_file_get_boolean (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "RemoteContent", &_inner_error0_);
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
			_g_free0 (_tmp23_);
	...
	_tmp45_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "QueryBinary", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp45_) {
		...
		gchar* _tmp47_;
		gchar* _tmp48_;
		_tmp47_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "QueryBinary", &_inner_error0_);
		_tmp46_ = _tmp47_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
	...
	_tmp49_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "CategoryIcon", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp49_) {
		...
		gchar* _tmp51_;
		gchar* _tmp52_;
		_tmp51_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "CategoryIcon", &_inner_error0_);
		_tmp50_ = _tmp51_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
	...
	_tmp53_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "QueryPattern", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp53_) {
		...
		gchar* _tmp55_;
		gchar* _tmp56_;
		_tmp55_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "QueryPattern", &_inner_error0_);
		_tmp54_ = _tmp55_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
	...
	_tmp57_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Description", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp57_) {
		...
		gchar* _tmp59_;
		gchar* _tmp60_;
		_tmp59_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Description", &_inner_error0_);
		_tmp58_ = _tmp59_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
	...
	_tmp61_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "SearchHint", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp61_) {
		...
		const gchar* _tmp64_;
		gchar* _tmp65_;
		_tmp63_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "SearchHint", &_inner_error0_);
		_tmp62_ = _tmp63_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
	...
	_tmp66_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "RequiredMetadata", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp66_) {
		...
		_tmp68_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "RequiredMetadata", &_inner_error0_);
		_tmp67_ = _tmp68_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
		...
		_tmp70_ = unity_protocol_meta_data_schema_info_from_string (_tmp67_, &_inner_error0_);
		_tmp69_ = _tmp70_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp67_);
	...
	_tmp72_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "OptionalMetadata", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp72_) {
		...
		_tmp74_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "OptionalMetadata", &_inner_error0_);
		_tmp73_ = _tmp74_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
		...
		_tmp76_ = unity_protocol_meta_data_schema_info_from_string (_tmp73_, &_inner_error0_);
		_tmp75_ = _tmp76_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp73_);
	...
	_tmp78_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Keywords", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp78_) {
		...
		self->keywords = NULL;
		_tmp80_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Keywords", &_inner_error0_);
		_tmp79_ = _tmp80_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
	...
	_tmp89_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Shortcut", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp89_) {
		...
		gchar* _tmp91_;
		gchar* _tmp92_;
		_tmp91_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Shortcut", &_inner_error0_);
		_tmp90_ = _tmp91_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
	...
	_tmp93_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Timeout", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp93_) {
		gint _tmp94_ = 0;
		_tmp94_ = g_key_file_get_integer (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Timeout", &_inner_error0_);
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
			_g_free0 (_tmp23_);
	...
	_tmp95_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "NoExport", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp95_) {
		...
		_tmp96_ = g_key_file_get_boolean (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "NoExport", &_inner_error0_);
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
			_g_free0 (_tmp23_);
	...
	_tmp97_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "NoContentHint", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp97_) {
		...
		gchar* _tmp101_;
		_tmp99_ = g_key_file_get_string (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "NoContentHint", &_inner_error0_);
		_tmp98_ = _tmp99_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_free0 (_tmp26_);
	...
	_tmp102_ = g_key_file_has_key (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Subscopes", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp23_);
	...
	if (_tmp102_) {
		...
		_tmp105_ = g_key_file_get_string_list (file, UNITY_PROTOCOL_SCOPE_REGISTRY_SCOPE_GROUP, "Subscopes", &_tmp104_, &_inner_error0_);
		_tmp103_ = _tmp105_;
		...
		for (group_name_it = 0; group_name_it < group_name_collection_length1; group_name_it = group_name_it + 1) {
			...
			group_name = group_name_collection[group_name_it];
			{
				...
				if (_tmp111_) {
					...
					id = _tmp124_;
					_tmp126_ = group_name;
					_tmp127_ = g_key_file_get_string (file, _tmp126_, "Name", &_inner_error0_);
					_tmp125_ = _tmp127_;
					if (G_UNLIKELY (_inner_error0_ != NULL)) {
						g_propagate_error (error, _inner_error0_);
						_g_free0 (id);
					...
					name = _tmp129_;
					_tmp130_ = group_name;
					_tmp131_ = g_key_file_get_string (file, _tmp130_, "Icon", &_inner_error0_);
					icon = _tmp131_;
					if (G_UNLIKELY (_inner_error0_ != NULL)) {
						g_propagate_error (error, _inner_error0_);
						_g_free0 (name);
					...
					dedup_field = NULL;
					_tmp133_ = group_name;
					_tmp132_ = g_key_file_has_key (file, _tmp133_, "DedupField", &_inner_error0_);
					if (G_UNLIKELY (_inner_error0_ != NULL)) {
						g_propagate_error (error, _inner_error0_);
					...
					if (_tmp132_) {
						...
						gchar* _tmp137_;
						_tmp135_ = group_name;
						_tmp136_ = g_key_file_get_string (file, _tmp135_, "DedupField", &_inner_error0_);
						_tmp134_ = _tmp136_;
						if (G_UNLIKELY (_inner_error0_ != NULL)) {
							g_propagate_error (error, _inner_error0_);
							_g_free0 (dedup_field);
					...
					sort_field = NULL;
					_tmp139_ = group_name;
					_tmp138_ = g_key_file_has_key (file, _tmp139_, "SortField", &_inner_error0_);
					if (G_UNLIKELY (_inner_error0_ != NULL)) {
						g_propagate_error (error, _inner_error0_);
						_g_free0 (sort_field);
						_g_free0 (dedup_field);
					...
					if (_tmp138_) {
						...
						gchar* _tmp143_;
						_tmp141_ = group_name;
						_tmp142_ = g_key_file_get_string (file, _tmp141_, "SortField", &_inner_error0_);
						_tmp140_ = _tmp142_;
						if (G_UNLIKELY (_inner_error0_ != NULL)) {
							g_propagate_error (error, _inner_error0_);
							_g_free0 (sort_field);
					...
					renderer = NULL;
					_tmp145_ = group_name;
					_tmp144_ = g_key_file_has_key (file, _tmp145_, "Renderer", &_inner_error0_);
					if (G_UNLIKELY (_inner_error0_ != NULL)) {
						g_propagate_error (error, _inner_error0_);
						_g_free0 (renderer);
						_g_free0 (sort_field);
					...
					if (_tmp144_) {
						...
						gchar* _tmp149_;
						_tmp147_ = group_name;
						_tmp148_ = g_key_file_get_string (file, _tmp147_, "Renderer", &_inner_error0_);
						_tmp146_ = _tmp148_;
						if (G_UNLIKELY (_inner_error0_ != NULL)) {
							g_propagate_error (error, _inner_error0_);
							_g_free0 (renderer);
					...
					_tmp151_ = group_name;
					_tmp150_ = g_key_file_has_key (file, _tmp151_, "ContentType", &_inner_error0_);
					if (G_UNLIKELY (_inner_error0_ != NULL)) {
						g_propagate_error (error, _inner_error0_);
					...
					if (_tmp150_) {
						...
						gchar* _tmp155_;
						_tmp153_ = group_name;
						_tmp154_ = g_key_file_get_string (file, _tmp153_, "ContentType", &_inner_error0_);
						_tmp152_ = _tmp154_;
						if (G_UNLIKELY (_inner_error0_ != NULL)) {
							g_propagate_error (error, _inner_error0_);
							_g_free0 (cat_content_type);
					...
					renderer_hint = NULL;
					_tmp157_ = group_name;
					_tmp156_ = g_key_file_has_key (file, _tmp157_, "RendererHint", &_inner_error0_);
					if (G_UNLIKELY (_inner_error0_ != NULL)) {
						g_propagate_error (error, _inner_error0_);
					...
					if (_tmp156_) {
						...
						gchar* _tmp161_;
						_tmp159_ = group_name;
						_tmp160_ = g_key_file_get_string (file, _tmp159_, "RendererHint", &_inner_error0_);
						_tmp158_ = _tmp160_;
						if (G_UNLIKELY (_inner_error0_ != NULL)) {
							g_propagate_error (error, _inner_error0_);
							_g_free0 (renderer_hint);
					...
					if (_tmp170_ != NULL) {
						...
						_tmp173_ = category_definition;
						_tmp174_ = _unity_protocol_category_definition_ref0 (_tmp173_);
						_vala_array_add9 (&self->priv->categories, &self->priv->categories_length1, &self->priv->_categories_size_, _tmp174_);
					}
					...
					_tmp176_ = group_name;
					if (g_str_has_prefix (_tmp176_, FILTER_PREFIX)) {
						...
						_tmp179_ = _tmp178_;
						_tmp180_ = strlen (FILTER_PREFIX);
						_tmp181_ = _tmp180_;
						_tmp175_ = _tmp179_ >= (_tmp181_ + 1);
					} else {
						_tmp175_ = FALSE;
					}
					if (_tmp175_) {
						...
						UnityProtocolFilterDefinition* _tmp206_;
						...
						UnityProtocolFilterDefinition* _tmp243_;
						_tmp182_ = stripped;
						_tmp183_ = strlen (FILTER_PREFIX);
						_tmp184_ = _tmp183_;
						_tmp185_ = string_substring (_tmp182_, (glong) _tmp184_, (glong) -1);
						_tmp186_ = _tmp185_;
						...
						id = _tmp188_;
						_tmp189_ = group_name;
						_tmp190_ = g_key_file_get_string (file, _tmp189_, "Type", &_inner_error0_);
						type = _tmp190_;
						if (G_UNLIKELY (_inner_error0_ != NULL)) {
							g_propagate_error (error, _inner_error0_);
							_g_free0 (id);
						...
						_tmp192_ = group_name;
						_tmp193_ = g_key_file_get_string (file, _tmp192_, "Name", &_inner_error0_);
						_tmp191_ = _tmp193_;
						if (G_UNLIKELY (_inner_error0_ != NULL)) {
							g_propagate_error (error, _inner_error0_);
							_g_free0 (type);
						...
						_tmp194_ = self->domain;
						_tmp195_ = g_strdup (g_dgettext (_tmp194_, _tmp191_));
						name = _tmp195_;
						sort_type = NULL;
						_tmp197_ = group_name;
						_tmp196_ = g_key_file_has_key (file, _tmp197_, "SortType", &_inner_error0_);
						if (G_UNLIKELY (_inner_error0_ != NULL)) {
							g_propagate_error (error, _inner_error0_);
							_g_free0 (sort_type);
							_g_free0 (name);
						...
						if (_tmp196_) {
							...
							gchar* _tmp201_;
							_tmp199_ = group_name;
							_tmp200_ = g_key_file_get_string (file, _tmp199_, "SortType", &_inner_error0_);
							_tmp198_ = _tmp200_;
							if (G_UNLIKELY (_inner_error0_ != NULL)) {
								g_propagate_error (error, _inner_error0_);
								_g_free0 (sort_type);
						...
						_tmp204_ = name;
						_tmp205_ = sort_type;
						_tmp206_ = unity_protocol_filter_definition_create (_tmp202_, _tmp203_, _tmp204_, _tmp205_);
						filter_definition = _tmp206_;
						_tmp207_ = group_name;
						_tmp209_ = g_key_file_get_string_list (file, _tmp207_, "OptionIDs", &_tmp208_, &_inner_error0_);
						option_ids = _tmp209_;
						option_ids_length1 = _tmp208_;
						...
						_tmp211_ = group_name;
						_tmp212_ = g_key_file_get_string (file, _tmp211_, "OptionNames", &_inner_error0_);
						_tmp210_ = _tmp212_;
						if (G_UNLIKELY (_inner_error0_ != NULL)) {
							g_propagate_error (error, _inner_error0_);
						...
						_tmp213_ = self->domain;
						_tmp214_ = g_strdup (g_dgettext (_tmp213_, _tmp210_));
						option_names_str = _tmp214_;
						_tmp215_ = option_names_str;
						_tmp216_ = option_names_str;
						_tmp217_ = strlen (_tmp216_);
						_tmp218_ = _tmp217_;
						if (string_get (_tmp215_, (glong) (_tmp218_ - 1)) == ';') {
							...
							gint _tmp224_;
							gint _tmp225_;
							_tmp219_ = option_names_str;
							_tmp220_ = string_get_data (_tmp219_, &_tmp221_);
							_tmp220__length1 = _tmp221_;
							_tmp222_ = _tmp220_;
							_tmp222__length1 = _tmp220__length1;
							_tmp223_ = option_names_str;
							_tmp224_ = strlen (_tmp223_);
							_tmp225_ = _tmp224_;
							_tmp222_[_tmp225_ - 1] = (guint8) 0;
						}
						_tmp226_ = option_names_str;
						_tmp228_ = _tmp227_ = g_strsplit (_tmp226_, ";", 0);
						option_names = _tmp228_;
						option_names_length1 = _vala_array_length (_tmp227_);
						_option_names_size_ = option_names_length1;
						_tmp229_ = option_ids;
						_tmp229__length1 = option_ids_length1;
						_tmp230_ = option_names;
						_tmp230__length1 = option_names_length1;
						if (_tmp229__length1 != _tmp230__length1) {
							gchar** _tmp231_;
							gint _tmp231__length1;
							gchar** _tmp232_;
							gint _tmp232__length1;
							_tmp231_ = option_ids;
							_tmp231__length1 = option_ids_length1;
							_tmp232_ = option_names;
							_tmp232__length1 = option_names_length1;
							g_warning ("protocol-scope-discovery.vala:543: Number of elements of OptionIDs doe" \
"sn't match OptionNames (%d vs %d)", _tmp231__length1, _tmp232__length1);
						}
						{
							gint i = 0;
							i = 0;
							{
								...
								while (TRUE) {
									...
									UnityProtocolFilterDefinition* _tmp238_;
									gchar** _tmp239_;
									...
									_tmp233_ = FALSE;
									_tmp236_ = option_ids;
									_tmp236__length1 = option_ids_length1;
									if (i < _tmp236__length1) {
										gchar** _tmp237_;
										gint _tmp237__length1;
										_tmp237_ = option_names;
										_tmp237__length1 = option_names_length1;
										_tmp235_ = i < _tmp237__length1;
									} else {
										_tmp235_ = FALSE;
									}
									if (!_tmp235_) {
									...
									_tmp238_ = filter_definition;
									_tmp239_ = option_ids;
									_tmp239__length1 = option_ids_length1;
									_tmp240_ = _tmp239_[i];
									_tmp241_ = option_names;
									_tmp241__length1 = option_names_length1;
									_tmp242_ = _tmp241_[i];
									unity_protocol_filter_definition_add_option (_tmp238_, _tmp240_, _tmp242_);
								}
							}
						}
						_tmp243_ = filter_definition;
						if (_tmp243_ != NULL) {
							UnityProtocolFilterDefinition* _tmp244_;
							UnityProtocolFilterDefinition* _tmp245_;
							_tmp244_ = filter_definition;
							_tmp245_ = _unity_protocol_filter_definition_ref0 (_tmp244_);
							_vala_array_add10 (&self->priv->filters, &self->priv->filters_length1, &self->priv->_filters_size_, _tmp245_);
						}
                                                          ...
                                                          GError** error)
{
	...
	GError* _inner_error0_ = NULL;
	UnityProtocolScopeRegistryScopeMetadata* result;
	g_return_val_if_fail (file != NULL, NULL);
	_tmp0_ = unity_protocol_scope_registry_scope_metadata_new ();
	data = _tmp0_;
	unity_protocol_scope_registry_scope_metadata_load_from_key_file (data, file, &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
                                                     ...
                                                     GError** error)
{
	...
	UnityProtocolScopeRegistryScopeMetadata* data = NULL;
	GKeyFile* _tmp15_;
	UnityProtocolScopeRegistryScopeMetadata* _tmp16_;
	...
	file = _tmp2_;
	if (unity_protocol_scope_registry_overrides_scope_dirs) {
		gboolean _tmp3_ = FALSE;
		GKeyFile* _tmp4_;
		gchar** _tmp5_;
		gint _tmp5__length1;
		...
		gboolean _tmp7_;
		_tmp4_ = file;
		_tmp5_ = unity_protocol_scope_registry_scope_directories;
		_tmp5__length1 = unity_protocol_scope_registry_scope_directories_length1;
		_tmp7_ = g_key_file_load_from_dirs (_tmp4_, scope_id, _tmp5_, &_tmp6_, G_KEY_FILE_NONE, &_inner_error0_);
		_g_free0 (full_path);
		full_path = _tmp6_;
		_tmp3_ = _tmp7_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
		...
		gchar* _tmp12_ = NULL;
		gboolean _tmp13_;
		_tmp8_ = g_strdup_printf ("%s/%s", UNITY_PROTOCOL_SCOPES_DIR, scope_id);
		path = _tmp8_;
		_tmp10_ = file;
		_tmp11_ = path;
		_tmp13_ = g_key_file_load_from_data_dirs (_tmp10_, _tmp11_, &_tmp12_, G_KEY_FILE_NONE, &_inner_error0_);
		_g_free0 (full_path);
		full_path = _tmp12_;
		_tmp9_ = _tmp13_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
	...
	if (!loaded) {
		GError* _tmp14_;
		_tmp14_ = g_error_new (UNITY_PROTOCOL_PARSE_ERROR, UNITY_PROTOCOL_PARSE_ERROR_FILE_NOT_FOUND, "Scope not found: %s", scope_id);
	...
	_tmp15_ = file;
	_tmp16_ = unity_protocol_scope_registry_scope_metadata_for_keyfile (_tmp15_, &_inner_error0_);
	data = _tmp16_;
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_key_file_unref0 (file);
	...
	_tmp17_ = data;
	_tmp18_ = g_strdup (scope_id);
	_g_free0 (_tmp17_->id);
	_tmp17_->id = _tmp18_;
	_tmp19_ = data;
	_tmp20_ = full_path;
	_tmp21_ = g_strdup (_tmp20_);
	_g_free0 (_tmp19_->full_path);
	_tmp19_->full_path = _tmp21_;
	result = data;
	_g_key_file_unref0 (file);
	_g_free0 (full_path);
	return result;
                                                       ...
                                                       GError** error)
{
	...
	if (g_path_is_absolute (path)) {
		...
		gchar* _tmp3_;
		_tmp2_ = keyfile;
		_tmp1_ = g_key_file_load_from_file (_tmp2_, path, G_KEY_FILE_NONE, &_inner_error0_);
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
		...
		gboolean _tmp7_;
		_tmp5_ = keyfile;
		_tmp7_ = g_key_file_load_from_data_dirs (_tmp5_, path, &_tmp6_, G_KEY_FILE_NONE, &_inner_error0_);
		_g_free0 (full_path);
		full_path = _tmp6_;
		_tmp4_ = _tmp7_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
	...
	if (!loaded) {
		GError* _tmp8_;
		_tmp8_ = g_error_new (UNITY_PROTOCOL_PARSE_ERROR, UNITY_PROTOCOL_PARSE_ERROR_FILE_NOT_FOUND, "File not found: %s", path);
	...
	_tmp9_ = keyfile;
	_tmp10_ = unity_protocol_scope_registry_scope_metadata_for_keyfile (_tmp9_, &_inner_error0_);
	data = _tmp10_;
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_key_file_unref0 (keyfile);
	...
	_g_free0 (_tmp11_->full_path);
	_tmp11_->full_path = _tmp13_;
	_tmp14_ = data;
	_tmp15_ = full_path;
	_tmp16_ = unity_protocol_scope_registry_extract_scope_id (_tmp15_);
	_g_free0 (_tmp14_->id);
	_tmp14_->id = _tmp16_;
	_tmp17_ = data;
	_tmp18_ = _tmp17_->id;
	_tmp19_ = unity_protocol_scope_registry_scope_metadata_hidden_scope_ids;
	_tmp19__length1 = unity_protocol_scope_registry_scope_metadata_hidden_scope_ids_length1;
	if (_vala_string_array_contains (_tmp19_, _tmp19__length1, _tmp18_)) {
		...
		_tmp20_ = data;
		_tmp21_ = _tmp20_->id;
		_tmp22_ = g_error_new (UNITY_PROTOCOL_PARSE_ERROR, UNITY_PROTOCOL_PARSE_ERROR_FILE_NOT_FOUND, "Scope is disabled: %s", _tmp21_);
                                                         ...
                                                         gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityProtocolScopeRegistryScopeMetadata_private_offset);
...
unity_protocol_scope_registry_scope_metadata_instance_init (UnityProtocolScopeRegistryScopeMetadata * self,
                                                            gpointer klass)
{
	self->priv = unity_protocol_scope_registry_scope_metadata_get_instance_private (self);
	self->ref_count = 1;
}
...
static GType
unity_protocol_scope_registry_scope_metadata_get_type_once (void)
{
	...
	UnityProtocolScopeRegistryScopeMetadata_private_offset = g_type_add_instance_private (unity_protocol_scope_registry_scope_metadata_type_id, sizeof (UnityProtocolScopeRegistryScopeMetadataPrivate));
	return unity_protocol_scope_registry_scope_metadata_type_id;
}

GType
unity_protocol_scope_registry_scope_metadata_get_type (void)
{
	static volatile gsize unity_protocol_scope_registry_scope_metadata_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_scope_registry_scope_metadata_type_id__once)) {
		GType unity_protocol_scope_registry_scope_metadata_type_id;
		unity_protocol_scope_registry_scope_metadata_type_id = unity_protocol_scope_registry_scope_metadata_get_type_once ();
		g_once_init_leave (&unity_protocol_scope_registry_scope_metadata_type_id__once, unity_protocol_scope_registry_scope_metadata_type_id);
	}
	return unity_protocol_scope_registry_scope_metadata_type_id__once;
}
...
static GType
unity_protocol_scope_registry_scope_registry_node_get_type_once (void)
{
	...
	return unity_protocol_scope_registry_scope_registry_node_type_id;
}

GType
unity_protocol_scope_registry_scope_registry_node_get_type (void)
{
	static volatile gsize unity_protocol_scope_registry_scope_registry_node_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_scope_registry_scope_registry_node_type_id__once)) {
		GType unity_protocol_scope_registry_scope_registry_node_type_id;
		unity_protocol_scope_registry_scope_registry_node_type_id = unity_protocol_scope_registry_scope_registry_node_get_type_once ();
		g_once_init_leave (&unity_protocol_scope_registry_scope_registry_node_type_id__once, unity_protocol_scope_registry_scope_registry_node_type_id);
	}
	return unity_protocol_scope_registry_scope_registry_node_type_id__once;
}
                                          ...
                                          gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityProtocolScopeRegistry_private_offset);
	unity_protocol_scope_registry_init_scope_directories ();
}
...
unity_protocol_scope_registry_instance_init (UnityProtocolScopeRegistry * self,
                                             gpointer klass)
{
	self->priv = unity_protocol_scope_registry_get_instance_private (self);
...
static GType
unity_protocol_scope_registry_get_type_once (void)
{
	...
	UnityProtocolScopeRegistry_private_offset = g_type_add_instance_private (unity_protocol_scope_registry_type_id, sizeof (UnityProtocolScopeRegistryPrivate));
	return unity_protocol_scope_registry_type_id;
}

GType
unity_protocol_scope_registry_get_type (void)
{
	static volatile gsize unity_protocol_scope_registry_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_scope_registry_type_id__once)) {
		GType unity_protocol_scope_registry_type_id;
		unity_protocol_scope_registry_type_id = unity_protocol_scope_registry_get_type_once ();
		g_once_init_leave (&unity_protocol_scope_registry_type_id__once, unity_protocol_scope_registry_type_id);
	}
	return unity_protocol_scope_registry_type_id__once;
}
...
static GType
unity_protocol_scope_group_scope_info_get_type_once (void)
{
	...
	return unity_protocol_scope_group_scope_info_type_id;
}

GType
unity_protocol_scope_group_scope_info_get_type (void)
{
	static volatile gsize unity_protocol_scope_group_scope_info_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_scope_group_scope_info_type_id__once)) {
		GType unity_protocol_scope_group_scope_info_type_id;
		unity_protocol_scope_group_scope_info_type_id = unity_protocol_scope_group_scope_info_get_type_once ();
		g_once_init_leave (&unity_protocol_scope_group_scope_info_type_id__once, unity_protocol_scope_group_scope_info_type_id);
	}
	return unity_protocol_scope_group_scope_info_type_id__once;
}
                                             ...
                                             GError** error)
{
	...
	file = _tmp0_;
	_tmp2_ = file;
	_tmp1_ = g_key_file_load_from_file (_tmp2_, file_name, G_KEY_FILE_NONE, &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_key_file_unref0 (file);
	...
	_tmp9_ = file;
	_tmp8_ = g_key_file_has_key (_tmp9_, UNITY_PROTOCOL_SCOPE_GROUP_CONFIG_SCOPE_GROUP_GROUP, "Timeout", &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_key_file_unref0 (file);
		_unity_protocol_scope_group_config_unref0 (self);
	...
	if (_tmp8_) {
		...
		GKeyFile* _tmp11_;
		_tmp11_ = file;
		_tmp10_ = g_key_file_get_integer (_tmp11_, UNITY_PROTOCOL_SCOPE_GROUP_CONFIG_SCOPE_GROUP_GROUP, "Timeout", &_inner_error0_);
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			g_propagate_error (error, _inner_error0_);
			_g_key_file_unref0 (file);
			_unity_protocol_scope_group_config_unref0 (self);
	...
	self->scopes = NULL;
	_tmp13_ = file;
	_tmp14_ = g_key_file_get_string (_tmp13_, UNITY_PROTOCOL_SCOPE_GROUP_CONFIG_SCOPE_GROUP_GROUP, "Scopes", &_inner_error0_);
	_tmp12_ = _tmp14_;
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
		_g_key_file_unref0 (file);
	...
	_tmp16_ = _tmp15_ = g_strsplit (_tmp12_, ";", 0);
	{
		...
		for (scope_id_it = 0; scope_id_it < scope_id_collection_length1; scope_id_it = scope_id_it + 1) {
			...
			scope_id = _tmp17_;
			{
				...
				_tmp18_ = scope_id;
				_tmp19_ = unity_protocol_scope_registry_scope_metadata_for_id (_tmp18_, &_inner_error0_);
				metadata = _tmp19_;
				if (G_UNLIKELY (_inner_error0_ != NULL)) {
					g_propagate_error (error, _inner_error0_);
					_g_free0 (scope_id);
...
static GType
unity_protocol_scope_group_config_get_type_once (void)
{
	...
	return unity_protocol_scope_group_config_type_id;
}

GType
unity_protocol_scope_group_config_get_type (void)
{
	static volatile gsize unity_protocol_scope_group_config_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_scope_group_config_type_id__once)) {
		GType unity_protocol_scope_group_config_type_id;
		unity_protocol_scope_group_config_type_id = unity_protocol_scope_group_config_get_type_once ();
		g_once_init_leave (&unity_protocol_scope_group_config_type_id__once, unity_protocol_scope_group_config_type_id);
	}
	return unity_protocol_scope_group_config_type_id__once;
}
