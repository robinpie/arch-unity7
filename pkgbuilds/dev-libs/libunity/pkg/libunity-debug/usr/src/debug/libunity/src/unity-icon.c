/* unity-icon.c generated by valac 0.56.19, the Vala compiler
...
static gint UnityAnnotatedIcon_private_offset;
...
static GType unity_annotated_icon_get_type_once (void);
...
static GType
unity_category_type_get_type_once (void)
{
	...
	return unity_category_type_type_id;
}

GType
unity_category_type_get_type (void)
{
	static volatile gsize unity_category_type_type_id__once = 0;
	if (g_once_init_enter (&unity_category_type_type_id__once)) {
		GType unity_category_type_type_id;
		unity_category_type_type_id = unity_category_type_get_type_once ();
		g_once_init_leave (&unity_category_type_type_id__once, unity_category_type_type_id);
	}
	return unity_category_type_type_id__once;
}

static GType
unity_icon_size_hint_get_type_once (void)
{
	...
	return unity_icon_size_hint_type_id;
}

GType
unity_icon_size_hint_get_type (void)
{
	static volatile gsize unity_icon_size_hint_type_id__once = 0;
	if (g_once_init_enter (&unity_icon_size_hint_type_id__once)) {
		GType unity_icon_size_hint_type_id;
		unity_icon_size_hint_type_id = unity_icon_size_hint_get_type_once ();
		g_once_init_leave (&unity_icon_size_hint_type_id__once, unity_icon_size_hint_type_id);
	}
	return unity_icon_size_hint_type_id__once;
}

static inline gpointer
unity_annotated_icon_get_instance_private (UnityAnnotatedIcon* self)
{
	return G_STRUCT_MEMBER_P (self, UnityAnnotatedIcon_private_offset);
}
                                 ...
                                 gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityAnnotatedIcon_private_offset);
...
unity_annotated_icon_instance_init (UnityAnnotatedIcon * self,
                                    gpointer klass)
{
	self->priv = unity_annotated_icon_get_instance_private (self);
}
...
static GType
unity_annotated_icon_get_type_once (void)
{
	...
	UnityAnnotatedIcon_private_offset = g_type_add_instance_private (unity_annotated_icon_type_id, sizeof (UnityAnnotatedIconPrivate));
	return unity_annotated_icon_type_id;
}

GType
unity_annotated_icon_get_type (void)
{
	static volatile gsize unity_annotated_icon_type_id__once = 0;
	if (g_once_init_enter (&unity_annotated_icon_type_id__once)) {
		GType unity_annotated_icon_type_id;
		unity_annotated_icon_type_id = unity_annotated_icon_get_type_once ();
		g_once_init_leave (&unity_annotated_icon_type_id__once, unity_annotated_icon_type_id);
	}
	return unity_annotated_icon_type_id__once;
}
