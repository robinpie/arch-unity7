/* protocol-icon.c generated by valac 0.56.19, the Vala compiler
...
static gint UnityProtocolAnnotatedIcon_private_offset;
...
static GType unity_protocol_annotated_icon_get_type_once (void);
...
static GType
unity_protocol_category_type_get_type_once (void)
{
	...
	return unity_protocol_category_type_type_id;
}

GType
unity_protocol_category_type_get_type (void)
{
	static volatile gsize unity_protocol_category_type_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_category_type_type_id__once)) {
		GType unity_protocol_category_type_type_id;
		unity_protocol_category_type_type_id = unity_protocol_category_type_get_type_once ();
		g_once_init_leave (&unity_protocol_category_type_type_id__once, unity_protocol_category_type_type_id);
	}
	return unity_protocol_category_type_type_id__once;
}

static inline gpointer
unity_protocol_annotated_icon_get_instance_private (UnityProtocolAnnotatedIcon* self)
{
	return G_STRUCT_MEMBER_P (self, UnityProtocolAnnotatedIcon_private_offset);
}
                                                 ...
                                                 gdouble a)
{
	...
	g_return_if_fail (self != NULL);
	color = (guint32) 0;
	color += (guint32) MIN (MAX_VAL, (guint) round (r * MAX_VAL_DBL));
	color <<= (guint32) 8;
	color += (guint32) MIN (MAX_VAL, (guint) round (g * MAX_VAL_DBL));
	color <<= (guint32) 8;
	color += (guint32) MIN (MAX_VAL, (guint) round (b * MAX_VAL_DBL));
	color <<= (guint32) 8;
	color += (guint32) MIN (MAX_VAL, (guint) round (a * MAX_VAL_DBL));
	unity_protocol_annotated_icon_set_colorize_value (self, color);
}
                                                ...
                                                GIcon* base)
{
	...
	UnityProtocolAnnotatedIcon* _tmp22_;
	GVariant* _tmp23_;
	GVariant* _tmp24_;
	...
	UnityProtocolAnnotatedIcon* _tmp40_;
	GVariant* _tmp41_;
	GVariant* _tmp42_;
	...
	_tmp1_ = tokens[0];
	_tmp2_ = g_variant_parse (NULL, _tmp1_, NULL, NULL, &_inner_error0_);
	dict = _tmp2_;
	...
	_tmp5_ = UNITY_PROTOCOL_IS_ANNOTATED_ICON (_tmp4_) ? ((UnityProtocolAnnotatedIcon*) _tmp4_) : NULL;
	if (_tmp5_ == NULL) {
	...
	_tmp9_ = icon;
	_tmp10_ = unity_protocol_annotated_icon_get_hint (_tmp9_, "base-icon");
	icon_variant = _tmp10_;
	_tmp12_ = icon_variant;
	if (_tmp12_ != NULL) {
		GVariant* _tmp13_;
		const gchar* _tmp14_;
		_tmp13_ = icon_variant;
	...
	if (_tmp11_) {
		...
		_tmp19_ = icon;
		unity_protocol_annotated_icon_set_icon (_tmp19_, _tmp15_);
		_tmp20_ = icon;
		_tmp21_ = _tmp20_->priv->_hints;
		g_hash_table_remove (_tmp21_, "base-icon");
		_g_object_unref0 (_tmp15_);
	}
	_tmp22_ = icon;
	_tmp23_ = unity_protocol_annotated_icon_get_hint (_tmp22_, "category");
	category_variant = _tmp23_;
	_tmp24_ = category_variant;
	if (_tmp24_ != NULL) {
		UnityProtocolAnnotatedIcon* _tmp25_;
		GVariant* _tmp26_;
		UnityProtocolAnnotatedIcon* _tmp27_;
		GHashTable* _tmp28_;
		_tmp25_ = icon;
		_tmp26_ = category_variant;
		unity_protocol_annotated_icon_set_category (_tmp25_, (UnityProtocolCategoryType) g_variant_get_uint32 (_tmp26_));
		_tmp27_ = icon;
		_tmp28_ = _tmp27_->priv->_hints;
		g_hash_table_remove (_tmp28_, "category");
	}
	_tmp29_ = icon;
	_tmp30_ = unity_protocol_annotated_icon_get_hint (_tmp29_, "ribbon");
	ribbon_variant = _tmp30_;
	_tmp32_ = ribbon_variant;
	if (_tmp32_ != NULL) {
		GVariant* _tmp33_;
		const gchar* _tmp34_;
		_tmp33_ = ribbon_variant;
	...
	if (_tmp31_) {
		UnityProtocolAnnotatedIcon* _tmp35_;
		GVariant* _tmp36_;
		const gchar* _tmp37_;
		UnityProtocolAnnotatedIcon* _tmp38_;
		GHashTable* _tmp39_;
		_tmp35_ = icon;
		_tmp36_ = ribbon_variant;
		_tmp37_ = g_variant_get_string (_tmp36_, NULL);
		unity_protocol_annotated_icon_set_ribbon (_tmp35_, _tmp37_);
		_tmp38_ = icon;
		_tmp39_ = _tmp38_->priv->_hints;
		g_hash_table_remove (_tmp39_, "ribbon");
	}
	_tmp40_ = icon;
	_tmp41_ = unity_protocol_annotated_icon_get_hint (_tmp40_, "use-small-icon");
	small_icon_variant = _tmp41_;
	_tmp42_ = small_icon_variant;
	if (_tmp42_ != NULL) {
		UnityProtocolAnnotatedIcon* _tmp43_;
		GVariant* _tmp44_;
		UnityProtocolAnnotatedIcon* _tmp45_;
		GHashTable* _tmp46_;
		_tmp43_ = icon;
		_tmp44_ = small_icon_variant;
		unity_protocol_annotated_icon_set_use_small_icon (_tmp43_, g_variant_get_boolean (_tmp44_));
		_tmp45_ = icon;
		_tmp46_ = _tmp45_->priv->_hints;
		g_hash_table_remove (_tmp46_, "use-small-icon");
	}
	_tmp47_ = icon;
	_tmp48_ = unity_protocol_annotated_icon_get_hint (_tmp47_, "colorize-value");
	colorize_variant = _tmp48_;
	_tmp49_ = colorize_variant;
	if (_tmp49_ != NULL) {
		UnityProtocolAnnotatedIcon* _tmp50_;
		GVariant* _tmp51_;
		UnityProtocolAnnotatedIcon* _tmp52_;
		GHashTable* _tmp53_;
		_tmp50_ = icon;
		_tmp51_ = colorize_variant;
		unity_protocol_annotated_icon_set_colorize_value (_tmp50_, g_variant_get_uint32 (_tmp51_));
		_tmp52_ = icon;
		_tmp53_ = _tmp52_->priv->_hints;
		g_hash_table_remove (_tmp53_, "colorize-value");
	}
	result = (GIcon*) icon;
	_g_variant_unref0 (dict);
	return result;
                                        ...
                                        GIcon* value)
{
	GIcon* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_protocol_annotated_icon_get_icon (self);
	if (old_value != value) {
		GIcon* _tmp0_;
                                          ...
                                          const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_protocol_annotated_icon_get_ribbon (self);
...
{
	UnityProtocolCategoryType old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_protocol_annotated_icon_get_category (self);
	if (old_value != value) {
...
unity_protocol_annotated_icon_get_use_small_icon (UnityProtocolAnnotatedIcon* self)
{
	...
	result = self->priv->_use_small_icon;
	return result;
}
                                                  ...
                                                  gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_protocol_annotated_icon_get_use_small_icon (self);
	if (old_value != value) {
...
unity_protocol_annotated_icon_get_colorize_value (UnityProtocolAnnotatedIcon* self)
{
	...
	result = self->priv->_colorize_value;
	return result;
}
                                                  ...
                                                  guint32 value)
{
	guint32 old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_protocol_annotated_icon_get_colorize_value (self);
	if (old_value != value) {
                                          ...
                                          gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityProtocolAnnotatedIcon_private_offset);
                                                     ...
                                                     gpointer iface_data)
{
	...
	iface->from_tokens = (GIcon* (*) (GIcon*, gchar**, gint, gint, GError**)) unity_protocol_annotated_icon_real_from_tokens;
...
unity_protocol_annotated_icon_instance_init (UnityProtocolAnnotatedIcon * self,
                                             gpointer klass)
{
	self->priv = unity_protocol_annotated_icon_get_instance_private (self);
...
static GType
unity_protocol_annotated_icon_get_type_once (void)
{
	...
	UnityProtocolAnnotatedIcon_private_offset = g_type_add_instance_private (unity_protocol_annotated_icon_type_id, sizeof (UnityProtocolAnnotatedIconPrivate));
	return unity_protocol_annotated_icon_type_id;
}

GType
unity_protocol_annotated_icon_get_type (void)
{
	static volatile gsize unity_protocol_annotated_icon_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_annotated_icon_type_id__once)) {
		GType unity_protocol_annotated_icon_type_id;
		unity_protocol_annotated_icon_type_id = unity_protocol_annotated_icon_get_type_once ();
		g_once_init_leave (&unity_protocol_annotated_icon_type_id__once, unity_protocol_annotated_icon_type_id);
	}
	return unity_protocol_annotated_icon_type_id__once;
}
