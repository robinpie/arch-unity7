/* unity-result-activation.c generated by valac 0.56.19, the Vala compiler
...
enum  {
	...
	UNITY_AGGREGATOR_ACTIVATION_SCOPE_RESULT_PROPERTY,
...
static gint UnityActivationResponse_private_offset;
static gpointer unity_activation_response_parent_class = NULL;
static gint UnityAggregatorActivation_private_offset;
...
static GType unity_activation_response_get_type_once (void);
...
static void _vala_unity_activation_response_set_property (GObject * object,
                                                   ...
                                                   const GValue * value,
                                                   GParamSpec * pspec);
static gboolean _unity_scope_result_equal (const UnityScopeResult * s1,
                                    const UnityScopeResult * s2);
...
static GType unity_aggregator_activation_get_type_once (void);
...
static GType
unity_handled_type_get_type_once (void)
{
	...
	return unity_handled_type_type_id;
}

GType
unity_handled_type_get_type (void)
{
	static volatile gsize unity_handled_type_type_id__once = 0;
	if (g_once_init_enter (&unity_handled_type_type_id__once)) {
		GType unity_handled_type_type_id;
		unity_handled_type_type_id = unity_handled_type_get_type_once ();
		g_once_init_leave (&unity_handled_type_type_id__once, unity_handled_type_type_id);
	}
	return unity_handled_type_type_id__once;
}

static inline gpointer
unity_activation_response_get_instance_private (UnityActivationResponse* self)
{
	return G_STRUCT_MEMBER_P (self, UnityActivationResponse_private_offset);
}
...
{
	UnityHandledType old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_activation_response_get_handled (self);
	if (old_value != value) {
                                        ...
                                        const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_activation_response_get_goto_uri (self);
                                      ...
                                      gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityActivationResponse_private_offset);
...
unity_activation_response_instance_init (UnityActivationResponse * self,
                                         gpointer klass)
{
	self->priv = unity_activation_response_get_instance_private (self);
}
...
static GType
unity_activation_response_get_type_once (void)
{
	...
	UnityActivationResponse_private_offset = g_type_add_instance_private (unity_activation_response_type_id, sizeof (UnityActivationResponsePrivate));
	return unity_activation_response_type_id;
}

GType
unity_activation_response_get_type (void)
{
	static volatile gsize unity_activation_response_type_id__once = 0;
	if (g_once_init_enter (&unity_activation_response_type_id__once)) {
		GType unity_activation_response_type_id;
		unity_activation_response_type_id = unity_activation_response_get_type_once ();
		g_once_init_leave (&unity_activation_response_type_id__once, unity_activation_response_type_id);
	}
	return unity_activation_response_type_id__once;
}
...
static inline gpointer
unity_aggregator_activation_get_instance_private (UnityAggregatorActivation* self)
{
	return G_STRUCT_MEMBER_P (self, UnityAggregatorActivation_private_offset);
}
                                            ...
                                            const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_aggregator_activation_get_channel_id (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                          ...
                                          const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_aggregator_activation_get_scope_id (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                             ...
                                             guint value)
{
	guint old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_aggregator_activation_get_action_type (self);
	if (old_value != value) {
...
static gboolean
_unity_scope_result_equal (const UnityScopeResult * s1,
                           const UnityScopeResult * s2)
{
	if (s1 == s2) {
		return TRUE;
	...
	if (g_strcmp0 (s1->uri, s2->uri)) {
		return FALSE;
	}
	if (g_strcmp0 (s1->icon_hint, s2->icon_hint)) {
		return FALSE;
	}
	if (s1->category != s2->category) {
		return FALSE;
	}
	if (s1->result_type != s2->result_type) {
		return FALSE;
	}
	if (g_strcmp0 (s1->mimetype, s2->mimetype)) {
		return FALSE;
	}
	if (g_strcmp0 (s1->title, s2->title)) {
		return FALSE;
	}
	if (g_strcmp0 (s1->comment, s2->comment)) {
		return FALSE;
	}
	if (g_strcmp0 (s1->dnd_uri, s2->dnd_uri)) {
		return FALSE;
	}
...
{
	UnityScopeResult* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_aggregator_activation_get_scope_result (self);
	if (_unity_scope_result_equal (value, old_value) != TRUE) {
		UnityScopeResult* _tmp0_;
		_tmp0_ = _unity_scope_result_dup0 (value);
		_unity_scope_result_free0 (self->priv->_scope_result);
		self->priv->_scope_result = _tmp0_;
		g_object_notify_by_pspec ((GObject *) self, unity_aggregator_activation_properties[UNITY_AGGREGATOR_ACTIVATION_SCOPE_RESULT_PROPERTY]);
	}
}
                                       ...
                                       GHashTable* value)
{
	...
	g_return_if_fail (self != NULL);
	old_value = unity_aggregator_activation_get_hints (self);
	if (old_value != value) {
		GHashTable* _tmp0_;
                                        ...
                                        gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityAggregatorActivation_private_offset);
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), UNITY_AGGREGATOR_ACTIVATION_SCOPE_RESULT_PROPERTY, unity_aggregator_activation_properties[UNITY_AGGREGATOR_ACTIVATION_SCOPE_RESULT_PROPERTY] = g_param_spec_boxed ("scope-result", "scope-result", "scope-result", UNITY_TYPE_SCOPE_RESULT, G_PARAM_STATIC_STRINGS | G_PARAM_READABLE | G_PARAM_WRITABLE));
...
unity_aggregator_activation_instance_init (UnityAggregatorActivation * self,
                                           gpointer klass)
{
	self->priv = unity_aggregator_activation_get_instance_private (self);
}
...
static GType
unity_aggregator_activation_get_type_once (void)
{
	...
	UnityAggregatorActivation_private_offset = g_type_add_instance_private (unity_aggregator_activation_type_id, sizeof (UnityAggregatorActivationPrivate));
	return unity_aggregator_activation_type_id;
}

GType
unity_aggregator_activation_get_type (void)
{
	static volatile gsize unity_aggregator_activation_type_id__once = 0;
	if (g_once_init_enter (&unity_aggregator_activation_type_id__once)) {
		GType unity_aggregator_activation_type_id;
		unity_aggregator_activation_type_id = unity_aggregator_activation_get_type_once ();
		g_once_init_leave (&unity_aggregator_activation_type_id__once, unity_aggregator_activation_type_id);
	}
	return unity_aggregator_activation_type_id__once;
}
                                                ...
                                                GParamSpec * pspec)
{
	...
	switch (property_id) {
		...
		break;
		case UNITY_AGGREGATOR_ACTIVATION_SCOPE_RESULT_PROPERTY:
		{
			UnityScopeResult* boxed;
			boxed = unity_aggregator_activation_get_scope_result (self);
                                                ...
                                                GParamSpec * pspec)
{
	...
	switch (property_id) {
		...
		break;
		case UNITY_AGGREGATOR_ACTIVATION_SCOPE_RESULT_PROPERTY:
		unity_aggregator_activation_set_scope_result (self, g_value_get_boxed (value));
		break;
		case UNITY_AGGREGATOR_ACTIVATION_HINTS_PROPERTY:
