/* unity-launcher.c generated by valac 0.56.19, the Vala compiler
...
static gint UnityLauncherFavorites_private_offset;
...
static GType unity_launcher_entry_dbus_impl_get_type_once (void);
...
static GType unity_launcher_entry_get_type_once (void);
...
static GType unity_launcher_favorites_get_type_once (void);
...
static const GDBusArgInfo _unity_launcher_entry_dbus_impl_dbus_arg_info_query_result = {-1, "result", "a{sv}", NULL};
...
static const GDBusMethodInfo _unity_launcher_entry_dbus_impl_dbus_method_info_query = {-1, "Query", (GDBusArgInfo **) (&_unity_launcher_entry_dbus_impl_dbus_arg_info_query_in), (GDBusArgInfo **) (&_unity_launcher_entry_dbus_impl_dbus_arg_info_query_out), NULL};
...
static const GDBusArgInfo _unity_launcher_entry_dbus_impl_dbus_arg_info_update_app_uri = {-1, "app_uri", "s", NULL};
static const GDBusArgInfo _unity_launcher_entry_dbus_impl_dbus_arg_info_update_properties = {-1, "properties", "a{sv}", NULL};
...
static const GDBusSignalInfo _unity_launcher_entry_dbus_impl_dbus_signal_info_update = {-1, "Update", (GDBusArgInfo **) (&_unity_launcher_entry_dbus_impl_dbus_arg_info_update), NULL};
                                          ...
                                          UnityLauncherEntry* owner)
{
	...
	{
		unity_launcher_entry_dbus_impl_register_object (self, conn, (const gchar*) object_path, &_inner_error0_);
...
static GType
unity_launcher_entry_dbus_impl_get_type_once (void)
{
	...
	return unity_launcher_entry_dbus_impl_type_id;
}

GType
unity_launcher_entry_dbus_impl_get_type (void)
{
	static volatile gsize unity_launcher_entry_dbus_impl_type_id__once = 0;
	if (g_once_init_enter (&unity_launcher_entry_dbus_impl_type_id__once)) {
		GType unity_launcher_entry_dbus_impl_type_id;
		unity_launcher_entry_dbus_impl_type_id = unity_launcher_entry_dbus_impl_get_type_once ();
		g_once_init_leave (&unity_launcher_entry_dbus_impl_type_id__once, unity_launcher_entry_dbus_impl_type_id);
	}
	return unity_launcher_entry_dbus_impl_type_id__once;
}
...
unity_launcher_entry_parse_serializable (GVariant* data)
{
	...
	_self_ = _tmp7_;
	_tmp8_ = props;
	_tmp10_ = g_variant_lookup (_tmp8_, "count", "x", &_tmp9_, NULL);
	count = _tmp9_;
	if (_tmp10_) {
		UnityLauncherEntry* _tmp11_;
		_tmp11_ = _self_;
		unity_launcher_entry_set_count (_tmp11_, count);
	}
	_tmp12_ = props;
	_tmp14_ = g_variant_lookup (_tmp12_, "count-visible", "b", &_tmp13_, NULL);
	visible = _tmp13_;
	if (_tmp14_) {
		UnityLauncherEntry* _tmp15_;
		_tmp15_ = _self_;
		unity_launcher_entry_set_count_visible (_tmp15_, visible);
	}
	_tmp16_ = props;
	_tmp18_ = g_variant_lookup (_tmp16_, "count-visible", "d", &_tmp17_, NULL);
	progress = _tmp17_;
	if (_tmp18_) {
		UnityLauncherEntry* _tmp19_;
		_tmp19_ = _self_;
		unity_launcher_entry_set_progress (_tmp19_, progress);
	}
	_tmp20_ = props;
	_tmp22_ = g_variant_lookup (_tmp20_, "progress-visible", "b", &_tmp21_, NULL);
	visible = _tmp21_;
	if (_tmp22_) {
		UnityLauncherEntry* _tmp23_;
		_tmp23_ = _self_;
		unity_launcher_entry_set_progress_visible (_tmp23_, visible);
	}
	_tmp24_ = props;
	_tmp26_ = g_variant_lookup (_tmp24_, "urgent", "b", &_tmp25_, NULL);
	urgent = _tmp25_;
	if (_tmp26_) {
		UnityLauncherEntry* _tmp27_;
		_tmp27_ = _self_;
		unity_launcher_entry_set_urgent (_tmp27_, urgent);
	}
	_tmp28_ = props;
	_tmp30_ = g_variant_lookup (_tmp28_, "quicklist", "s", &_tmp29_, NULL);
	_g_free0 (quicklist_path);
	quicklist_path = _tmp29_;
	if (_tmp30_) {
		const gchar* _tmp31_;
		_tmp31_ = quicklist_path;
		if (g_strcmp0 (_tmp31_, "") != 0) {
			UnityLauncherEntry* _tmp32_;
			const gchar* _tmp33_;
			char* _tmp34_;
			_tmp32_ = _self_;
			_tmp33_ = quicklist_path;
			_tmp34_ = g_strdup (_tmp33_);
			_g_free0 (_tmp32_->_object_path);
			_tmp32_->_object_path = _tmp34_;
		}
	}
                                                  ...
                                                  GParamSpec* pspec)
{
		...
		switch (0) {
			default:
			{
				...
				if (_tmp14_ != NULL) {
					...
					g_object_get ((GObject*) _tmp15_, "dbus-object", &_tmp16_, NULL);
	...
	if (self->priv->_property_source_id == ((guint) 0)) {
                                               ...
                                               GParamSpec* pspec)
{
	...
	g_return_if_fail (pspec != NULL);
	_tmp0_ = _g_object_ref0 (UNITY_IS_INSPECTOR (_inspector) ? ((UnityInspector*) _inspector) : NULL);
	inspector = _tmp0_;
	_tmp1_ = inspector;
	...
	if (_tmp3_) {
		{
			...
			_tmp7_ = _tmp6_;
			g_dbus_connection_emit_signal (_tmp4_, NULL, (const gchar*) _tmp5_, "com.canonical.Unity.LauncherEntry", "Update", _tmp7_, &_inner_error0_);
                                  ...
                                  const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_launcher_entry_get_app_uri (self);
                                ...
                                gint64 value)
{
	gint64 old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_launcher_entry_get_count (self);
	if (old_value != value) {
                                        ...
                                        gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_launcher_entry_get_count_visible (self);
	if (old_value != value) {
                                   ...
                                   gdouble value)
{
	gdouble old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_launcher_entry_get_progress (self);
	if (old_value != value) {
                                           ...
                                           gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_launcher_entry_get_progress_visible (self);
	if (old_value != value) {
                                 ...
                                 gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_launcher_entry_get_urgent (self);
	if (old_value != value) {
                                  ...
                                  GObjectConstructParam * construct_properties)
{
	...
	self->priv->_property_source_id = (guint) 0;
	{
		...
		_tmp4_ = g_bus_get_sync (G_BUS_TYPE_SESSION, NULL, &_inner_error0_);
		_tmp3_ = _tmp4_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			if (_inner_error0_->domain == G_IO_ERROR) {
				goto __catch0_g_io_error;
...
/**
   ...
   */
static GType
unity_launcher_entry_get_type_once (void)
{
	...
	UnityLauncherEntry_private_offset = g_type_add_instance_private (unity_launcher_entry_type_id, sizeof (UnityLauncherEntryPrivate));
...
{
	static volatile gsize unity_launcher_entry_type_id__once = 0;
	if (g_once_init_enter (&unity_launcher_entry_type_id__once)) {
		GType unity_launcher_entry_type_id;
		unity_launcher_entry_type_id = unity_launcher_entry_get_type_once ();
		g_once_init_leave (&unity_launcher_entry_type_id__once, unity_launcher_entry_type_id);
	}
	return unity_launcher_entry_type_id__once;
}
...
static inline gpointer
unity_launcher_favorites_get_instance_private (UnityLauncherFavorites* self)
{
	return G_STRUCT_MEMBER_P (self, UnityLauncherFavorites_private_offset);
}
	...
	_tmp4_ = _tmp3_ = g_settings_get_strv (_tmp2_, "favorites");
	{
		...
		for (id_it = 0; id_it < id_collection_length1; id_it = id_it + 1) {
			...
			id = _tmp5_;
			{
				...
				_vala_array_add1 (&self->priv->fav_list, &self->priv->fav_list_length1, &self->priv->_fav_list_size_, _tmp18_);
				_tmp19_ = self->priv->fav_cache;
				_tmp20_ = id;
				_tmp21_ = g_strdup (_tmp20_);
				g_hash_table_insert (_tmp19_, _tmp21_, NULL);
				_g_free0 (id);
			}
		}
                                     ...
                                     const gchar* app_id)
{
	...
	_tmp0_ = self->priv->fav_cache;
	result = g_hash_table_lookup_extended (_tmp0_, app_id, NULL, NULL);
	return result;
}
                                 ...
                                 const gchar* app_id)
{
	...
	_tmp3_ = _g_object_ref0 ((GAppInfo*) _tmp1_);
	appinfo = _tmp3_;
	has_id = _tmp2_;
	if (has_id) {
		GAppInfo* _tmp4_;
		...
		_tmp5_ = unity_app_info_manager_get_default ();
		appman = _tmp5_;
		_tmp6_ = appman;
		_tmp7_ = unity_app_info_manager_lookup (_tmp6_, app_id);
		_g_object_unref0 (appinfo);
		appinfo = _tmp7_;
		_tmp8_ = self->priv->fav_cache;
                                     ...
                                     gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityLauncherFavorites_private_offset);
...
unity_launcher_favorites_instance_init (UnityLauncherFavorites * self,
                                        gpointer klass)
{
	self->priv = unity_launcher_favorites_get_instance_private (self);
}
...
static GType
unity_launcher_favorites_get_type_once (void)
{
	...
	UnityLauncherFavorites_private_offset = g_type_add_instance_private (unity_launcher_favorites_type_id, sizeof (UnityLauncherFavoritesPrivate));
	return unity_launcher_favorites_type_id;
}

GType
unity_launcher_favorites_get_type (void)
{
	static volatile gsize unity_launcher_favorites_type_id__once = 0;
	if (g_once_init_enter (&unity_launcher_favorites_type_id__once)) {
		GType unity_launcher_favorites_type_id;
		unity_launcher_favorites_type_id = unity_launcher_favorites_get_type_once ();
		g_once_init_leave (&unity_launcher_favorites_type_id__once, unity_launcher_favorites_type_id);
	}
	return unity_launcher_favorites_type_id__once;
}
