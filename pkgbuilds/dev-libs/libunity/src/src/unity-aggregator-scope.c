/* unity-aggregator-scope.c generated by valac 0.56.19, the Vala compiler
...
static gint UnityAggregatorScope_private_offset;
...
static GType unity_aggregator_scope_get_type_once (void);
...
unity_aggregator_scope_get_instance_private (UnityAggregatorScope* self)
{
	return G_STRUCT_MEMBER_P (self, UnityAggregatorScope_private_offset);
}

static GType
unity_aggregator_scope_sort_flags_get_type_once (void)
{
	...
	return unity_aggregator_scope_sort_flags_type_id;
}

GType
unity_aggregator_scope_sort_flags_get_type (void)
{
	static volatile gsize unity_aggregator_scope_sort_flags_type_id__once = 0;
	if (g_once_init_enter (&unity_aggregator_scope_sort_flags_type_id__once)) {
		GType unity_aggregator_scope_sort_flags_type_id;
		unity_aggregator_scope_sort_flags_type_id = unity_aggregator_scope_sort_flags_get_type_once ();
		g_once_init_leave (&unity_aggregator_scope_sort_flags_type_id__once, unity_aggregator_scope_sort_flags_type_id);
	}
	return unity_aggregator_scope_sort_flags_type_id__once;
}

static GType
unity_aggregator_scope_merge_mode_get_type_once (void)
{
	...
	return unity_aggregator_scope_merge_mode_type_id;
}

GType
unity_aggregator_scope_merge_mode_get_type (void)
{
	static volatile gsize unity_aggregator_scope_merge_mode_type_id__once = 0;
	if (g_once_init_enter (&unity_aggregator_scope_merge_mode_type_id__once)) {
		GType unity_aggregator_scope_merge_mode_type_id;
		unity_aggregator_scope_merge_mode_type_id = unity_aggregator_scope_merge_mode_get_type_once ();
		g_once_init_leave (&unity_aggregator_scope_merge_mode_type_id__once, unity_aggregator_scope_merge_mode_type_id);
	}
	return unity_aggregator_scope_merge_mode_type_id__once;
}
...
unity_aggregator_scope_category_index_for_scope_id (UnityAggregatorScope* self,
                                                    const gchar* scope_id)
{
	UnityAggregatorScopeClass* _klass_;
	g_return_val_if_fail (self != NULL, -1);
	_klass_ = UNITY_AGGREGATOR_SCOPE_GET_CLASS (self);
	if (_klass_->category_index_for_scope_id) {
		return _klass_->category_index_for_scope_id (self, scope_id);
	}
	return -1;
}
                                   ...
                                   UnityAggregatorScopeSortFlags flags)
{
	...
	_tmp1_ = _g_object_ref0 (UNITY_INTERNAL_IS_AGGREGATOR_SCOPE_IMPL (_tmp0_) ? ((UnityInternalAggregatorScopeImpl*) _tmp0_) : NULL);
	pimpl = _tmp1_;
                               ...
                               gpointer _user_data_)
{
	...
	_klass_ = UNITY_AGGREGATOR_SCOPE_GET_CLASS (self);
	if (_klass_->search) {
		_klass_->search (self, scope_search, _callback_, _user_data_);
	}
}
                                      ...
                                      GAsyncResult* _res_)
{
	...
	if (_klass_->search_finish) {
		_klass_->search_finish (self, _res_);
	}
}
                                 ...
                                 gpointer _user_data_)
{
	...
	_klass_ = UNITY_AGGREGATOR_SCOPE_GET_CLASS (self);
	if (_klass_->activate) {
		_klass_->activate (self, activation, _callback_, _user_data_);
	}
}
                                        ...
                                        GAsyncResult* _res_)
{
	UnityAggregatorScopeClass* _klass_;
	_klass_ = UNITY_AGGREGATOR_SCOPE_GET_CLASS (self);
	if (_klass_->activate_finish) {
		return _klass_->activate_finish (self, _res_);
	}
	return NULL;
}
...
unity_aggregator_scope_search_scope_co (UnityAggregatorScopeSearchScopeData* _data_)
{
	...
	_data_->_tmp1_ = _g_object_ref0 (UNITY_INTERNAL_IS_AGGREGATOR_SCOPE_IMPL (_data_->_tmp0_) ? ((UnityInternalAggregatorScopeImpl*) _data_->_tmp0_) : NULL);
	_data_->pimpl = _data_->_tmp1_;
	{
		...
		return FALSE;
		_state_1:
		_data_->_tmp2_ = unity_internal_aggregator_scope_impl_search_scope_finish (_data_->pimpl, _data_->_res_, &_data_->_inner_error0_);
		_data_->res = _data_->_tmp2_;
		if (G_UNLIKELY (_data_->_inner_error0_ != NULL)) {
			if (g_error_matches (_data_->_inner_error0_, UNITY_PROTOCOL_SCOPE_ERROR, UNITY_PROTOCOL_SCOPE_ERROR_DISABLED_CONTENT)) {
				goto __catch0_unity_protocol_scope_error_disabled_content;
			}
			goto __finally0;
		}
	...
	goto __finally0;
	__catch0_unity_protocol_scope_error_disabled_content:
	{
...
unity_aggregator_scope_push_results_co (UnityAggregatorScopePushResultsData* _data_)
{
	...
	{
		_data_->_state_ = 1;
		unity_internal_aggregator_scope_impl_push_results_to_scope (_data_->pimpl, _data_->channel_id, _data_->search_string, _data_->scope_id, _data_->results_model, _data_->category_ids, (gint) _data_->category_ids_length1, _data_->cancellable, unity_aggregator_scope_push_results_ready, _data_);
		return FALSE;
		_state_1:
		unity_internal_aggregator_scope_impl_push_results_to_scope_finish (_data_->pimpl, _data_->_res_, &_data_->_inner_error0_);
		if (G_UNLIKELY (_data_->_inner_error0_ != NULL)) {
...
{
	UnityAggregatorScopeMergeMode old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_aggregator_scope_get_merge_mode (self);
	if (old_value != value) {
...
unity_aggregator_scope_get_proxy_filter_hints (UnityAggregatorScope* self)
{
	...
	result = self->priv->_proxy_filter_hints;
	return result;
}
                                               ...
                                               gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_aggregator_scope_get_proxy_filter_hints (self);
	if (old_value != value) {
...
unity_aggregator_scope_get_automatic_flushing (UnityAggregatorScope* self)
{
	gboolean result;
	g_return_val_if_fail (self != NULL, FALSE);
	result = self->priv->_automatic_flushing;
	return result;
}
                                               ...
                                               gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_aggregator_scope_get_automatic_flushing (self);
	if (old_value != value) {
                                   ...
                                   gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityAggregatorScope_private_offset);
...
unity_aggregator_scope_instance_init (UnityAggregatorScope * self,
                                      gpointer klass)
{
	self->priv = unity_aggregator_scope_get_instance_private (self);
...
static GType
unity_aggregator_scope_get_type_once (void)
{
	...
	UnityAggregatorScope_private_offset = g_type_add_instance_private (unity_aggregator_scope_type_id, sizeof (UnityAggregatorScopePrivate));
	return unity_aggregator_scope_type_id;
}

GType
unity_aggregator_scope_get_type (void)
{
	static volatile gsize unity_aggregator_scope_type_id__once = 0;
	if (g_once_init_enter (&unity_aggregator_scope_type_id__once)) {
		GType unity_aggregator_scope_type_id;
		unity_aggregator_scope_type_id = unity_aggregator_scope_get_type_once ();
		g_once_init_leave (&unity_aggregator_scope_type_id__once, unity_aggregator_scope_type_id);
	}
	return unity_aggregator_scope_type_id__once;
}
