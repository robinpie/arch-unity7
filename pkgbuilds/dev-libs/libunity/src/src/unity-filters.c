/* unity-filters.c generated by valac 0.56.19, the Vala compiler
...
static gint UnityFilter_private_offset;
...
static gint UnityFilterOption_private_offset;
static gpointer unity_filter_option_parent_class = NULL;
static gint UnityOptionsFilter_private_offset;
...
static gint UnityRatingsFilter_private_offset;
...
static GType unity_filter_get_type_once (void);
...
static GType unity_filter_option_get_type_once (void);
...
static GType unity_options_filter_get_type_once (void);
...
static void _vala_unity_options_filter_set_property (GObject * object,
                                              ...
                                              const GValue * value,
                                              GParamSpec * pspec);
static GType unity_radio_option_filter_get_type_once (void);
static GType unity_check_option_filter_get_type_once (void);
static GType unity_check_option_filter_compact_get_type_once (void);
...
static GType unity_ratings_filter_get_type_once (void);
...
static void _vala_unity_ratings_filter_set_property (GObject * object,
                                              ...
                                              const GValue * value,
                                              GParamSpec * pspec);
static GType unity_multi_range_filter_get_type_once (void);
...
static GType
unity_filter_renderer_get_type_once (void)
{
	...
	return unity_filter_renderer_type_id;
}

GType
unity_filter_renderer_get_type (void)
{
	static volatile gsize unity_filter_renderer_type_id__once = 0;
	if (g_once_init_enter (&unity_filter_renderer_type_id__once)) {
		GType unity_filter_renderer_type_id;
		unity_filter_renderer_type_id = unity_filter_renderer_get_type_once ();
		g_once_init_leave (&unity_filter_renderer_type_id__once, unity_filter_renderer_type_id);
	}
	return unity_filter_renderer_type_id__once;
}

static inline gpointer
unity_filter_get_instance_private (UnityFilter* self)
{
	return G_STRUCT_MEMBER_P (self, UnityFilter_private_offset);
}
...
{
	UnityFilterClass* _klass_;
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_FILTER_GET_CLASS (self);
	if (_klass_->get_hints) {
		return _klass_->get_hints (self);
	}
	return NULL;
}
                     ...
                     GVariant* properties)
{
	...
	_klass_ = UNITY_FILTER_GET_CLASS (self);
	if (_klass_->update) {
		_klass_->update (self, properties);
	}
}
                                   ...
                                   DeeModelIter* iter)
{
	...
	icon = NULL;
	{
		...
		if (g_strcmp0 (_tmp2_, "") != 0) {
			...
			GIcon* _tmp6_;
			_tmp4_ = icon_hint;
			_tmp5_ = g_icon_new_for_string (_tmp4_, &_inner_error0_);
			_tmp3_ = _tmp5_;
	...
	switch (renderer) {
		case UNITY_FILTER_RENDERER_RATINGS:
		{
			...
			const gchar* _tmp12_;
			GIcon* _tmp13_;
			UnityRatingsFilter* _tmp14_;
			_tmp11_ = dee_model_get_string (model, iter, (guint) UNITY_INTERNAL_FILTER_COLUMN_ID);
			_tmp12_ = dee_model_get_string (model, iter, (guint) UNITY_INTERNAL_FILTER_COLUMN_DISPLAY_NAME);
			_tmp13_ = icon;
			_tmp14_ = unity_ratings_filter_new (_tmp11_, _tmp12_, _tmp13_, FALSE);
		...
		case UNITY_FILTER_RENDERER_RADIO_OPTIONS:
		{
			...
			const gchar* _tmp16_;
			GIcon* _tmp17_;
			UnityRadioOptionFilter* _tmp18_;
			_tmp15_ = dee_model_get_string (model, iter, (guint) UNITY_INTERNAL_FILTER_COLUMN_ID);
			_tmp16_ = dee_model_get_string (model, iter, (guint) UNITY_INTERNAL_FILTER_COLUMN_DISPLAY_NAME);
			_tmp17_ = icon;
			_tmp18_ = unity_radio_option_filter_new (_tmp15_, _tmp16_, _tmp17_, FALSE);
			_g_object_unref0 (filter);
			filter = (UnityFilter*) _tmp18_;
			break;
		}
		case UNITY_FILTER_RENDERER_CHECK_OPTIONS:
		{
			...
			_tmp19_ = dee_model_get_string (model, iter, (guint) UNITY_INTERNAL_FILTER_COLUMN_ID);
			_tmp20_ = dee_model_get_string (model, iter, (guint) UNITY_INTERNAL_FILTER_COLUMN_DISPLAY_NAME);
			_tmp21_ = icon;
			_tmp22_ = unity_check_option_filter_new (_tmp19_, _tmp20_, _tmp21_, FALSE);
			_g_object_unref0 (filter);
			filter = (UnityFilter*) _tmp22_;
			break;
		}
		case UNITY_FILTER_RENDERER_CHECK_OPTIONS_COMPACT:
		{
			...
			const gchar* _tmp24_;
			GIcon* _tmp25_;
			UnityCheckOptionFilterCompact* _tmp26_;
			_tmp23_ = dee_model_get_string (model, iter, (guint) UNITY_INTERNAL_FILTER_COLUMN_ID);
			_tmp24_ = dee_model_get_string (model, iter, (guint) UNITY_INTERNAL_FILTER_COLUMN_DISPLAY_NAME);
			_tmp25_ = icon;
			_tmp26_ = unity_check_option_filter_compact_new (_tmp23_, _tmp24_, _tmp25_, FALSE);
			_g_object_unref0 (filter);
			filter = (UnityFilter*) _tmp26_;
			break;
		}
		case UNITY_FILTER_RENDERER_MULTIRANGE:
		{
			...
			const gchar* _tmp28_;
			GIcon* _tmp29_;
			UnityMultiRangeFilter* _tmp30_;
			_tmp27_ = dee_model_get_string (model, iter, (guint) UNITY_INTERNAL_FILTER_COLUMN_ID);
			_tmp28_ = dee_model_get_string (model, iter, (guint) UNITY_INTERNAL_FILTER_COLUMN_DISPLAY_NAME);
			_tmp29_ = icon;
			_tmp30_ = unity_multi_range_filter_new (_tmp27_, _tmp28_, _tmp29_, FALSE);
			_g_object_unref0 (filter);
			filter = (UnityFilter*) _tmp30_;
			break;
		}
		default:
		break;
	...
	_tmp31_ = filter;
	unity_filter_set_filtering (_tmp31_, dee_model_get_bool (model, iter, (guint) UNITY_INTERNAL_FILTER_COLUMN_FILTERING));
	_tmp32_ = dee_model_get_value (model, iter, (guint) UNITY_INTERNAL_FILTER_COLUMN_RENDERER_STATE);
	properties = _tmp32_;
	_tmp33_ = filter;
	unity_filter_update (_tmp33_, properties);
	result = filter;
	_g_variant_unref0 (properties);
	_g_object_unref0 (icon);
	_g_free0 (icon_hint);
                     ...
                     const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_filter_get_id (self);
                               ...
                               const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_filter_get_display_name (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                            ...
                            GIcon* value)
{
	GIcon* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_filter_get_icon_hint (self);
	if (old_value != value) {
		GIcon* _tmp0_;
...
{
	UnityFilterRenderer old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_filter_get_renderer (self);
	if (old_value != value) {
                          ...
                          gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_filter_get_visible (self);
	if (old_value != value) {
                            ...
                            gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_filter_get_collapsed (self);
	if (old_value != value) {
                            ...
                            gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_filter_get_filtering (self);
	if (old_value != value) {
                         ...
                         gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityFilter_private_offset);
...
unity_filter_instance_init (UnityFilter * self,
                            gpointer klass)
{
	self->priv = unity_filter_get_instance_private (self);
}
...
static GType
unity_filter_get_type_once (void)
{
	...
	UnityFilter_private_offset = g_type_add_instance_private (unity_filter_type_id, sizeof (UnityFilterPrivate));
	return unity_filter_type_id;
}

GType
unity_filter_get_type (void)
{
	static volatile gsize unity_filter_type_id__once = 0;
	if (g_once_init_enter (&unity_filter_type_id__once)) {
		GType unity_filter_type_id;
		unity_filter_type_id = unity_filter_get_type_once ();
		g_once_init_leave (&unity_filter_type_id__once, unity_filter_type_id);
	}
	return unity_filter_type_id__once;
}
...
static inline gpointer
unity_filter_option_get_instance_private (UnityFilterOption* self)
{
	return G_STRUCT_MEMBER_P (self, UnityFilterOption_private_offset);
}
                            ...
                            const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_filter_option_get_id (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
		_g_free0 (self->priv->_id);
                                      ...
                                      const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_filter_option_get_display_name (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
		_g_free0 (self->priv->_display_name);
                                   ...
                                   GIcon* value)
{
	GIcon* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_filter_option_get_icon_hint (self);
	if (old_value != value) {
		GIcon* _tmp0_;
		_tmp0_ = _g_object_ref0 (value);
		_g_object_unref0 (self->priv->_icon_hint);
                                ...
                                gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_filter_option_get_active (self);
	if (old_value != value) {
                                ...
                                gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityFilterOption_private_offset);
...
unity_filter_option_instance_init (UnityFilterOption * self,
                                   gpointer klass)
{
	self->priv = unity_filter_option_get_instance_private (self);
}
...
static GType
unity_filter_option_get_type_once (void)
{
	...
	UnityFilterOption_private_offset = g_type_add_instance_private (unity_filter_option_type_id, sizeof (UnityFilterOptionPrivate));
	return unity_filter_option_type_id;
}

GType
unity_filter_option_get_type (void)
{
	static volatile gsize unity_filter_option_type_id__once = 0;
	if (g_once_init_enter (&unity_filter_option_type_id__once)) {
		GType unity_filter_option_type_id;
		unity_filter_option_type_id = unity_filter_option_get_type_once ();
		g_once_init_leave (&unity_filter_option_type_id__once, unity_filter_option_type_id);
	}
	return unity_filter_option_type_id__once;
}
...
static inline gpointer
unity_options_filter_get_instance_private (UnityOptionsFilter* self)
{
	return G_STRUCT_MEMBER_P (self, UnityOptionsFilter_private_offset);
}

static GType
unity_options_filter_sort_type_get_type_once (void)
{
	...
	return unity_options_filter_sort_type_type_id;
}

GType
unity_options_filter_sort_type_get_type (void)
{
	static volatile gsize unity_options_filter_sort_type_type_id__once = 0;
	if (g_once_init_enter (&unity_options_filter_sort_type_type_id__once)) {
		GType unity_options_filter_sort_type_type_id;
		unity_options_filter_sort_type_type_id = unity_options_filter_sort_type_get_type_once ();
		g_once_init_leave (&unity_options_filter_sort_type_type_id__once, unity_options_filter_sort_type_type_id);
	}
	return unity_options_filter_sort_type_type_id__once;
}
                                  ...
                                  GVariant* properties)
{
	...
	GVariantIter* _tmp0_ = NULL;
	self = (UnityOptionsFilter*) base;
	g_return_if_fail (properties != NULL);
	g_variant_get (properties, "a{sv}", &_tmp0_, NULL);
	...
	iter = _tmp0_;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp1_ = FALSE;
				_tmp3_ = iter;
				if (!(((gsize) i) < g_variant_iter_n_children (_tmp3_))) {
					break;
				}
				_tmp4_ = iter;
				g_variant_iter_next (_tmp4_, "{sv}", &_tmp5_, &_tmp6_, NULL);
				_g_free0 (key);
				key = _tmp5_;
				_g_variant_unref0 (val);
				val = _tmp6_;
				_tmp7_ = key;
				if (g_strcmp0 (_tmp7_, "options") == 0) {
					GVariant* _tmp8_;
					_tmp8_ = val;
					unity_options_filter_load_or_update_options (self, _tmp8_);
				} else {
					const gchar* _tmp9_;
					_tmp9_ = key;
					if (g_strcmp0 (_tmp9_, "show-all-button") == 0) {
						GVariant* _tmp10_;
						_tmp10_ = val;
						unity_options_filter_set_show_all_button (self, g_variant_get_boolean (_tmp10_));
					}
				}
				_g_variant_unref0 (val);
				_g_free0 (key);
                                             ...
                                             GVariant* array)
{
	...
	g_variant_get (array, "a(sssb)", &_tmp0_, NULL);
	_g_variant_iter_free0 (iter);
	iter = _tmp0_;
	...
	_option_ids_size_ = option_ids_length1;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp2_ = FALSE;
				_tmp4_ = iter;
				if (!(((gsize) i) < g_variant_iter_n_children (_tmp4_))) {
					break;
				}
				_tmp5_ = iter;
				g_variant_iter_next (_tmp5_, "(sssb)", &_tmp6_, &_tmp7_, &_tmp8_, &_tmp9_, NULL);
				_g_free0 (b_id);
				b_id = _tmp6_;
				_g_free0 (b_name);
				b_name = _tmp7_;
				...
				_tmp11_ = b_name;
				_tmp12_ = b_icon_hint;
				unity_options_filter_find_and_update_option (self, _tmp10_, _tmp11_, _tmp12_, b_active);
				_tmp13_ = b_id;
				_tmp14_ = g_strdup (_tmp13_);
				_vala_array_add2 (&option_ids, &option_ids_length1, &_option_ids_size_, _tmp14_);
				_g_free0 (b_icon_hint);
				_g_free0 (b_name);
				_g_free0 (b_id);
			}
	...
	_tmp16_ = option_ids;
	_tmp16__length1 = option_ids_length1;
	if (g_list_length (_tmp15_) != ((guint) _tmp16__length1)) {
		GList* l = NULL;
		GList* _tmp17_;
		...
		while (TRUE) {
			...
			_tmp21_ = unity_filter_option_get_id ((UnityFilterOption*) _tmp20_);
			_tmp22_ = _tmp21_;
			id = _tmp22_;
			_tmp23_ = l;
			to_remove = _tmp23_;
			...
			_tmp26_ = id;
			_tmp27_ = option_ids;
			_tmp27__length1 = option_ids_length1;
			if (!_vala_string_array_contains (_tmp27_, _tmp27__length1, _tmp26_)) {
				GList* _tmp28_;
				GList* _tmp29_;
				_tmp28_ = to_remove;
				_g_object_unref0 (_tmp28_->data);
				_tmp28_->data = NULL;
				_tmp29_ = to_remove;
				self->options = g_list_delete_link (self->options, _tmp29_);
			}
		}
	}
                                             ...
                                             gboolean active)
{
	...
	icon_hint = NULL;
	{
		if (g_strcmp0 (icon_hint_s, "") != 0) {
			...
			GIcon* _tmp7_;
			GIcon* _tmp8_;
			_tmp7_ = g_icon_new_for_string (icon_hint_s, &_inner_error0_);
			_tmp6_ = _tmp7_;
			if (G_UNLIKELY (_inner_error0_ != NULL)) {
				goto __catch0_g_error;
			}
...
{
	UnityOptionsFilterSortType old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_options_filter_get_sort_type (self);
	if (old_value != value) {
...
unity_options_filter_get_show_all_button (UnityOptionsFilter* self)
{
	gboolean result;
	g_return_val_if_fail (self != NULL, FALSE);
	result = self->priv->_show_all_button;
	return result;
}
                                          ...
                                          gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_options_filter_get_show_all_button (self);
	if (old_value != value) {
                                 ...
                                 gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityOptionsFilter_private_offset);
...
unity_options_filter_instance_init (UnityOptionsFilter * self,
                                    gpointer klass)
{
	self->priv = unity_options_filter_get_instance_private (self);
...
static GType
unity_options_filter_get_type_once (void)
{
	...
	UnityOptionsFilter_private_offset = g_type_add_instance_private (unity_options_filter_type_id, sizeof (UnityOptionsFilterPrivate));
	return unity_options_filter_type_id;
}

GType
unity_options_filter_get_type (void)
{
	static volatile gsize unity_options_filter_type_id__once = 0;
	if (g_once_init_enter (&unity_options_filter_type_id__once)) {
		GType unity_options_filter_type_id;
		unity_options_filter_type_id = unity_options_filter_get_type_once ();
		g_once_init_leave (&unity_options_filter_type_id__once, unity_options_filter_type_id);
	}
	return unity_options_filter_type_id__once;
}
...
static GType
unity_radio_option_filter_get_type_once (void)
{
	...
	return unity_radio_option_filter_type_id;
}

GType
unity_radio_option_filter_get_type (void)
{
	static volatile gsize unity_radio_option_filter_type_id__once = 0;
	if (g_once_init_enter (&unity_radio_option_filter_type_id__once)) {
		GType unity_radio_option_filter_type_id;
		unity_radio_option_filter_type_id = unity_radio_option_filter_get_type_once ();
		g_once_init_leave (&unity_radio_option_filter_type_id__once, unity_radio_option_filter_type_id);
	}
	return unity_radio_option_filter_type_id__once;
}
...
static GType
unity_check_option_filter_get_type_once (void)
{
	...
	return unity_check_option_filter_type_id;
}

GType
unity_check_option_filter_get_type (void)
{
	static volatile gsize unity_check_option_filter_type_id__once = 0;
	if (g_once_init_enter (&unity_check_option_filter_type_id__once)) {
		GType unity_check_option_filter_type_id;
		unity_check_option_filter_type_id = unity_check_option_filter_get_type_once ();
		g_once_init_leave (&unity_check_option_filter_type_id__once, unity_check_option_filter_type_id);
	}
	return unity_check_option_filter_type_id__once;
}
...
static GType
unity_check_option_filter_compact_get_type_once (void)
{
	...
	return unity_check_option_filter_compact_type_id;
}

GType
unity_check_option_filter_compact_get_type (void)
{
	static volatile gsize unity_check_option_filter_compact_type_id__once = 0;
	if (g_once_init_enter (&unity_check_option_filter_compact_type_id__once)) {
		GType unity_check_option_filter_compact_type_id;
		unity_check_option_filter_compact_type_id = unity_check_option_filter_compact_get_type_once ();
		g_once_init_leave (&unity_check_option_filter_compact_type_id__once, unity_check_option_filter_compact_type_id);
	}
	return unity_check_option_filter_compact_type_id__once;
}

static inline gpointer
unity_ratings_filter_get_instance_private (UnityRatingsFilter* self)
{
	return G_STRUCT_MEMBER_P (self, UnityRatingsFilter_private_offset);
}
	...
	iter = _tmp0_;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				val = _tmp6_;
				_tmp7_ = key;
				if (g_strcmp0 (_tmp7_, "rating") == 0) {
					GVariant* _tmp8_;
					_tmp8_ = val;
					unity_ratings_filter_set_rating (self, (gfloat) g_variant_get_double (_tmp8_));
				}
				_g_variant_unref0 (val);
				_g_free0 (key);
			}
                                 ...
                                 gfloat value)
{
	gfloat old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_ratings_filter_get_rating (self);
	if (old_value != value) {
                                 ...
                                 gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityRatingsFilter_private_offset);
...
unity_ratings_filter_instance_init (UnityRatingsFilter * self,
                                    gpointer klass)
{
	self->priv = unity_ratings_filter_get_instance_private (self);
}
...
static GType
unity_ratings_filter_get_type_once (void)
{
	...
	UnityRatingsFilter_private_offset = g_type_add_instance_private (unity_ratings_filter_type_id, sizeof (UnityRatingsFilterPrivate));
	return unity_ratings_filter_type_id;
}

GType
unity_ratings_filter_get_type (void)
{
	static volatile gsize unity_ratings_filter_type_id__once = 0;
	if (g_once_init_enter (&unity_ratings_filter_type_id__once)) {
		GType unity_ratings_filter_type_id;
		unity_ratings_filter_type_id = unity_ratings_filter_get_type_once ();
		g_once_init_leave (&unity_ratings_filter_type_id__once, unity_ratings_filter_type_id);
	}
	return unity_ratings_filter_type_id__once;
}
...
static GType
unity_multi_range_filter_get_type_once (void)
{
	...
	return unity_multi_range_filter_type_id;
}

GType
unity_multi_range_filter_get_type (void)
{
	static volatile gsize unity_multi_range_filter_type_id__once = 0;
	if (g_once_init_enter (&unity_multi_range_filter_type_id__once)) {
		GType unity_multi_range_filter_type_id;
		unity_multi_range_filter_type_id = unity_multi_range_filter_get_type_once ();
		g_once_init_leave (&unity_multi_range_filter_type_id__once, unity_multi_range_filter_type_id);
	}
	return unity_multi_range_filter_type_id__once;
}
