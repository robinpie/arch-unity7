/* unity-deprecated-scope-impl.c generated by valac 0.56.19, the Vala compiler
...
struct _UnityInternalDeprecatedScopeImplActivateData {
	...
	UnityDeprecatedScope* _tmp26_;
	UnityScopeResult _tmp27_;
	UnityActivationResponse* _tmp28_;
	UnityDeprecatedScope* _tmp29_;
	UnityScopeResult _tmp30_;
	UnityPreview* _tmp31_;
	UnityPreview* _tmp32_;
	UnityGenericPreview* _tmp33_;
	UnityPreview* _tmp34_;
	...
	gchar* _tmp60_;
	const gchar* _tmp61_;
	UnityScopeResult _tmp62_;
	const gchar* _tmp63_;
	UnityActivationResponse* _tmp64_;
	gboolean _tmp65_;
	UnityActivationResponse* _tmp66_;
	UnityActivationResponse* _tmp67_;
	UnityHandledType _tmp68_;
	UnityHandledType _tmp69_;
	UnityActivationResponse* _tmp70_;
	...
	const gchar* _tmp77_;
	GVariant* _tmp78_;
	UnityProtocolActivationReplyRaw _tmp79_;
	UnityProtocolActivationReplyRaw _tmp80_;
	UnityProtocolActivationReplyRaw _tmp81_;
	UnityPreview* _tmp82_;
	UnityActivationResponse* _tmp83_;
	UnityPreview* _tmp84_;
	UnityPreview* _tmp85_;
	UnityPreview* _tmp86_;
	GPtrArray* actions;
	UnityPreview* _tmp87_;
	GPtrArray* _tmp88_;
	GPtrArray* _tmp89_;
	guint i;
	gboolean _tmp90_;
	...
	UnityPreviewAction* _tmp103_;
	UnityPreview* _tmp104_;
	UnityActivationResponse* _tmp105_;
	UnityActivationResponse* _tmp106_;
	UnityActivationResponse* _tmp107_;
	UnityScopeResult _tmp108_;
	const gchar* _tmp109_;
	gchar* _tmp110_;
	UnityActivationResponse* _tmp111_;
	UnityHandledType _tmp112_;
	UnityHandledType _tmp113_;
...
struct _UnityInternalDeprecatedScopeImplSearchInternalData {
	...
	UnityDeprecatedScope* _tmp65_;
	const gchar* _tmp66_;
	const gchar* _tmp67_;
	UnityDeprecatedScopeSearch* _tmp68_;
	UnityCancellable* _tmp69_;
	UnityInternalDeeResultSet* _tmp70_;
	GHashTable* _tmp71_;
	gchar* _tmp72_;
	GVariant* _tmp73_;
	UnityDeprecatedScope* _tmp74_;
	const gchar* _tmp75_;
	const gchar* _tmp76_;
	gint64 delta_us;
	gdouble delta;
	...
	UnityDeprecatedScopeSearch* _tmp80_;
	GHashTable* _tmp81_;
	GHashTable* _tmp82_;
	GHashTable* _tmp83_;
	GHashTable* _tmp84_;
	...
	UnityInternalUtilsAsyncMutex* _tmp89_;
	UnityCancellable* _tmp90_;
	const gchar* _tmp91_;
	GError* _tmp92_;
	GError* _inner_error0_;
};
...
struct _UnityInternalDeprecatedScopeImplOpenChannelData {
	...
	const gchar* _tmp16_;
	gchar* _tmp17_;
	UnitySchemaFieldInfo* _tmp18_;
	const gchar* _tmp19_;
	gchar* _tmp20_;
	GHashTable* _tmp21_;
	UnitySchemaFieldInfo* _tmp22_;
	const gchar* _tmp23_;
	gchar* _tmp24_;
	...
	gchar* _tmp27_;
	gchar* model_name;
	UnityInternalScopeChannel* _tmp28_;
	gchar* _tmp29_;
	gchar* _tmp30_;
	GHashTable* _tmp31_;
	GHashTable* _tmp32_;
...
static gint UnityInternalDeprecatedScopeImpl_private_offset;
...
VALA_EXTERN void unity_internal_deprecated_scope_dbus_impl_set_filters (UnityInternalDeprecatedScopeDBusImpl* self,
                                                            GList* filters);
static GType unity_internal_deprecated_scope_dbus_impl_get_type_once (void);
...
static GHashTable* _variant_get6 (GVariant* value);
...
static GType unity_internal_deprecated_scope_impl_get_type_once (void);
...
unity_internal_deprecated_scope_dbus_impl_set_categories (UnityInternalDeprecatedScopeDBusImpl* self,
                                                          GList* categories)
{
	UnityInternalDeprecatedScopeDBusImplIface* _iface_;
	g_return_if_fail (self != NULL);
	_iface_ = UNITY_INTERNAL_DEPRECATED_SCOPE_DBUS_IMPL_GET_INTERFACE (self);
	if (_iface_->set_categories) {
		_iface_->set_categories (self, categories);
	}
}
                                                       ...
                                                       GList* filters)
{
	...
	g_return_if_fail (self != NULL);
	_iface_ = UNITY_INTERNAL_DEPRECATED_SCOPE_DBUS_IMPL_GET_INTERFACE (self);
	if (_iface_->set_filters) {
		_iface_->set_filters (self, filters);
	}
}
...
static GType
unity_internal_deprecated_scope_dbus_impl_get_type_once (void)
{
	...
	return unity_internal_deprecated_scope_dbus_impl_type_id;
}

GType
unity_internal_deprecated_scope_dbus_impl_get_type (void)
{
	static volatile gsize unity_internal_deprecated_scope_dbus_impl_type_id__once = 0;
	if (g_once_init_enter (&unity_internal_deprecated_scope_dbus_impl_type_id__once)) {
		GType unity_internal_deprecated_scope_dbus_impl_type_id;
		unity_internal_deprecated_scope_dbus_impl_type_id = unity_internal_deprecated_scope_dbus_impl_get_type_once ();
		g_once_init_leave (&unity_internal_deprecated_scope_dbus_impl_type_id__once, unity_internal_deprecated_scope_dbus_impl_type_id);
	}
	return unity_internal_deprecated_scope_dbus_impl_type_id__once;
}

static inline gpointer
unity_internal_deprecated_scope_impl_get_instance_private (UnityInternalDeprecatedScopeImpl* self)
{
	return G_STRUCT_MEMBER_P (self, UnityInternalDeprecatedScopeImpl_private_offset);
}
                                                       ...
                                                       GList* filters)
{
				...
				serialized_filter = _tmp13_;
				{
					...
					i = (gsize) 0;
					{
						...
						while (TRUE) {
							...
							if (!(i < g_variant_n_children (_tmp16_))) {
								break;
							}
							_tmp17_ = serialized_filter;
							_tmp18_ = g_variant_get_child_value (_tmp17_, i);
							_g_variant_unref0 (data[i]);
							data[i] = _tmp18_;
						}
					}
				}
				_tmp19_ = unity_internal_scope_dbus_impl_get_filters_model ((UnityInternalScopeDBusImpl*) self);
				_tmp20_ = _tmp19_;
				dee_model_append_row ((DeeModel*) _tmp20_, data);
	...
	if (self->priv->_dbus_id != ((guint) 0)) {
		...
		GVariant* _tmp24_;
		GVariant* _tmp25_;
		_tmp21_ = unity_protocol_scope_service_get_filters ((UnityProtocolScopeService*) self);
		_tmp22_ = _tmp21_;
		_tmp23_ = _tmp22_;
		_tmp24_ = g_variant_new_variant (_tmp23_);
		g_variant_ref_sink (_tmp24_);
		_tmp25_ = _tmp24_;
		unity_internal_scope_dbus_impl_queue_property_notification ((UnityInternalScopeDBusImpl*) self, "Filters", _tmp25_);
...
static void
unity_internal_deprecated_scope_impl_activate_finish (UnityProtocolScopeService* base,
                                                      GAsyncResult* _res_,
                                                      UnityProtocolActivationReplyRaw* result,
                                                      GError** error)
{
...
unity_internal_deprecated_scope_impl_real_activate_co (UnityInternalDeprecatedScopeImplActivateData* _data_)
{
	...
	if (g_variant_type_equal (_data_->_tmp22_, _data_->_tmp23_)) {
		...
		_data_->_tmp25_ = _variant_get6 (_data_->_tmp24_);
	...
	switch (_data_->action) {
		...
		{
			_data_->_tmp26_ = _data_->self->priv->_owner;
			_data_->_tmp27_ = _data_->scope_result;
			_data_->_state_ = 1;
			unity_deprecated_scope_activate_result (_data_->_tmp26_, &_data_->_tmp27_, unity_internal_deprecated_scope_impl_activate_ready, _data_);
			return FALSE;
			_state_1:
			_data_->_tmp28_ = unity_deprecated_scope_activate_result_finish (_data_->_tmp26_, _data_->_res_);
			_g_object_unref0 (_data_->response);
		...
		case UNITY_PROTOCOL_ACTION_TYPE_PREVIEW_RESULT:
		{
			...
			_data_->_tmp30_ = _data_->scope_result;
			_data_->_state_ = 2;
			unity_deprecated_scope_preview_result (_data_->_tmp29_, &_data_->_tmp30_, unity_internal_deprecated_scope_impl_activate_ready, _data_);
			return FALSE;
			_state_2:
			_data_->_tmp31_ = unity_deprecated_scope_preview_result_finish (_data_->_tmp29_, _data_->_res_);
			_g_object_unref0 (_data_->preview);
			_data_->preview = _data_->_tmp31_;
			_data_->_tmp32_ = _data_->preview;
			if (_data_->_tmp32_ == NULL) {
				_data_->_tmp33_ = unity_generic_preview_empty ();
				_g_object_unref0 (_data_->preview);
				_data_->preview = (UnityPreview*) _data_->_tmp33_;
				_data_->_tmp34_ = _data_->preview;
				_data_->_tmp35_ = _data_->scope_result;
				_data_->_tmp36_ = _data_->_tmp35_.title;
				unity_preview_set_title (_data_->_tmp34_, _data_->_tmp36_);
				_data_->_tmp37_ = _data_->preview;
				_data_->_tmp38_ = _data_->scope_result;
				_data_->_tmp39_ = _data_->_tmp38_.comment;
				_data_->_tmp40_ = g_markup_escape_text (_data_->_tmp39_, (gssize) -1);
				_data_->_tmp41_ = _data_->_tmp40_;
				unity_preview_set_description_markup (_data_->_tmp37_, _data_->_tmp41_);
				_g_free0 (_data_->_tmp41_);
				_data_->_tmp42_ = _data_->scope_result;
				_data_->_tmp43_ = _data_->_tmp42_.mimetype;
				_data_->_tmp44_ = g_content_type_get_icon (_data_->_tmp43_);
				_data_->icon = _data_->_tmp44_;
				_data_->_tmp45_ = _data_->preview;
				_data_->_tmp46_ = _data_->icon;
				unity_preview_set_image (_data_->_tmp45_, _data_->_tmp46_);
		...
		{
			_data_->_tmp47_ = g_hash_table_lookup (_data_->hints, UNITY_INTERNAL_ACTIVATE_PREVIEW_ACTION_HINT);
			_data_->_tmp48_ = _g_variant_ref0 ((GVariant*) _data_->_tmp47_);
			_data_->act_id_v = _data_->_tmp48_;
			_data_->_tmp50_ = _data_->act_id_v;
			if (_data_->_tmp50_ == NULL) {
				_data_->_tmp49_ = TRUE;
			} else {
				_data_->_tmp51_ = _data_->act_id_v;
				_data_->_tmp52_ = g_variant_get_type (_data_->_tmp51_);
				_data_->_tmp53_ = G_VARIANT_TYPE_STRING;
				_data_->_tmp49_ = !g_variant_type_equal (_data_->_tmp52_, _data_->_tmp53_);
			}
			if (_data_->_tmp49_) {
				_data_->_tmp54_ = g_strdup_printf ("Invoking preview action requires '%s' hint", UNITY_INTERNAL_ACTIVATE_PREVIEW_ACTION_HINT);
				_data_->_tmp55_ = _data_->_tmp54_;
				_data_->_tmp56_ = g_error_new_literal (UNITY_PROTOCOL_SCOPE_ERROR, UNITY_PROTOCOL_SCOPE_ERROR_REQUEST_FAILED, _data_->_tmp55_);
			...
			_data_->_tmp58_ = _data_->act_id_v;
			_data_->_tmp59_ = g_variant_get_string (_data_->_tmp58_, NULL);
			_data_->_tmp60_ = g_strdup (_data_->_tmp59_);
			_data_->action_id = _data_->_tmp60_;
			_data_->_tmp61_ = _data_->action_id;
			_data_->_tmp62_ = _data_->scope_result;
			_data_->_tmp63_ = _data_->_tmp62_.uri;
			_data_->_tmp64_ = unity_internal_deprecated_scope_impl_activate_action (_data_->self, _data_->_tmp61_, _data_->_tmp63_, _data_->hints);
			_g_object_unref0 (_data_->response);
...
"u", _data_->action_type);
	...
	if (_data_->_tmp66_ != NULL) {
		...
		_data_->_tmp68_ = unity_activation_response_get_handled (_data_->_tmp67_);
		_data_->_tmp69_ = _data_->_tmp68_;
		_data_->_tmp65_ = _data_->_tmp69_ == UNITY_HANDLED_TYPE_SHOW_PREVIEW;
	} else {
		_data_->_tmp65_ = FALSE;
	}
	if (_data_->_tmp65_) {
		_data_->_tmp70_ = _data_->response;
		_data_->_tmp71_ = unity_activation_response_get_preview (_data_->_tmp70_);
		if (_data_->_tmp71_ == NULL) {
			_data_->_tmp72_ = _data_->response;
			_data_->_tmp73_ = unity_activation_response_get_goto_uri (_data_->_tmp72_);
			_data_->_tmp74_ = _data_->_tmp73_;
			_data_->_tmp75_ = g_strdup (_data_->_tmp74_);
			_data_->new_uri = _data_->_tmp75_;
			_data_->_tmp76_ = _data_->new_uri;
			if (_data_->_tmp76_ != NULL) {
				_data_->_tmp77_ = _data_->new_uri;
				_data_->_tmp78_ = _variant_new29 (_data_->_tmp77_);
				_g_variant_unref0 (_data_->result_arr[UNITY_INTERNAL_RESULT_COLUMN_URI]);
				_data_->result_arr[UNITY_INTERNAL_RESULT_COLUMN_URI] = _data_->_tmp78_;
			}
			memset (&_data_->_tmp80_, 0, sizeof (UnityProtocolActivationReplyRaw));
			_data_->_state_ = 3;
			unity_protocol_scope_service_activate ((UnityProtocolScopeService*) _data_->self, _data_->channel_id, _data_->result_arr, (gint) _data_->result_arr_length1, (guint) UNITY_PROTOCOL_ACTION_TYPE_PREVIEW_RESULT, _data_->hints, _data_->cancellable, unity_internal_deprecated_scope_impl_activate_ready, _data_);
			return FALSE;
			_state_3:
			unity_protocol_scope_service_activate_finish ((UnityProtocolScopeService*) _data_->self, _data_->_res_, &_data_->_tmp80_, &_data_->_inner_error0_);
			_data_->_tmp79_ = _data_->_tmp80_;
			...
			_data_->_tmp81_ = _data_->_tmp79_;
			memset (&_data_->_tmp79_, 0, sizeof (UnityProtocolActivationReplyRaw));
			unity_protocol_activation_reply_raw_destroy (&_data_->reply);
			_data_->reply = _data_->_tmp81_;
			_data_->result = _data_->reply;
			unity_protocol_activation_reply_raw_destroy (&_data_->_tmp79_);
			_g_free0 (_data_->new_uri);
			unity_scope_result_destroy (&_data_->scope_result);
			_g_object_unref0 (_data_->preview);
			_g_object_unref0 (_data_->response);
			...
			_data_->_tmp82_ = _data_->preview;
			if (_data_->_tmp82_ == NULL) {
				_data_->_tmp83_ = _data_->response;
				_data_->_tmp84_ = unity_activation_response_get_preview (_data_->_tmp83_);
				_data_->_tmp85_ = _g_object_ref0 (_data_->_tmp84_);
				_g_object_unref0 (_data_->preview);
				_data_->preview = _data_->_tmp85_;
			}
		}
	}
	_data_->_tmp86_ = _data_->preview;
	if (_data_->_tmp86_ != NULL) {
		_data_->_tmp87_ = _data_->preview;
		_data_->_tmp88_ = unity_preview_get_actions (_data_->_tmp87_);
		_data_->_tmp89_ = _g_ptr_array_ref0 (_data_->_tmp88_);
		_data_->actions = _data_->_tmp89_;
		{
			_data_->i = (guint) 0;
			{
				_data_->_tmp90_ = TRUE;
				while (TRUE) {
					if (!_data_->_tmp90_) {
						_data_->_tmp91_ = _data_->i;
						_data_->i = _data_->_tmp91_ + 1;
					}
					_data_->_tmp90_ = FALSE;
					_data_->_tmp92_ = _data_->actions;
					_data_->_tmp93_ = vala_g_ptr_array_get_length (_data_->_tmp92_);
					_data_->_tmp94_ = _data_->_tmp93_;
					if (!(_data_->i < ((guint) _data_->_tmp94_))) {
						break;
					}
					_data_->_tmp95_ = _data_->actions;
					_data_->_tmp96_ = g_ptr_array_index (_data_->_tmp95_, _data_->i);
					_data_->preview_action = (UnityPreviewAction*) _data_->_tmp96_;
					_data_->_tmp97_ = _data_->self->priv->_action_map;
					_data_->_tmp98_ = _data_->preview_action;
					_data_->_tmp99_ = unity_preview_action_get_id (_data_->_tmp98_);
					_data_->_tmp100_ = _data_->_tmp99_;
					_data_->_tmp101_ = g_strdup (_data_->_tmp100_);
					_data_->_tmp102_ = _data_->preview_action;
					_data_->_tmp103_ = _g_object_ref0 (_data_->_tmp102_);
					g_hash_table_insert (_data_->_tmp97_, _data_->_tmp101_, _data_->_tmp103_);
				}
			}
		}
		_data_->_tmp104_ = _data_->preview;
		_data_->_tmp105_ = unity_activation_response_new_with_preview (_data_->_tmp104_);
		_g_object_unref0 (_data_->response);
		_data_->response = _data_->_tmp105_;
		_g_ptr_array_unref0 (_data_->actions);
	}
	_data_->_tmp106_ = _data_->response;
	if (_data_->_tmp106_ == NULL) {
		_data_->_tmp107_ = unity_activation_response_new (UNITY_HANDLED_TYPE_NOT_HANDLED, "");
		_g_object_unref0 (_data_->response);
		_data_->response = _data_->_tmp107_;
	}
	_data_->_tmp108_ = _data_->scope_result;
	_data_->_tmp109_ = _data_->_tmp108_.uri;
	_data_->_tmp110_ = g_strdup (_data_->_tmp109_);
	_g_free0 (_data_->reply.uri);
	_data_->reply.uri = _data_->_tmp110_;
	_data_->_tmp111_ = _data_->response;
	_data_->_tmp112_ = unity_activation_response_get_handled (_data_->_tmp111_);
	_data_->_tmp113_ = _data_->_tmp112_;
	_data_->reply.handled = (guint) _data_->_tmp113_;
	_data_->_tmp114_ = _data_->response;
	_data_->_tmp115_ = unity_activation_response_get_hints (_data_->_tmp114_);
	_g_hash_table_unref0 (_data_->reply.hints);
	_data_->reply.hints = _data_->_tmp115_;
                                                     ...
                                                     UnityDeprecatedScopeSearch* search)
{
	...
	search_type = (*_tmp0_).search_type;
	if (search_type == UNITY_SEARCH_TYPE_DEFAULT) {
		UnityDeprecatedScope* _tmp2_;
		gchar* _tmp3_ = NULL;
		_tmp2_ = self->priv->_owner;
		g_signal_emit_by_name (_tmp2_, "generate-search-key::default", search, &_tmp3_);
		_g_free0 (_tmp1_);
		_tmp1_ = _tmp3_;
	} else {
		UnityDeprecatedScope* _tmp4_;
		gchar* _tmp5_ = NULL;
		_tmp4_ = self->priv->_owner;
		g_signal_emit_by_name (_tmp4_, "generate-search-key::global", search, &_tmp5_);
		_g_free0 (_tmp1_);
		_tmp1_ = _tmp5_;
	}
	_tmp6_ = _tmp1_;
...
___lambda16_ (Block19Data* _data19_)
{
	...
	self = _data18_->self;
	if (unity_internal_deprecated_scope_impl_measure_requests) {
...
unity_internal_deprecated_scope_impl_search_internal_co (UnityInternalDeprecatedScopeImplSearchInternalData* _data_)
{
	...
	if (_data_->_tmp4_ != NULL) {
		...
		unity_internal_deprecated_scope_impl_update_filter_state (_data_->self, _data_->channel, _data_->_tmp5_, &_data_->_inner_error0_);
		if (G_UNLIKELY (_data_->_inner_error0_ != NULL)) {
	...
	if (_data_->_tmp34_ != NULL) {
		...
		if (g_strcmp0 (_data_->_tmp37_, _data_->_tmp38_) == 0) {
			...
			_data_->_tmp40_ = _g_object_ref0 (UNITY_IS_DEPRECATED_SCOPE_SEARCH (_data_->_tmp39_) ? ((UnityDeprecatedScopeSearch*) _data_->_tmp39_) : NULL);
	...
	_data_->channel->last_search = _data_->_tmp57_;
	{
		...
		_data_->_data19_->search_end_time = _data_->search_start_time;
		_data_->_tmp65_ = _data_->self->priv->_owner;
		_data_->_tmp66_ = unity_deprecated_scope_base_get_id ((UnityDeprecatedScopeBase*) _data_->_tmp65_);
		_data_->_tmp67_ = _data_->_tmp66_;
		unity_trace_tracepoint ("search:start::scope=%s", _data_->_tmp67_);
		_data_->_tmp68_ = _data_->new_search;
		unity_scope_search_base_run_async ((UnityScopeSearchBase*) _data_->_tmp68_, ____lambda16__unity_scope_search_base_callback, _data_->_data19_);
		_data_->_state_ = 4;
		return FALSE;
		_state_4:
		;
		_data_->_tmp69_ = _data_->cancellable;
		if (!unity_cancellable_is_cancelled (_data_->_tmp69_)) {
		...
		_data_->_tmp74_ = _data_->self->priv->_owner;
		_data_->_tmp75_ = unity_deprecated_scope_base_get_id ((UnityDeprecatedScopeBase*) _data_->_tmp74_);
		_data_->_tmp76_ = _data_->_tmp75_;
		unity_trace_tracepoint ("search:end::scope=%s", _data_->_tmp76_);
		if (unity_internal_deprecated_scope_impl_measure_requests) {
			_data_->delta_us = _data_->_data19_->search_end_time - _data_->search_start_time;
			_data_->delta = _data_->delta_us / 1000000.0;
			_data_->_tmp77_ = _data_->_result_;
			_data_->_tmp78_ = g_strdup (UNITY_INTERNAL_SEARCH_TIME_HINT);
			_data_->_tmp79_ = g_variant_new_double (_data_->delta);
			g_variant_ref_sink (_data_->_tmp79_);
			g_hash_table_insert (_data_->_tmp77_, _data_->_tmp78_, _data_->_tmp79_);
		}
		_data_->_tmp80_ = _data_->new_search;
		_data_->_tmp81_ = unity_deprecated_scope_search_get_reply_hints (_data_->_tmp80_);
		_data_->reply_hints = _data_->_tmp81_;
		_data_->_tmp82_ = _data_->reply_hints;
		if (_data_->_tmp82_ != NULL) {
			_data_->_tmp83_ = _data_->reply_hints;
			if (g_hash_table_contains (_data_->_tmp83_, UNITY_INTERNAL_SEARCH_NO_RESULTS_HINT)) {
				_data_->_tmp84_ = _data_->_result_;
				_data_->_tmp85_ = g_strdup (UNITY_INTERNAL_SEARCH_NO_RESULTS_HINT);
				_data_->_tmp86_ = _data_->reply_hints;
				_data_->_tmp87_ = g_hash_table_lookup (_data_->_tmp86_, UNITY_INTERNAL_SEARCH_NO_RESULTS_HINT);
				_data_->_tmp88_ = _g_variant_ref0 ((GVariant*) _data_->_tmp87_);
	...
	__finally0:
	{
		...
		_data_->_tmp89_ = _data_->channel->model_lock;
		unity_internal_utils_async_mutex_unlock (_data_->_tmp89_);
	}
	if (G_UNLIKELY (_data_->_inner_error0_ != NULL)) {
		if (_data_->_inner_error0_->domain == UNITY_PROTOCOL_SCOPE_ERROR) {
			g_task_return_error (_data_->_async_result, _data_->_inner_error0_);
	...
	_data_->_tmp90_ = _data_->cancellable;
	if (unity_cancellable_is_cancelled (_data_->_tmp90_)) {
		_data_->_tmp91_ = _data_->normalized_query;
		_data_->_tmp92_ = g_error_new (UNITY_PROTOCOL_SCOPE_ERROR, UNITY_PROTOCOL_SCOPE_ERROR_SEARCH_CANCELLED, "Search '%s' was cancelled", _data_->_tmp91_);
...
static GHashTable*
unity_internal_deprecated_scope_impl_search_finish (UnityProtocolScopeService* base,
                                                    GAsyncResult* _res_,
                                                    GError** error)
{
	GHashTable* result;
...
unity_internal_deprecated_scope_impl_real_search_co (UnityInternalDeprecatedScopeImplSearchData* _data_)
{
	...
	_state_0:
	_data_->_tmp0_ = unity_internal_deprecated_scope_impl_get_channel_by_id (_data_->self, _data_->channel_id, &_data_->_inner_error0_);
	...
	return FALSE;
	_state_1:
	_data_->_tmp3_ = unity_internal_deprecated_scope_impl_search_internal_finish (_data_->self, _data_->_res_, &_data_->_inner_error0_);
	...
	if (_tmp3_ != NULL) {
		...
		if (g_hash_table_size (hints) > ((guint) 0)) {
			...
			while (TRUE) {
				...
				key = (const gchar*) _tmp9_;
				value = (GVariant*) _tmp10_;
				if (!_tmp11_) {
					break;
				}
...
static gchar*
unity_internal_deprecated_scope_impl_open_channel_finish (UnityProtocolScopeService* base,
                                                          GAsyncResult* _res_,
                                                          GHashTable** out_hints,
                                                          GError** error)
{
...
unity_internal_deprecated_scope_impl_real_open_channel_co (UnityInternalDeprecatedScopeImplOpenChannelData* _data_)
{
	...
	_data_->_tmp12_ = unity_schema_get_fields (_data_->_tmp11_);
	{
		...
		for (_data_->field_it = _data_->field_collection; _data_->field_it != NULL; _data_->field_it = _data_->field_it->next) {
			_data_->field = (UnitySchemaFieldInfo*) _data_->field_it->data;
			{
				...
				if ((*_data_->_tmp13_).type == UNITY_SCHEMA_FIELD_TYPE_REQUIRED) {
					_data_->_tmp14_ = _data_->required_schema;
					_data_->_tmp15_ = _data_->field;
					_data_->_tmp16_ = (*_data_->_tmp15_).name;
					_data_->_tmp17_ = g_strdup (_data_->_tmp16_);
					_data_->_tmp18_ = _data_->field;
					_data_->_tmp19_ = (*_data_->_tmp18_).schema;
					_data_->_tmp20_ = g_strdup (_data_->_tmp19_);
					g_hash_table_insert (_data_->_tmp14_, _data_->_tmp17_, _data_->_tmp20_);
				} else {
					_data_->_tmp21_ = _data_->optional_schema;
					_data_->_tmp22_ = _data_->field;
					_data_->_tmp23_ = (*_data_->_tmp22_).name;
					_data_->_tmp24_ = g_strdup (_data_->_tmp23_);
					_data_->_tmp25_ = _data_->field;
					_data_->_tmp26_ = (*_data_->_tmp25_).schema;
					_data_->_tmp27_ = g_strdup (_data_->_tmp26_);
					g_hash_table_insert (_data_->_tmp21_, _data_->_tmp24_, _data_->_tmp27_);
				}
			}
		}
	...
	_data_->_tmp29_ = unity_internal_deprecated_scope_impl_create_dbus_name (_data_->self);
	_data_->_tmp30_ = _data_->_tmp29_;
	_data_->_tmp31_ = _data_->required_schema;
	_data_->_tmp32_ = _data_->optional_schema;
	_data_->_tmp33_ = unity_internal_scope_dbus_impl_get_filters_model ((UnityInternalScopeDBusImpl*) _data_->self);
	_data_->_tmp34_ = _data_->_tmp33_;
	_data_->_tmp35_ = unity_internal_scope_channel_create_channel (_data_->_tmp28_, _data_->_tmp30_, _data_->_tmp31_, _data_->_tmp32_, _data_->_tmp34_, _data_->flags);
	...
	if (_data_->_tmp38_ != NULL) {
		...
		dee_shared_model_set_flush_mode (_data_->_tmp40_, DEE_SHARED_MODEL_FLUSH_MODE_AUTOMATIC);
		_data_->_tmp41_ = _data_->channel;
		_data_->_tmp42_ = _data_->_tmp41_->transfer_model;
		_data_->_state_ = 1;
		unity_internal_utils_wait_for_model_synchronization (_data_->_tmp42_, unity_internal_deprecated_scope_impl_open_channel_ready, _data_);
		return FALSE;
		_state_1:
		unity_internal_utils_wait_for_model_synchronization_finish (_data_->_res_);
	}
	_data_->_tmp43_ = _data_->self->priv->_channels;
	...
	g_hash_table_insert (_data_->_tmp43_, _data_->_tmp46_, _data_->_tmp48_);
	...
	_g_hash_table_unref0 (_data_->out_hints);
	_data_->out_hints = _data_->_tmp51_;
	_data_->_tmp52_ = g_strdup (UNITY_PROTOCOL_CHANNEL_SWARM_NAME_HINT);
	_data_->_tmp53_ = _data_->model_name;
	_data_->_tmp54_ = g_variant_new_string (_data_->_tmp53_);
	g_variant_ref_sink (_data_->_tmp54_);
	g_hash_table_insert (_data_->out_hints, _data_->_tmp52_, _data_->_tmp54_);
...
static void
unity_internal_deprecated_scope_impl_close_channel_finish (UnityProtocolScopeService* base,
                                                           GAsyncResult* _res_,
                                                           GError** error)
{
	UnityInternalDeprecatedScopeImplCloseChannelData* _data_;
...
static void
unity_internal_deprecated_scope_impl_set_view_type_finish (UnityProtocolScopeService* base,
                                                           GAsyncResult* _res_,
                                                           GError** error)
{
	UnityInternalDeprecatedScopeImplSetViewTypeData* _data_;
...
static GHashTable*
unity_internal_deprecated_scope_impl_push_results_finish (UnityProtocolScopeService* base,
                                                          GAsyncResult* _res_,
                                                          GError** error)
{
	GHashTable* result;
                                                ...
                                                UnityDeprecatedScope* value)
{
	...
	g_return_if_fail (self != NULL);
	old_value = unity_internal_deprecated_scope_impl_get_owner (self);
	if (old_value != value) {
                                                                ...
                                                                DeeSerializableModel* value)
{
	...
	self = (UnityInternalDeprecatedScopeImpl*) base;
	old_value = unity_internal_deprecated_scope_impl_real_get_categories_model (base);
	if (old_value != value) {
		DeeSerializableModel* _tmp0_;
                                                             ...
                                                             DeeSerializableModel* value)
{
	...
	DeeSerializableModel* old_value;
	self = (UnityInternalDeprecatedScopeImpl*) base;
	old_value = unity_internal_deprecated_scope_impl_real_get_filters_model (base);
	if (old_value != value) {
		DeeSerializableModel* _tmp0_;
		_tmp0_ = _g_object_ref0 (value);
                                                    ...
                                                    UnityProtocolViewType value)
{
	...
	g_return_if_fail (self != NULL);
	old_value = unity_internal_deprecated_scope_impl_get_view_type (self);
	if (old_value != value) {
                                                 ...
                                                 gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityInternalDeprecatedScopeImpl_private_offset);
                                                                                  ...
                                                                                  gpointer iface_data)
{
	...
	iface->activate = (void (*) (UnityProtocolScopeService*, const gchar*, GVariant**, gint, guint, GHashTable*, GCancellable*, GAsyncReadyCallback, gpointer)) unity_internal_deprecated_scope_impl_real_activate;
	iface->activate_finish = (void (*) (UnityProtocolScopeService*, GAsyncResult*, UnityProtocolActivationReplyRaw*, GError**)) unity_internal_deprecated_scope_impl_activate_finish;
	...
	iface->search_finish = (GHashTable* (*) (UnityProtocolScopeService*, GAsyncResult*, GError**)) unity_internal_deprecated_scope_impl_search_finish;
	...
	iface->open_channel_finish = (gchar* (*) (UnityProtocolScopeService*, GAsyncResult*, GHashTable**, GError**)) unity_internal_deprecated_scope_impl_open_channel_finish;
	...
	iface->close_channel_finish = (void (*) (UnityProtocolScopeService*, GAsyncResult*, GError**)) unity_internal_deprecated_scope_impl_close_channel_finish;
	...
	iface->set_view_type_finish = (void (*) (UnityProtocolScopeService*, GAsyncResult*, GError**)) unity_internal_deprecated_scope_impl_set_view_type_finish;
	iface->push_results = (void (*) (UnityProtocolScopeService*, const gchar*, const gchar*, const gchar*, GVariant*, gchar**, gint, GCancellable*, GAsyncReadyCallback, gpointer)) unity_internal_deprecated_scope_impl_real_push_results;
	iface->push_results_finish = (GHashTable* (*) (UnityProtocolScopeService*, GAsyncResult*, GError**)) unity_internal_deprecated_scope_impl_push_results_finish;
...
unity_internal_deprecated_scope_impl_instance_init (UnityInternalDeprecatedScopeImpl * self,
                                                    gpointer klass)
{
	self->priv = unity_internal_deprecated_scope_impl_get_instance_private (self);
}
...
static GType
unity_internal_deprecated_scope_impl_get_type_once (void)
{
	...
	UnityInternalDeprecatedScopeImpl_private_offset = g_type_add_instance_private (unity_internal_deprecated_scope_impl_type_id, sizeof (UnityInternalDeprecatedScopeImplPrivate));
	return unity_internal_deprecated_scope_impl_type_id;
}

GType
unity_internal_deprecated_scope_impl_get_type (void)
{
	static volatile gsize unity_internal_deprecated_scope_impl_type_id__once = 0;
	if (g_once_init_enter (&unity_internal_deprecated_scope_impl_type_id__once)) {
		GType unity_internal_deprecated_scope_impl_type_id;
		unity_internal_deprecated_scope_impl_type_id = unity_internal_deprecated_scope_impl_get_type_once ();
		g_once_init_leave (&unity_internal_deprecated_scope_impl_type_id__once, unity_internal_deprecated_scope_impl_type_id);
	}
	return unity_internal_deprecated_scope_impl_type_id__once;
}
