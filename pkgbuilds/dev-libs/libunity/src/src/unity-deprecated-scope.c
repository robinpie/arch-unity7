/* unity-deprecated-scope.c generated by valac 0.56.19, the Vala compiler
...
static gint UnityDeprecatedScopeBase_private_offset;
...
static GType unity_deprecated_scope_base_get_type_once (void);
...
static void g_cclosure_user_marshal_VOID__OBJECT_ENUM_OBJECT (GClosure * closure,
                                                       ...
                                                       gpointer invocation_hint,
                                                       gpointer marshal_data);
static GType unity_deprecated_scope_get_type_once (void);
static inline gpointer _vala_memdup2 (gconstpointer mem,
                        gsize byte_size);

static inline gpointer
unity_deprecated_scope_base_get_instance_private (UnityDeprecatedScopeBase* self)
{
	return G_STRUCT_MEMBER_P (self, UnityDeprecatedScopeBase_private_offset);
}
...
unity_deprecated_scope_base_real_constructed (GObject* base)
{
	...
	_tmp1_ = UNITY_INTERNAL_IS_DEPRECATED_SCOPE_DBUS_IMPL (_tmp0_) ? ((UnityInternalDeprecatedScopeDBusImpl*) _tmp0_) : NULL;
	if (_tmp1_ == NULL) {
...
{
	UnityDeprecatedScopeBaseClass* _klass_;
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = UNITY_DEPRECATED_SCOPE_BASE_GET_CLASS (self);
	if (_klass_->create_impl) {
		return _klass_->create_impl (self);
	}
	return NULL;
}
                                    ...
                                    GError** error)
{
	...
	if (_tmp0_) {
		...
		unity_internal_scope_dbus_impl_export ((UnityInternalScopeDBusImpl*) _tmp1_, &_inner_error0_);
                                                         ...
                                                         gint active_sources__length1)
{
	...
	g_signal_emit (self, unity_deprecated_scope_base_signals[UNITY_DEPRECATED_SCOPE_BASE_ACTIVE_SOURCES_CHANGED_SIGNAL], 0, active_sources_, (gint) active_sources__length1);
}
...
unity_deprecated_scope_base_handle_search_co (UnityDeprecatedScopeBaseHandleSearchData* _data_)
{
	...
	return FALSE;
	_state_1:
	_data_->_tmp1_ = unity_protocol_scope_service_search_finish ((UnityProtocolScopeService*) _data_->_tmp0_, _data_->_res_, &_data_->_inner_error0_);
                                    ...
                                    const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_deprecated_scope_base_get_id (self);
                                           ...
                                           const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_deprecated_scope_base_get_dbus_path (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                                  ...
                                                  gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_deprecated_scope_base_get_search_in_global (self);
	if (old_value != value) {
                                         ...
                                         gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_deprecated_scope_base_get_visible (self);
	if (old_value != value) {
                                           ...
                                           gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_deprecated_scope_base_get_is_master (self);
	if (old_value != value) {
                                             ...
                                             const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_deprecated_scope_base_get_search_hint (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
...
unity_deprecated_scope_base_set_sources (UnityDeprecatedScopeBase* self,
                                         UnityOptionsFilter* value)
{
	UnityOptionsFilter* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_deprecated_scope_base_get_sources (self);
	if (old_value != value) {
		UnityOptionsFilter* _tmp0_;
...
unity_deprecated_scope_base_set_schema (UnityDeprecatedScopeBase* self,
                                        UnitySchema* value)
{
	UnitySchema* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_deprecated_scope_base_get_schema (self);
	if (old_value != value) {
		UnitySchema* _tmp0_;
		_tmp0_ = _g_object_ref0 (value);
                                        ...
                                        gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityDeprecatedScopeBase_private_offset);
...
unity_deprecated_scope_base_instance_init (UnityDeprecatedScopeBase * self,
                                           gpointer klass)
{
	self->priv = unity_deprecated_scope_base_get_instance_private (self);
...
static GType
unity_deprecated_scope_base_get_type_once (void)
{
	...
	UnityDeprecatedScopeBase_private_offset = g_type_add_instance_private (unity_deprecated_scope_base_type_id, sizeof (UnityDeprecatedScopeBasePrivate));
	return unity_deprecated_scope_base_type_id;
}

GType
unity_deprecated_scope_base_get_type (void)
{
	static volatile gsize unity_deprecated_scope_base_type_id__once = 0;
	if (g_once_init_enter (&unity_deprecated_scope_base_type_id__once)) {
		GType unity_deprecated_scope_base_type_id;
		unity_deprecated_scope_base_type_id = unity_deprecated_scope_base_get_type_once ();
		g_once_init_leave (&unity_deprecated_scope_base_type_id__once, unity_deprecated_scope_base_type_id);
	}
	return unity_deprecated_scope_base_type_id__once;
}
...
unity_deprecated_scope_preview_result (UnityDeprecatedScope* self,
                                       ...
                                       gpointer _user_data_)
{
	UnityDeprecatedScopeClass* _klass_;
	_klass_ = UNITY_DEPRECATED_SCOPE_GET_CLASS (self);
	if (_klass_->preview_result) {
		_klass_->preview_result (self, _result_, _callback_, _user_data_);
	}
}
                                              ...
                                              GAsyncResult* _res_)
{
	UnityDeprecatedScopeClass* _klass_;
	_klass_ = UNITY_DEPRECATED_SCOPE_GET_CLASS (self);
	if (_klass_->preview_result_finish) {
		return _klass_->preview_result_finish (self, _res_);
	}
	return NULL;
}
                                        ...
                                        gpointer _user_data_)
{
	UnityDeprecatedScopeClass* _klass_;
	_klass_ = UNITY_DEPRECATED_SCOPE_GET_CLASS (self);
	if (_klass_->activate_result) {
		_klass_->activate_result (self, _result_, _callback_, _user_data_);
	}
}
                                               ...
                                               GAsyncResult* _res_)
{
	UnityDeprecatedScopeClass* _klass_;
	_klass_ = UNITY_DEPRECATED_SCOPE_GET_CLASS (self);
	if (_klass_->activate_result_finish) {
		return _klass_->activate_result_finish (self, _res_);
	}
	return NULL;
}
                                             ...
                                             UnitySearchType search_type)
{
	...
	_tmp1_ = _g_object_ref0 (UNITY_INTERNAL_IS_DEPRECATED_SCOPE_IMPL (_tmp0_) ? ((UnityInternalDeprecatedScopeImpl*) _tmp0_) : NULL);
	pimpl = _tmp1_;
...
static GType
unity_deprecated_scope_get_type_once (void)
{
	...
	return unity_deprecated_scope_type_id;
}

GType
unity_deprecated_scope_get_type (void)
{
	static volatile gsize unity_deprecated_scope_type_id__once = 0;
	if (g_once_init_enter (&unity_deprecated_scope_type_id__once)) {
		GType unity_deprecated_scope_type_id;
		unity_deprecated_scope_type_id = unity_deprecated_scope_get_type_once ();
		g_once_init_leave (&unity_deprecated_scope_type_id__once, unity_deprecated_scope_type_id);
	}
	return unity_deprecated_scope_type_id__once;
}
