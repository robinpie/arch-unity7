/* unity-search.c generated by valac 0.56.19, the Vala compiler
...
static gint UnityInternalGLibCancellable_private_offset;
static gpointer unity_internal_glib_cancellable_parent_class = NULL;
static gint UnityDeprecatedScopeSearch_private_offset;
...
static GType unity_internal_glib_cancellable_get_type_once (void);
...
static GType unity_deprecated_scope_search_get_type_once (void);
...
static GType unity_aggregated_scope_search_get_type_once (void);

static inline gpointer
unity_internal_glib_cancellable_get_instance_private (UnityInternalGLibCancellable* self)
{
	return G_STRUCT_MEMBER_P (self, UnityInternalGLibCancellable_private_offset);
}
                                            ...
                                            gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityInternalGLibCancellable_private_offset);
...
{
	GCancellable* _tmp0_;
	self->priv = unity_internal_glib_cancellable_get_instance_private (self);
...
static GType
unity_internal_glib_cancellable_get_type_once (void)
{
	...
	UnityInternalGLibCancellable_private_offset = g_type_add_instance_private (unity_internal_glib_cancellable_type_id, sizeof (UnityInternalGLibCancellablePrivate));
	return unity_internal_glib_cancellable_type_id;
}

GType
unity_internal_glib_cancellable_get_type (void)
{
	static volatile gsize unity_internal_glib_cancellable_type_id__once = 0;
	if (g_once_init_enter (&unity_internal_glib_cancellable_type_id__once)) {
		GType unity_internal_glib_cancellable_type_id;
		unity_internal_glib_cancellable_type_id = unity_internal_glib_cancellable_get_type_once ();
		g_once_init_leave (&unity_internal_glib_cancellable_type_id__once, unity_internal_glib_cancellable_type_id);
	}
	return unity_internal_glib_cancellable_type_id__once;
}

static inline gpointer
unity_deprecated_scope_search_get_instance_private (UnityDeprecatedScopeSearch* self)
{
	return G_STRUCT_MEMBER_P (self, UnityDeprecatedScopeSearch_private_offset);
}
...
unity_deprecated_scope_search_real_async_run_co (UnityDeprecatedScopeSearchRealAsyncRunData* _data_)
{
	...
	if (_data_->finished_sig_id == ((gulong) 0)) {
	...
	_data_->_tmp2_ = _g_object_ref0 (UNITY_IS_DEPRECATED_SCOPE (_data_->_tmp1_) ? ((UnityDeprecatedScope*) _data_->_tmp1_) : NULL);
	_data_->depr_scope = _data_->_tmp2_;
	_data_->_tmp3_ = _data_->depr_scope;
	if (_data_->_tmp3_ != NULL) {
		_data_->_tmp4_ = ((UnityScopeSearchBase*) _data_->self)->search_context;
		_data_->_tmp5_ = (*_data_->_tmp4_).cancellable;
		_data_->_tmp6_ = unity_cancellable_get_gcancellable (_data_->_tmp5_);
		_data_->canc = _data_->_tmp6_;
		_data_->_tmp7_ = _data_->depr_scope;
		_data_->_tmp8_ = unity_deprecated_scope_search_get_search_type (_data_->self);
		_data_->_tmp9_ = _data_->_tmp8_;
		_data_->_tmp10_ = _data_->canc;
		g_signal_emit_by_name (_data_->_tmp7_, "search-changed", _data_->self, _data_->_tmp9_, _data_->_tmp10_);
		_data_->_data4_->waiting = TRUE;
		if (!_data_->_data4_->search_finished) {
			_data_->_state_ = 1;
			return FALSE;
			_state_1:
			;
...
"ope");
	...
	g_signal_handler_disconnect (_data_->self, _data_->finished_sig_id);
                                              ...
                                              const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_deprecated_scope_search_get_channel_id (self);
                                         ...
                                         GHashTable* value)
{
	...
	g_return_if_fail (self != NULL);
	old_value = unity_deprecated_scope_search_get_hints (self);
	if (old_value != value) {
		GHashTable* _tmp0_;
                                                 ...
                                                 DeeSerializableModel* value)
{
	...
	g_return_if_fail (self != NULL);
	old_value = unity_deprecated_scope_search_get_results_model (self);
	if (old_value != value) {
		DeeSerializableModel* _tmp0_;
...
{
	UnityDeprecatedScopeBase* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_deprecated_scope_search_get_owner (self);
	if (old_value != value) {
                                          ...
                                          gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityDeprecatedScopeSearch_private_offset);
...
unity_deprecated_scope_search_instance_init (UnityDeprecatedScopeSearch * self,
                                             gpointer klass)
{
	self->priv = unity_deprecated_scope_search_get_instance_private (self);
 ...
 */
static GType
unity_deprecated_scope_search_get_type_once (void)
{
	...
	UnityDeprecatedScopeSearch_private_offset = g_type_add_instance_private (unity_deprecated_scope_search_type_id, sizeof (UnityDeprecatedScopeSearchPrivate));
	return unity_deprecated_scope_search_type_id;
}

GType
unity_deprecated_scope_search_get_type (void)
{
	static volatile gsize unity_deprecated_scope_search_type_id__once = 0;
	if (g_once_init_enter (&unity_deprecated_scope_search_type_id__once)) {
		GType unity_deprecated_scope_search_type_id;
		unity_deprecated_scope_search_type_id = unity_deprecated_scope_search_get_type_once ();
		g_once_init_leave (&unity_deprecated_scope_search_type_id__once, unity_deprecated_scope_search_type_id);
	}
	return unity_deprecated_scope_search_type_id__once;
}
...
unity_aggregated_scope_search_search_scope_co (UnityAggregatedScopeSearchSearchScopeData* _data_)
{
	...
	_data_->_tmp5_ = _g_object_ref0 (UNITY_IS_AGGREGATOR_SCOPE (_data_->_tmp4_) ? ((UnityAggregatorScope*) _data_->_tmp4_) : NULL);
	...
	return FALSE;
	_state_1:
	_data_->_tmp11_ = unity_aggregator_scope_search_scope_finish (_data_->agg_scope, _data_->_res_, &_data_->_inner_error0_);
...
unity_aggregated_scope_search_push_results_co (UnityAggregatedScopeSearchPushResultsData* _data_)
{
	...
	_data_->_tmp4_ = _g_object_ref0 (UNITY_IS_AGGREGATOR_SCOPE (_data_->_tmp3_) ? ((UnityAggregatorScope*) _data_->_tmp3_) : NULL);
	...
	_data_->_state_ = 1;
	unity_aggregator_scope_push_results (_data_->_tmp8_, _data_->_tmp10_, _data_->_tmp12_, _data_->scope_id, _data_->results_model, _data_->category_ids, (gint) _data_->category_ids_length1, _data_->_tmp13_, unity_aggregated_scope_search_push_results_ready, _data_);
	return FALSE;
	_state_1:
                                                    ...
                                                    UnityFilterSet* filters)
{
	...
	_tmp3_ = _tmp2_;
	_tmp4_ = _g_object_ref0 (UNITY_IS_AGGREGATOR_SCOPE (_tmp3_) ? ((UnityAggregatorScope*) _tmp3_) : NULL);
	agg_scope = _tmp4_;
	_tmp5_ = agg_scope;
...
unity_aggregated_scope_search_real_async_run_co (UnityAggregatedScopeSearchRealAsyncRunData* _data_)
{
	...
	_data_->_tmp2_ = _g_object_ref0 (UNITY_IS_AGGREGATOR_SCOPE (_data_->_tmp1_) ? ((UnityAggregatorScope*) _data_->_tmp1_) : NULL);
...
static GType
unity_aggregated_scope_search_get_type_once (void)
{
	...
	return unity_aggregated_scope_search_type_id;
}

GType
unity_aggregated_scope_search_get_type (void)
{
	static volatile gsize unity_aggregated_scope_search_type_id__once = 0;
	if (g_once_init_enter (&unity_aggregated_scope_search_type_id__once)) {
		GType unity_aggregated_scope_search_type_id;
		unity_aggregated_scope_search_type_id = unity_aggregated_scope_search_get_type_once ();
		g_once_init_leave (&unity_aggregated_scope_search_type_id__once, unity_aggregated_scope_search_type_id);
	}
	return unity_aggregated_scope_search_type_id__once;
}
