/* unity-category.c generated by valac 0.56.19, the Vala compiler
...
static gint UnityProgressSourceProvider_private_offset;
static gpointer unity_progress_source_provider_parent_class = NULL;
static gint UnityCategory_private_offset;
...
static void unity_metadata_provider_real_update_hints (UnityMetadataProvider* self,
                                                GHashTable* hints);
static GType unity_metadata_provider_get_type_once (void);
...
static GType unity_progress_source_provider_get_type_once (void);
...
static GType unity_category_get_type_once (void);
...
static GType
unity_category_renderer_get_type_once (void)
{
	...
	return unity_category_renderer_type_id;
}

GType
unity_category_renderer_get_type (void)
{
	static volatile gsize unity_category_renderer_type_id__once = 0;
	if (g_once_init_enter (&unity_category_renderer_type_id__once)) {
		GType unity_category_renderer_type_id;
		unity_category_renderer_type_id = unity_category_renderer_get_type_once ();
		g_once_init_leave (&unity_category_renderer_type_id__once, unity_category_renderer_type_id);
	}
	return unity_category_renderer_type_id__once;
}
...
static GType
unity_category_content_type_get_type_once (void)
{
	...
	return unity_category_content_type_type_id;
}

GType
unity_category_content_type_get_type (void)
{
	static volatile gsize unity_category_content_type_type_id__once = 0;
	if (g_once_init_enter (&unity_category_content_type_type_id__once)) {
		GType unity_category_content_type_type_id;
		unity_category_content_type_type_id = unity_category_content_type_get_type_once ();
		g_once_init_leave (&unity_category_content_type_type_id__once, unity_category_content_type_type_id);
	}
	return unity_category_content_type_type_id__once;
}
...
unity_metadata_provider_update_hints (UnityMetadataProvider* self,
                                      GHashTable* hints)
{
	UnityMetadataProviderClass* _klass_;
	g_return_if_fail (self != NULL);
	_klass_ = UNITY_METADATA_PROVIDER_GET_CLASS (self);
	if (_klass_->update_hints) {
		_klass_->update_hints (self, hints);
	}
}
...
static GType
unity_metadata_provider_get_type_once (void)
{
	...
	return unity_metadata_provider_type_id;
}

GType
unity_metadata_provider_get_type (void)
{
	static volatile gsize unity_metadata_provider_type_id__once = 0;
	if (g_once_init_enter (&unity_metadata_provider_type_id__once)) {
		GType unity_metadata_provider_type_id;
		unity_metadata_provider_type_id = unity_metadata_provider_get_type_once ();
		g_once_init_leave (&unity_metadata_provider_type_id__once, unity_metadata_provider_type_id);
	}
	return unity_metadata_provider_type_id__once;
}

static inline gpointer
unity_progress_source_provider_get_instance_private (UnityProgressSourceProvider* self)
{
	return G_STRUCT_MEMBER_P (self, UnityProgressSourceProvider_private_offset);
}
                                              ...
                                              const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_progress_source_provider_get_dbus_name (self);
                                              ...
                                              const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_progress_source_provider_get_dbus_path (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                           ...
                                           gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityProgressSourceProvider_private_offset);
...
unity_progress_source_provider_instance_init (UnityProgressSourceProvider * self,
                                              gpointer klass)
{
	self->priv = unity_progress_source_provider_get_instance_private (self);
}
...
static GType
unity_progress_source_provider_get_type_once (void)
{
	...
	UnityProgressSourceProvider_private_offset = g_type_add_instance_private (unity_progress_source_provider_type_id, sizeof (UnityProgressSourceProviderPrivate));
	return unity_progress_source_provider_type_id;
}

GType
unity_progress_source_provider_get_type (void)
{
	static volatile gsize unity_progress_source_provider_type_id__once = 0;
	if (g_once_init_enter (&unity_progress_source_provider_type_id__once)) {
		GType unity_progress_source_provider_type_id;
		unity_progress_source_provider_type_id = unity_progress_source_provider_get_type_once ();
		g_once_init_leave (&unity_progress_source_provider_type_id__once, unity_progress_source_provider_type_id);
	}
	return unity_progress_source_provider_type_id__once;
}
...
static inline gpointer
unity_category_get_instance_private (UnityCategory* self)
{
	return G_STRUCT_MEMBER_P (self, UnityCategory_private_offset);
}
                       ...
                       const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_category_get_id (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                         ...
                         const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_category_get_name (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                              ...
                              GIcon* value)
{
	GIcon* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_category_get_icon_hint (self);
	if (old_value != value) {
		GIcon* _tmp0_;
...
unity_category_get_default_renderer (UnityCategory* self)
{
	...
	result = self->priv->_default_renderer;
	return result;
}
...
{
	UnityCategoryRenderer old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_category_get_default_renderer (self);
	if (old_value != value) {
...
{
	UnityCategoryContentType old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_category_get_content_type (self);
	if (old_value != value) {
                                  ...
                                  const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_category_get_renderer_hint (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                           ...
                           gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityCategory_private_offset);
...
unity_category_instance_init (UnityCategory * self,
                              gpointer klass)
{
	self->priv = unity_category_get_instance_private (self);
}
...
static GType
unity_category_get_type_once (void)
{
	...
	UnityCategory_private_offset = g_type_add_instance_private (unity_category_type_id, sizeof (UnityCategoryPrivate));
	return unity_category_type_id;
}

GType
unity_category_get_type (void)
{
	static volatile gsize unity_category_type_id__once = 0;
	if (g_once_init_enter (&unity_category_type_id__once)) {
		GType unity_category_type_id;
		unity_category_type_id = unity_category_get_type_once ();
		g_once_init_leave (&unity_category_type_id__once, unity_category_type_id);
	}
	return unity_category_type_id__once;
}
