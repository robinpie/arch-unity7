/* unity-simple-scope.c generated by valac 0.56.19, the Vala compiler
...
static gint UnitySimpleScope_private_offset;
static gpointer unity_simple_scope_parent_class = NULL;
static gint UnitySimpleScopeSimpleScopeSearch_private_offset;
static gpointer unity_simple_scope_simple_scope_search_parent_class = NULL;
static gint UnitySimpleScopeSimpleResultPreviewer_private_offset;
...
static GType unity_simple_scope_simple_scope_search_get_type_once (void);
...
static GType unity_simple_scope_simple_result_previewer_get_type_once (void);
static void unity_simple_scope_finalize (GObject * obj);
static GType unity_simple_scope_get_type_once (void);
...
unity_simple_scope_get_instance_private (UnitySimpleScope* self)
{
	return G_STRUCT_MEMBER_P (self, UnitySimpleScope_private_offset);
}
...
{
	UnityFilterSet* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_simple_scope_get_filter_set (self);
	if (old_value != value) {
		UnityFilterSet* _tmp0_;
...
{
	UnityCategorySet* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_simple_scope_get_category_set (self);
	if (old_value != value) {
		UnityCategorySet* _tmp0_;
		_tmp0_ = _g_object_ref0 (value);
                               ...
                               UnitySchema* value)
{
	...
	g_return_if_fail (self != NULL);
	old_value = unity_simple_scope_get_schema (self);
	if (old_value != value) {
		UnitySchema* _tmp0_;
		_tmp0_ = _g_object_ref0 (value);
                                    ...
                                    const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_simple_scope_get_search_hint (self);
                                   ...
                                   const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_simple_scope_get_group_name (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
                                    ...
                                    const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
	old_value = unity_simple_scope_get_unique_name (self);
	if (g_strcmp0 (value, old_value) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
...
static inline gpointer
unity_simple_scope_simple_scope_search_get_instance_private (UnitySimpleScopeSimpleScopeSearch* self)
{
	return G_STRUCT_MEMBER_P (self, UnitySimpleScopeSimpleScopeSearch_private_offset);
}
                                                   ...
                                                   gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnitySimpleScopeSimpleScopeSearch_private_offset);
...
unity_simple_scope_simple_scope_search_instance_init (UnitySimpleScopeSimpleScopeSearch * self,
                                                      gpointer klass)
{
	self->priv = unity_simple_scope_simple_scope_search_get_instance_private (self);
}
...
static GType
unity_simple_scope_simple_scope_search_get_type_once (void)
{
	...
	UnitySimpleScopeSimpleScopeSearch_private_offset = g_type_add_instance_private (unity_simple_scope_simple_scope_search_type_id, sizeof (UnitySimpleScopeSimpleScopeSearchPrivate));
	return unity_simple_scope_simple_scope_search_type_id;
}

static GType
unity_simple_scope_simple_scope_search_get_type (void)
{
	static volatile gsize unity_simple_scope_simple_scope_search_type_id__once = 0;
	if (g_once_init_enter (&unity_simple_scope_simple_scope_search_type_id__once)) {
		GType unity_simple_scope_simple_scope_search_type_id;
		unity_simple_scope_simple_scope_search_type_id = unity_simple_scope_simple_scope_search_get_type_once ();
		g_once_init_leave (&unity_simple_scope_simple_scope_search_type_id__once, unity_simple_scope_simple_scope_search_type_id);
	}
	return unity_simple_scope_simple_scope_search_type_id__once;
}

static inline gpointer
unity_simple_scope_simple_result_previewer_get_instance_private (UnitySimpleScopeSimpleResultPreviewer* self)
{
	return G_STRUCT_MEMBER_P (self, UnitySimpleScopeSimpleResultPreviewer_private_offset);
}
                                                       ...
                                                       gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnitySimpleScopeSimpleResultPreviewer_private_offset);
...
unity_simple_scope_simple_result_previewer_instance_init (UnitySimpleScopeSimpleResultPreviewer * self,
                                                          gpointer klass)
{
	self->priv = unity_simple_scope_simple_result_previewer_get_instance_private (self);
}
...
static GType
unity_simple_scope_simple_result_previewer_get_type_once (void)
{
	...
	UnitySimpleScopeSimpleResultPreviewer_private_offset = g_type_add_instance_private (unity_simple_scope_simple_result_previewer_type_id, sizeof (UnitySimpleScopeSimpleResultPreviewerPrivate));
	return unity_simple_scope_simple_result_previewer_type_id;
}

static GType
unity_simple_scope_simple_result_previewer_get_type (void)
{
	static volatile gsize unity_simple_scope_simple_result_previewer_type_id__once = 0;
	if (g_once_init_enter (&unity_simple_scope_simple_result_previewer_type_id__once)) {
		GType unity_simple_scope_simple_result_previewer_type_id;
		unity_simple_scope_simple_result_previewer_type_id = unity_simple_scope_simple_result_previewer_get_type_once ();
		g_once_init_leave (&unity_simple_scope_simple_result_previewer_type_id__once, unity_simple_scope_simple_result_previewer_type_id);
	}
	return unity_simple_scope_simple_result_previewer_type_id__once;
}
                               ...
                               gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnitySimpleScope_private_offset);
                                  ...
                                  gpointer klass)
{
	...
	UnitySchema* _tmp2_;
	gchar* _tmp3_;
	self->priv = unity_simple_scope_get_instance_private (self);
 ...
 */
static GType
unity_simple_scope_get_type_once (void)
{
	...
	UnitySimpleScope_private_offset = g_type_add_instance_private (unity_simple_scope_type_id, sizeof (UnitySimpleScopePrivate));
	return unity_simple_scope_type_id;
}

GType
unity_simple_scope_get_type (void)
{
	static volatile gsize unity_simple_scope_type_id__once = 0;
	if (g_once_init_enter (&unity_simple_scope_type_id__once)) {
		GType unity_simple_scope_type_id;
		unity_simple_scope_type_id = unity_simple_scope_get_type_once ();
		g_once_init_leave (&unity_simple_scope_type_id__once, unity_simple_scope_type_id);
	}
	return unity_simple_scope_type_id__once;
}
