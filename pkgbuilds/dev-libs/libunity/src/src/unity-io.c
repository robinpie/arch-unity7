/* unity-io.c generated by valac 0.56.19, the Vala compiler
...
unity_internal_io_read_stream_async_co (UnityInternalIoReadStreamAsyncData* _data_)
{
	...
	return FALSE;
	_state_1:
	g_output_stream_splice_finish ((GOutputStream*) _data_->_tmp1_, _data_->_res_, &_data_->_inner_error0_);
	...
	g_output_stream_close ((GOutputStream*) _data_->_tmp2_, NULL, &_data_->_inner_error0_);
	if (G_UNLIKELY (_data_->_inner_error0_ != NULL)) {
		if (_data_->_inner_error0_->domain == G_IO_ERROR) {
			g_task_return_error (_data_->_async_result, _data_->_inner_error0_);
			_g_object_unref0 (_data_->output);
...
unity_internal_io_open_from_data_dirs_co (UnityInternalIoOpenFromDataDirsData* _data_)
{
	...
	_data_->_state_ = 2;
	unity_internal_io_open_from_dirs (_data_->filename, _data_->_tmp14_, (gint) _data_->_tmp14__length1, unity_internal_io_open_from_data_dirs_ready, _data_);
	return FALSE;
	_state_2:
	_data_->_tmp15_ = unity_internal_io_open_from_dirs_finish (_data_->_res_, &_data_->_inner_error0_);
...
gchar**
unity_internal_io_get_system_data_dirs (gint* result_length1)
{
	gchar** _tmp0_;
	gint _tmp0__length1;
	gchar** _tmp8_;
