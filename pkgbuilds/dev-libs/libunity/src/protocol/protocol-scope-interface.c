/* protocol-scope-interface.c generated by valac 0.56.19, the Vala compiler
...
typedef struct _UnityProtocolScopeServiceActivateReadyData UnityProtocolScopeServiceActivateReadyData;
typedef struct _UnityProtocolScopeServiceSearchReadyData UnityProtocolScopeServiceSearchReadyData;
typedef struct _UnityProtocolScopeServiceOpenChannelReadyData UnityProtocolScopeServiceOpenChannelReadyData;
typedef struct _UnityProtocolScopeServiceCloseChannelReadyData UnityProtocolScopeServiceCloseChannelReadyData;
typedef struct _UnityProtocolScopeServicePushResultsReadyData UnityProtocolScopeServicePushResultsReadyData;
typedef struct _UnityProtocolScopeServiceSetViewTypeReadyData UnityProtocolScopeServiceSetViewTypeReadyData;

struct _UnityProtocolScopeServiceActivateReadyData {
...
struct _UnityProtocolScopeServiceSearchReadyData {
	GDBusMethodInvocation* _invocation_;
	gchar* channel_id;
	gchar* search_string;
	GHashTable* hints;
...
struct _UnityProtocolScopeServiceOpenChannelReadyData {
	GDBusMethodInvocation* _invocation_;
	guint channel_type;
	GHashTable* hints;
};

struct _UnityProtocolScopeServiceCloseChannelReadyData {
	GDBusMethodInvocation* _invocation_;
	gchar* channel_id;
	GHashTable* hints;
};

struct _UnityProtocolScopeServicePushResultsReadyData {
	GDBusMethodInvocation* _invocation_;
	gchar* channel_id;
	gchar* search_string;
...
struct _UnityProtocolScopeServiceSetViewTypeReadyData {
	GDBusMethodInvocation* _invocation_;
	guint view_type;
};
...
static void g_cclosure_user_marshal_VOID__STRING_VARIANT (GClosure * closure,
                                                   ...
                                                   gpointer invocation_hint,
                                                   gpointer marshal_data);
static GType unity_protocol_scope_service_get_type_once (void);
...
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_activate_channel_id = {-1, "channel_id", "s", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_activate_result_arr = {-1, "result_arr", "av", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_activate_action_type = {-1, "action_type", "u", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_activate_hints = {-1, "hints", "a{sv}", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_activate_result = {-1, "result", "(sua{sv})", NULL};
...
static const GDBusMethodInfo _unity_protocol_scope_service_dbus_method_info_activate = {-1, "Activate", (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_activate_in), (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_activate_out), NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_search_channel_id = {-1, "channel_id", "s", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_search_search_string = {-1, "search_string", "s", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_search_hints = {-1, "hints", "a{sv}", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_search_result = {-1, "result", "a{sv}", NULL};
...
static const GDBusMethodInfo _unity_protocol_scope_service_dbus_method_info_search = {-1, "Search", (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_search_in), (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_search_out), NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_open_channel_channel_type = {-1, "channel_type", "u", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_open_channel_hints = {-1, "hints", "a{sv}", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_open_channel_out_hints = {-1, "out_hints", "a{sv}", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_open_channel_result = {-1, "result", "s", NULL};
...
static const GDBusMethodInfo _unity_protocol_scope_service_dbus_method_info_open_channel = {-1, "OpenChannel", (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_open_channel_in), (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_open_channel_out), NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_close_channel_channel_id = {-1, "channel_id", "s", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_close_channel_hints = {-1, "hints", "a{sv}", NULL};
...
static const GDBusMethodInfo _unity_protocol_scope_service_dbus_method_info_close_channel = {-1, "CloseChannel", (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_close_channel_in), (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_close_channel_out), NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_push_results_channel_id = {-1, "channel_id", "s", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_push_results_search_string = {-1, "search_string", "s", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_push_results_source_scope_id = {-1, "source_scope_id", "s", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_push_results_result_variant = {-1, "result_variant", "v", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_push_results_categories = {-1, "categories", "as", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_push_results_result = {-1, "result", "a{sv}", NULL};
...
static const GDBusMethodInfo _unity_protocol_scope_service_dbus_method_info_push_results = {-1, "PushResults", (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_push_results_in), (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_push_results_out), NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_set_view_type_view_type = {-1, "view_type", "u", NULL};
...
static const GDBusMethodInfo _unity_protocol_scope_service_dbus_method_info_set_view_type = {-1, "SetViewType", (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_set_view_type_in), (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_set_view_type_out), NULL};
...
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_category_order_changed_channel_id = {-1, "channel_id", "s", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_category_order_changed_new_order = {-1, "new_order", "au", NULL};
...
static const GDBusSignalInfo _unity_protocol_scope_service_dbus_signal_info_category_order_changed = {-1, "CategoryOrderChanged", (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_category_order_changed), NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_filter_settings_changed_channel_id = {-1, "channel_id", "s", NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_filter_settings_changed_filter_rows = {-1, "filter_rows", "a(ssssa{sv}bbb)", NULL};
...
static const GDBusSignalInfo _unity_protocol_scope_service_dbus_signal_info_filter_settings_changed = {-1, "FilterSettingsChanged", (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_filter_settings_changed), NULL};
static const GDBusArgInfo _unity_protocol_scope_service_dbus_arg_info_results_invalidated_channel_type = {-1, "channel_type", "u", NULL};
...
static const GDBusSignalInfo _unity_protocol_scope_service_dbus_signal_info_results_invalidated = {-1, "ResultsInvalidated", (GDBusArgInfo **) (&_unity_protocol_scope_service_dbus_arg_info_results_invalidated), NULL};
...
static const GDBusPropertyInfo _unity_protocol_scope_service_dbus_property_info_protocol_version = {-1, "ProtocolVersion", "i", G_DBUS_PROPERTY_INFO_FLAGS_READABLE, NULL};
static const GDBusPropertyInfo _unity_protocol_scope_service_dbus_property_info_visible = {-1, "Visible", "b", G_DBUS_PROPERTY_INFO_FLAGS_READABLE, NULL};
static const GDBusPropertyInfo _unity_protocol_scope_service_dbus_property_info_is_master = {-1, "IsMaster", "b", G_DBUS_PROPERTY_INFO_FLAGS_READABLE, NULL};
static const GDBusPropertyInfo _unity_protocol_scope_service_dbus_property_info_search_hint = {-1, "SearchHint", "s", G_DBUS_PROPERTY_INFO_FLAGS_READABLE, NULL};
static const GDBusPropertyInfo _unity_protocol_scope_service_dbus_property_info_metadata = {-1, "Metadata", "a{ss}", G_DBUS_PROPERTY_INFO_FLAGS_READABLE, NULL};
static const GDBusPropertyInfo _unity_protocol_scope_service_dbus_property_info_optional_metadata = {-1, "OptionalMetadata", "a{ss}", G_DBUS_PROPERTY_INFO_FLAGS_READABLE, NULL};
static const GDBusPropertyInfo _unity_protocol_scope_service_dbus_property_info_categories = {-1, "Categories", "v", G_DBUS_PROPERTY_INFO_FLAGS_READABLE, NULL};
static const GDBusPropertyInfo _unity_protocol_scope_service_dbus_property_info_filters = {-1, "Filters", "v", G_DBUS_PROPERTY_INFO_FLAGS_READABLE, NULL};
static const GDBusPropertyInfo _unity_protocol_scope_service_dbus_property_info_hints = {-1, "Hints", "a{sv}", G_DBUS_PROPERTY_INFO_FLAGS_READABLE, NULL};
...
static GType
unity_protocol_activation_reply_raw_get_type_once (void)
{
	...
	return unity_protocol_activation_reply_raw_type_id;
}

GType
unity_protocol_activation_reply_raw_get_type (void)
{
	static volatile gsize unity_protocol_activation_reply_raw_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_activation_reply_raw_type_id__once)) {
		GType unity_protocol_activation_reply_raw_type_id;
		unity_protocol_activation_reply_raw_type_id = unity_protocol_activation_reply_raw_get_type_once ();
		g_once_init_leave (&unity_protocol_activation_reply_raw_type_id__once, unity_protocol_activation_reply_raw_type_id);
	}
	return unity_protocol_activation_reply_raw_type_id__once;
}

static GType
unity_protocol_handled_type_get_type_once (void)
{
	...
	return unity_protocol_handled_type_type_id;
}

GType
unity_protocol_handled_type_get_type (void)
{
	static volatile gsize unity_protocol_handled_type_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_handled_type_type_id__once)) {
		GType unity_protocol_handled_type_type_id;
		unity_protocol_handled_type_type_id = unity_protocol_handled_type_get_type_once ();
		g_once_init_leave (&unity_protocol_handled_type_type_id__once, unity_protocol_handled_type_type_id);
	}
	return unity_protocol_handled_type_type_id__once;
}

static GType
unity_protocol_action_type_get_type_once (void)
{
	...
	return unity_protocol_action_type_type_id;
}

GType
unity_protocol_action_type_get_type (void)
{
	static volatile gsize unity_protocol_action_type_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_action_type_type_id__once)) {
		GType unity_protocol_action_type_type_id;
		unity_protocol_action_type_type_id = unity_protocol_action_type_get_type_once ();
		g_once_init_leave (&unity_protocol_action_type_type_id__once, unity_protocol_action_type_type_id);
	}
	return unity_protocol_action_type_type_id__once;
}

static GType
unity_protocol_view_type_get_type_once (void)
{
	...
	return unity_protocol_view_type_type_id;
}

GType
unity_protocol_view_type_get_type (void)
{
	static volatile gsize unity_protocol_view_type_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_view_type_type_id__once)) {
		GType unity_protocol_view_type_type_id;
		unity_protocol_view_type_type_id = unity_protocol_view_type_get_type_once ();
		g_once_init_leave (&unity_protocol_view_type_type_id__once, unity_protocol_view_type_type_id);
	}
	return unity_protocol_view_type_type_id__once;
}

static GType
unity_protocol_channel_type_get_type_once (void)
{
	...
	return unity_protocol_channel_type_type_id;
}

GType
unity_protocol_channel_type_get_type (void)
{
	static volatile gsize unity_protocol_channel_type_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_channel_type_type_id__once)) {
		GType unity_protocol_channel_type_type_id;
		unity_protocol_channel_type_type_id = unity_protocol_channel_type_get_type_once ();
		g_once_init_leave (&unity_protocol_channel_type_type_id__once, unity_protocol_channel_type_type_id);
	}
	return unity_protocol_channel_type_type_id__once;
}
...
unity_protocol_channel_flags_from_hints (GHashTable* hints)
{
	...
	if (g_hash_table_contains (hints, UNITY_PROTOCOL_CHANNEL_DIFF_MODEL_HINT)) {
		...
		_tmp3_ = g_hash_table_lookup (hints, UNITY_PROTOCOL_CHANNEL_DIFF_MODEL_HINT);
		_tmp2_ = g_variant_get_boolean ((GVariant*) _tmp3_);
	} else {
		_tmp2_ = FALSE;
	}
	if (_tmp2_) {
...
static GType
unity_protocol_channel_flags_get_type_once (void)
{
	...
	return unity_protocol_channel_flags_type_id;
}

GType
unity_protocol_channel_flags_get_type (void)
{
	static volatile gsize unity_protocol_channel_flags_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_channel_flags_type_id__once)) {
		GType unity_protocol_channel_flags_type_id;
		unity_protocol_channel_flags_type_id = unity_protocol_channel_flags_get_type_once ();
		g_once_init_leave (&unity_protocol_channel_flags_type_id__once, unity_protocol_channel_flags_type_id);
	}
	return unity_protocol_channel_flags_type_id__once;
}
...
unity_protocol_scope_error_quark (void)
{
	...
	g_dbus_error_register_error_domain ("unity-protocol-scope-error-quark", &unity_protocol_scope_error_quark_volatile, unity_protocol_scope_error_entries, G_N_ELEMENTS (unity_protocol_scope_error_entries));
...
unity_protocol_scope_service_activate (UnityProtocolScopeService* self,
                                       ...
                                       gpointer _user_data_)
{
	UnityProtocolScopeServiceIface* _iface_;
	_iface_ = UNITY_PROTOCOL_SCOPE_SERVICE_GET_INTERFACE (self);
	if (_iface_->activate) {
                                           ...
                                           gpointer _user_data_)
{
	...
	if (_iface_->open_channel) {
		_iface_->open_channel (self, channel_type, hints, cancellable, sender, _callback_, _user_data_);
	}
}
                                                  ...
                                                  GError** error)
{
	...
	if (_iface_->open_channel_finish) {
		return _iface_->open_channel_finish (self, _res_, out_hints, error);
	}
	return NULL;
}
                                            ...
                                            gpointer _user_data_)
{
	...
	if (_iface_->close_channel) {
		_iface_->close_channel (self, channel_id, hints, cancellable, _callback_, _user_data_);
	}
}
                                           ...
                                           gpointer _user_data_)
{
	...
	if (_iface_->push_results) {
		_iface_->push_results (self, channel_id, search_string, source_scope_id, result_variant, categories, categories_length1, cancellable, _callback_, _user_data_);
	}
}
                                            ...
                                            gpointer _user_data_)
{
	...
	if (_iface_->set_view_type) {
		_iface_->set_view_type (self, view_type, _callback_, _user_data_);
	}
}
                                                   ...
                                                   GError** error)
{
	UnityProtocolScopeServiceIface* _iface_;
	_iface_ = UNITY_PROTOCOL_SCOPE_SERVICE_GET_INTERFACE (self);
	if (_iface_->set_view_type_finish) {
		_iface_->set_view_type_finish (self, _res_, error);
	}
}
...
unity_protocol_scope_service_get_categories (UnityProtocolScopeService* self)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_iface_ = UNITY_PROTOCOL_SCOPE_SERVICE_GET_INTERFACE (self);
	if (_iface_->get_categories) {
		return _iface_->get_categories (self);
	}
	return NULL;
}
...
unity_protocol_scope_service_get_filters (UnityProtocolScopeService* self)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_iface_ = UNITY_PROTOCOL_SCOPE_SERVICE_GET_INTERFACE (self);
	if (_iface_->get_filters) {
		return _iface_->get_filters (self);
	}
	return NULL;
}
...
unity_protocol_scope_service_get_hints (UnityProtocolScopeService* self)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_iface_ = UNITY_PROTOCOL_SCOPE_SERVICE_GET_INTERFACE (self);
	if (_iface_->get_hints) {
		return _iface_->get_hints (self);
	}
	return NULL;
}
 ...
 */
static GType
unity_protocol_scope_service_get_type_once (void)
{
	...
	return unity_protocol_scope_service_type_id;
}

GType
unity_protocol_scope_service_get_type (void)
{
	static volatile gsize unity_protocol_scope_service_type_id__once = 0;
	if (g_once_init_enter (&unity_protocol_scope_service_type_id__once)) {
		GType unity_protocol_scope_service_type_id;
		unity_protocol_scope_service_type_id = unity_protocol_scope_service_get_type_once ();
		g_once_init_leave (&unity_protocol_scope_service_type_id__once, unity_protocol_scope_service_type_id);
	}
	return unity_protocol_scope_service_type_id__once;
}
...
{
	g_dbus_proxy_set_interface_info (G_DBUS_PROXY (self), (GDBusInterfaceInfo *) (&_unity_protocol_scope_service_dbus_interface_info));
}
...
{
	GVariantIter _arguments_iter;
	UnityProtocolScopeServiceActivateReadyData* _ready_data;
	GVariant* _tmp70_;
	GVariant* _tmp71_;
	GVariant** _tmp72_;
	gint _tmp72__length;
	...
	_ready_data = g_slice_new0 (UnityProtocolScopeServiceActivateReadyData);
	_ready_data->_invocation_ = invocation;
	_tmp70_ = g_variant_iter_next_value (&_arguments_iter);
	_ready_data->channel_id = g_variant_dup_string (_tmp70_, NULL);
	...
	_ready_data->result_arr_length1 = _tmp72__length1;
	_tmp72_[_tmp72__length] = NULL;
	_ready_data->result_arr = _tmp72_;
	g_variant_unref (_tmp71_);
	_tmp75_ = g_variant_iter_next_value (&_arguments_iter);
	_ready_data->action_type = g_variant_get_uint32 (_tmp75_);
	...
	_ready_data->hints = _tmp77_;
	g_variant_unref (_tmp76_);
	unity_protocol_scope_service_activate (self, _ready_data->channel_id, _ready_data->result_arr, _ready_data->result_arr_length1, _ready_data->action_type, _ready_data->hints, NULL, (GAsyncReadyCallback) _dbus_unity_protocol_scope_service_activate_ready, _ready_data);
	_error:
	;
}
                                                   ...
                                                   gpointer _user_data_)
{
	...
	g_object_unref (_reply_message);
	_error:
	_g_free0 (_ready_data->channel_id);
	_ready_data->result_arr = (_vala_array_free (_ready_data->result_arr, _ready_data->result_arr_length1, (GDestroyNotify) g_variant_unref), NULL);
	_g_hash_table_unref0 (_ready_data->hints);
	g_slice_free (UnityProtocolScopeServiceActivateReadyData, _ready_data);
}
...
{
	GVariantIter _arguments_iter;
	UnityProtocolScopeServiceSearchReadyData* _ready_data;
	GVariant* _tmp86_;
	GVariant* _tmp87_;
	GVariant* _tmp88_;
	GHashTable* _tmp89_;
	...
	GVariant* _tmp92_;
	g_variant_iter_init (&_arguments_iter, _parameters_);
	_ready_data = g_slice_new0 (UnityProtocolScopeServiceSearchReadyData);
	_ready_data->_invocation_ = invocation;
	_tmp86_ = g_variant_iter_next_value (&_arguments_iter);
	_ready_data->channel_id = g_variant_dup_string (_tmp86_, NULL);
	g_variant_unref (_tmp86_);
	_tmp87_ = g_variant_iter_next_value (&_arguments_iter);
	_ready_data->search_string = g_variant_dup_string (_tmp87_, NULL);
	...
	_ready_data->hints = _tmp89_;
	g_variant_unref (_tmp88_);
	unity_protocol_scope_service_search (self, _ready_data->channel_id, _ready_data->search_string, _ready_data->hints, NULL, (GAsyncReadyCallback) _dbus_unity_protocol_scope_service_search_ready, _ready_data);
	_error:
	;
}
                                                 ...
                                                 gpointer _user_data_)
{
	...
	_error:
	_g_free0 (_ready_data->channel_id);
	_g_free0 (_ready_data->search_string);
	_g_hash_table_unref0 (_ready_data->hints);
	g_slice_free (UnityProtocolScopeServiceSearchReadyData, _ready_data);
}
...
{
	GVariantIter _arguments_iter;
	UnityProtocolScopeServiceOpenChannelReadyData* _ready_data;
	GVariant* _tmp97_;
	GVariant* _tmp98_;
	GHashTable* _tmp99_;
	...
	GVariant* _tmp102_;
	g_variant_iter_init (&_arguments_iter, _parameters_);
	_ready_data = g_slice_new0 (UnityProtocolScopeServiceOpenChannelReadyData);
	_ready_data->_invocation_ = invocation;
	_tmp97_ = g_variant_iter_next_value (&_arguments_iter);
	_ready_data->channel_type = g_variant_get_uint32 (_tmp97_);
	...
	_ready_data->hints = _tmp99_;
	g_variant_unref (_tmp98_);
	unity_protocol_scope_service_open_channel (self, _ready_data->channel_type, _ready_data->hints, NULL, g_dbus_method_invocation_get_sender (invocation), (GAsyncReadyCallback) _dbus_unity_protocol_scope_service_open_channel_ready, _ready_data);
	_error:
	;
}
                                                       ...
                                                       gpointer _user_data_)
{
	...
	g_slice_free (UnityProtocolScopeServiceOpenChannelReadyData, _ready_data);
}
...
{
	GVariantIter _arguments_iter;
	UnityProtocolScopeServiceCloseChannelReadyData* _ready_data;
	GVariant* _tmp107_;
	GVariant* _tmp108_;
	GHashTable* _tmp109_;
	...
	GVariant* _tmp112_;
	g_variant_iter_init (&_arguments_iter, _parameters_);
	_ready_data = g_slice_new0 (UnityProtocolScopeServiceCloseChannelReadyData);
	_ready_data->_invocation_ = invocation;
	_tmp107_ = g_variant_iter_next_value (&_arguments_iter);
	_ready_data->channel_id = g_variant_dup_string (_tmp107_, NULL);
	...
	_ready_data->hints = _tmp109_;
	g_variant_unref (_tmp108_);
	unity_protocol_scope_service_close_channel (self, _ready_data->channel_id, _ready_data->hints, NULL, (GAsyncReadyCallback) _dbus_unity_protocol_scope_service_close_channel_ready, _ready_data);
	_error:
	;
}
                                                        ...
                                                        gpointer _user_data_)
{
	...
	_g_free0 (_ready_data->channel_id);
	_g_hash_table_unref0 (_ready_data->hints);
	g_slice_free (UnityProtocolScopeServiceCloseChannelReadyData, _ready_data);
}
...
{
	GVariantIter _arguments_iter;
	UnityProtocolScopeServicePushResultsReadyData* _ready_data;
	GVariant* _tmp113_;
	GVariant* _tmp114_;
	GVariant* _tmp115_;
	GVariant* _tmp116_;
	GVariant* _tmp117_;
	gchar** _tmp118_;
	gint _tmp118__length;
	gint _tmp118__size;
	gint _tmp118__length1;
	GVariantIter _tmp119_;
	GVariant* _tmp120_;
	g_variant_iter_init (&_arguments_iter, _parameters_);
	_ready_data = g_slice_new0 (UnityProtocolScopeServicePushResultsReadyData);
	_ready_data->_invocation_ = invocation;
	_tmp113_ = g_variant_iter_next_value (&_arguments_iter);
	_ready_data->channel_id = g_variant_dup_string (_tmp113_, NULL);
	g_variant_unref (_tmp113_);
	_tmp114_ = g_variant_iter_next_value (&_arguments_iter);
	_ready_data->search_string = g_variant_dup_string (_tmp114_, NULL);
	g_variant_unref (_tmp114_);
	_tmp115_ = g_variant_iter_next_value (&_arguments_iter);
	_ready_data->source_scope_id = g_variant_dup_string (_tmp115_, NULL);
	g_variant_unref (_tmp115_);
	_tmp116_ = g_variant_iter_next_value (&_arguments_iter);
	_ready_data->result_variant = g_variant_get_variant (_tmp116_);
	...
	_ready_data->categories_length1 = _tmp118__length1;
	_tmp118_[_tmp118__length] = NULL;
	_ready_data->categories = _tmp118_;
	g_variant_unref (_tmp117_);
	unity_protocol_scope_service_push_results (self, _ready_data->channel_id, _ready_data->search_string, _ready_data->source_scope_id, _ready_data->result_variant, _ready_data->categories, _ready_data->categories_length1, NULL, (GAsyncReadyCallback) _dbus_unity_protocol_scope_service_push_results_ready, _ready_data);
	_error:
	;
}
                                                       ...
                                                       gpointer _user_data_)
{
	...
	_g_free0 (_ready_data->channel_id);
	_g_free0 (_ready_data->search_string);
	_g_free0 (_ready_data->source_scope_id);
	_g_variant_unref0 (_ready_data->result_variant);
	_ready_data->categories = (_vala_array_free (_ready_data->categories, _ready_data->categories_length1, (GDestroyNotify) g_free), NULL);
	g_slice_free (UnityProtocolScopeServicePushResultsReadyData, _ready_data);
}
...
{
	GVariantIter _arguments_iter;
	UnityProtocolScopeServiceSetViewTypeReadyData* _ready_data;
	GVariant* _tmp125_;
	g_variant_iter_init (&_arguments_iter, _parameters_);
	_ready_data = g_slice_new0 (UnityProtocolScopeServiceSetViewTypeReadyData);
	_ready_data->_invocation_ = invocation;
	_tmp125_ = g_variant_iter_next_value (&_arguments_iter);
	_ready_data->view_type = g_variant_get_uint32 (_tmp125_);
	g_variant_unref (_tmp125_);
	unity_protocol_scope_service_set_view_type (self, _ready_data->view_type, (GAsyncReadyCallback) _dbus_unity_protocol_scope_service_set_view_type_ready, _ready_data);
}
                                                        ...
                                                        gpointer _user_data_)
{
	...
	g_object_unref (_reply_message);
	_error:
	g_slice_free (UnityProtocolScopeServiceSetViewTypeReadyData, _ready_data);
}
