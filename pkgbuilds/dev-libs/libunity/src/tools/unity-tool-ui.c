/* unity-tool-ui.c generated by valac 0.56.19, the Vala compiler
...
static gint UnityTesterUnityToolUi_private_offset;
...
static void ___lambda6__gasync_ready_callback (GObject* source_object,
                                        GAsyncResult* res,
                                        gpointer self);
VALA_EXTERN void unity_tester_unity_tool_ui_on_scope_combobox_clicked (GtkMenuItem* item,
                                                           UnityTesterUnityToolUi* self);
VALA_EXTERN void unity_tester_unity_tool_ui_on_connect_clicked (GtkMenuItem* item,
                                                    UnityTesterUnityToolUi* self);
VALA_EXTERN void unity_tester_unity_tool_ui_on_clear_log_clicked (GtkMenuItem* item,
                                                      UnityTesterUnityToolUi* self);
...
VALA_EXTERN void unity_tester_unity_tool_ui_on_scope_connect (GtkDialog* dlg,
                                                  gint response,
                                                  UnityTesterUnityToolUi* self);
...
static void _____lambda10__gasync_ready_callback (GObject* source_object,
                                           GAsyncResult* res,
                                           gpointer self);
VALA_EXTERN void unity_tester_unity_tool_ui_on_from_scope_clicked (GtkButton* btn,
                                                       UnityTesterUnityToolUi* self);
VALA_EXTERN void unity_tester_get_scope_params_from_file (const gchar* filename,
                                              GError** error);
VALA_EXTERN void unity_tester_unity_tool_ui_on_results_button_clicked (GtkButton* btn,
                                                           UnityTesterUnityToolUi* self);
VALA_EXTERN void unity_tester_unity_tool_ui_on_search_button_clicked (GtkButton* btn,
                                                          UnityTesterUnityToolUi* self);
...
VALA_EXTERN void unity_tester_unity_tool_ui_on_request_preview (GtkMenuItem* item,
                                                    UnityTesterUnityToolUi* self);
...
static GVariant** unity_tester_unity_tool_ui_get_selected_result_variant (UnityTesterUnityToolUi* self,
                                                                   ...
                                                                   gint* result_length1);
VALA_EXTERN void unity_tester_unity_tool_ui_on_prev_preview_clicked (GtkButton* button,
                                                         UnityTesterUnityToolUi* self);
VALA_EXTERN void unity_tester_unity_tool_ui_on_next_preview_clicked (GtkMenuItem* item,
                                                         UnityTesterUnityToolUi* self);
VALA_EXTERN void unity_tester_unity_tool_ui_on_activate_result (GtkMenuItem* item,
                                                    UnityTesterUnityToolUi* self);
...
static void ___lambda17__gasync_ready_callback (GObject* source_object,
                                         GAsyncResult* res,
                                         gpointer self);
VALA_EXTERN void unity_tester_unity_tool_ui_on_results_popup_request (GtkWidget* widget,
                                                          UnityTesterUnityToolUi* self);
VALA_EXTERN gboolean unity_tester_unity_tool_ui_on_results_right_click (GtkWidget* widget,
                                                            GdkEventButton* event,
                                                            UnityTesterUnityToolUi* self);
static void unity_tester_unity_tool_ui_finalize (GObject * obj);
static GType unity_tester_unity_tool_ui_get_type_once (void);
...
unity_tester_unity_tool_ui_get_instance_private (UnityTesterUnityToolUi* self)
{
	return G_STRUCT_MEMBER_P (self, UnityTesterUnityToolUi_private_offset);
}
...
unity_tester_unity_tool_ui_init_gui (UnityTesterUnityToolUi* self)
{
	...
	builder = _tmp0_;
	{
		...
		_tmp1_ = builder;
		gtk_builder_add_from_resource (_tmp1_, "/com/canonical/Unity/unity-tool/unity-tool.ui", &_inner_error0_);
            ...
            GAsyncResult* res)
{
	...
	g_return_if_fail (res != NULL);
	{
		...
		GList* _tmp0_;
		GtkSpinner* _tmp11_;
		_tmp0_ = unity_tester_dbus_lens_util_findLenses_finish (_data8_->c, res, &_inner_error0_);
		results = _tmp0_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			goto __catch0_g_error;
		}
		{
			...
			for (addr_it = addr_collection; addr_it != NULL; addr_it = addr_it->next) {
				UnityTesterDBusLensUtilDBusObjectAddress _tmp1_;
				UnityTesterDBusLensUtilDBusObjectAddress _tmp2_ = {0};
				UnityTesterDBusLensUtilDBusObjectAddress addr = {0};
				_tmp1_ = *((UnityTesterDBusLensUtilDBusObjectAddress*) addr_it->data);
				unity_tester_dbus_lens_util_dbus_object_address_copy (&_tmp1_, &_tmp2_);
				addr = _tmp2_;
				{
					GtkListStore* _tmp3_;
					...
					_data8_->iter = _tmp4_;
					_tmp5_ = self->priv->scope_list_model;
					_tmp6_ = _data8_->iter;
					_tmp7_ = addr;
		...
		_tmp11_ = self->priv->scope_discovery_spinner;
	...
	__catch0_g_error:
	{
		...
		_tmp15_ = self->priv->scope_discovery_spinner;
...
unity_tester_unity_tool_ui_show_connect_dialog (UnityTesterUnityToolUi* self)
{
	...
	builder = _tmp0_;
	{
		...
		const gchar* _tmp16_;
		GtkDialog* _tmp24_;
		gtk_builder_add_from_resource (builder, "/com/canonical/Unity/unity-tool/dbus-scope-connect.ui", &_inner_error0_);
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			goto __catch0_g_error;
		}
...
unity_tester_unity_tool_ui_update_status (UnityTesterUnityToolUi* self)
{
	...
	gtk_statusbar_pop (_tmp0_, self->priv->statusbar_info_ctx);
	_tmp1_ = self->priv->statusbar;
	_tmp2_ = self->priv->dee_results_model;
	_tmp3_ = g_strdup_printf ("%u records", dee_model_get_n_rows ((DeeModel*) _tmp2_));
	_tmp4_ = _tmp3_;
	_tmp5_ = g_strconcat (_tmp4_, ", DBus name: ", NULL);
	_tmp6_ = _tmp5_;
	_tmp7_ = unity_tester_options_scope_dbus_name;
	_tmp8_ = g_strconcat (_tmp6_, _tmp7_, NULL);
	_tmp9_ = _tmp8_;
	_tmp10_ = g_strconcat (_tmp9_, " path: ", NULL);
	_tmp11_ = _tmp10_;
	_tmp12_ = unity_tester_options_scope_dbus_path;
	_tmp13_ = g_strconcat (_tmp11_, _tmp12_, NULL);
	_tmp14_ = _tmp13_;
	gtk_statusbar_push (_tmp1_, self->priv->statusbar_info_ctx, _tmp14_);
	_g_free0 (_tmp14_);
	_g_free0 (_tmp11_);
	_g_free0 (_tmp9_);
	_g_free0 (_tmp6_);
                                                      ...
                                                      const gchar* name)
{
	...
	_g_free0 (_tmp1_);
	g_bus_unwatch_name (self->priv->dbus_watcher_id);
               ...
               GAsyncResult* res)
{
	...
	proxy = _tmp0_;
	_tmp3_ = unity_protocol_scope_service_open_channel_finish (proxy, res, &_tmp2_, &_inner_error0_);
                                             ...
                                             UnityTesterUnityToolUi* self)
{
	...
	if (response == 1) {
		...
		bus = NULL;
		{
			...
			UnityProtocolScopeService* _tmp35_;
			GVariant* _tmp36_;
			GVariant* _tmp37_;
			GVariant* _tmp38_;
			GObject* _tmp39_;
			...
			gint _tmp53_ = 0;
			UnityProtocolScopeService* _tmp54_;
			GHashTable* _tmp55_;
			GHashTable* _tmp56_;
			const gchar* _tmp57_;
			const gchar* _tmp58_;
			...
			_tmp15_ = (UnityProtocolScopeService*) g_initable_new (UNITY_PROTOCOL_TYPE_SCOPE_SERVICE_PROXY, NULL, &_inner_error0_, "g-flags", 0, "g-name", _tmp13_, "g-connection", _tmp12_, "g-object-path", _tmp14_, "g-interface-name", "com.canonical.Unity.Scope", NULL);
			...
			if (self->priv->dbus_watcher_id > ((guint) 0)) {
				g_bus_unwatch_name (self->priv->dbus_watcher_id);
			}
			_tmp17_ = unity_tester_options_scope_dbus_name;
			self->priv->dbus_watcher_id = g_bus_watch_name_with_closures (G_BUS_TYPE_SESSION, _tmp17_, G_BUS_NAME_WATCHER_FLAGS_AUTO_START, (GClosure*) ((NULL == NULL) ? NULL : g_cclosure_new ((GCallback) NULL, NULL, (GClosureNotify) NULL)), (GClosure*) ((_unity_tester_unity_tool_ui_on_scope_service_vanished_gbus_name_vanished_callback == NULL) ? NULL : g_cclosure_new ((GCallback) _unity_tester_unity_tool_ui_on_scope_service_vanished_gbus_name_vanished_callback, g_object_ref (self), (GClosureNotify) g_object_unref)));
			_tmp18_ = self->priv->scope_proxy;
			_tmp19_ = unity_protocol_scope_service_get_filters (_tmp18_);
			_tmp20_ = _tmp19_;
			_tmp21_ = _tmp20_;
			_tmp22_ = dee_serializable_parse (_tmp21_, dee_sequence_model_get_type ());
			_tmp23_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp22_, dee_serializable_model_get_type ()) ? ((DeeSerializableModel*) _tmp22_) : NULL;
			if (_tmp23_ == NULL) {
				_g_object_unref0 (_tmp22_);
			}
			_g_object_unref0 (self->priv->dee_filters_model);
			self->priv->dee_filters_model = _tmp23_;
			_g_variant_unref0 (_tmp21_);
			{
				...
				_tmp25_ = dee_model_get_first_iter ((DeeModel*) _tmp24_);
				iter = _tmp25_;
				{
					...
					while (TRUE) {
						...
						if (!_tmp26_) {
							...
							_tmp27_ = self->priv->dee_filters_model;
							_tmp28_ = iter;
						...
						_tmp26_ = FALSE;
						_tmp30_ = iter;
						_tmp31_ = self->priv->dee_filters_model;
						_tmp32_ = dee_model_get_last_iter ((DeeModel*) _tmp31_);
						if (!(_tmp30_ != _tmp32_)) {
							break;
						}
						_tmp33_ = self->priv->dee_filters_model;
						_tmp34_ = iter;
						unity_tester_unity_tool_ui_filters_row_added_cb (self, (DeeModel*) _tmp33_, _tmp34_);
					}
				}
			}
			_tmp35_ = self->priv->scope_proxy;
			_tmp36_ = unity_protocol_scope_service_get_categories (_tmp35_);
			_tmp37_ = _tmp36_;
			_tmp38_ = _tmp37_;
			_tmp39_ = dee_serializable_parse (_tmp38_, dee_sequence_model_get_type ());
			_tmp40_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp39_, dee_serializable_model_get_type ()) ? ((DeeSerializableModel*) _tmp39_) : NULL;
			if (_tmp40_ == NULL) {
				_g_object_unref0 (_tmp39_);
			}
			_g_object_unref0 (self->priv->dee_categories_model);
			self->priv->dee_categories_model = _tmp40_;
			_g_variant_unref0 (_tmp38_);
			{
				DeeModelIter* iter = NULL;
				DeeSerializableModel* _tmp41_;
				DeeModelIter* _tmp42_;
				_tmp41_ = self->priv->dee_categories_model;
				_tmp42_ = dee_model_get_first_iter ((DeeModel*) _tmp41_);
				iter = _tmp42_;
				{
					...
					while (TRUE) {
						...
						if (!_tmp43_) {
							...
							_tmp44_ = self->priv->dee_categories_model;
							_tmp45_ = iter;
							_tmp46_ = dee_model_next ((DeeModel*) _tmp44_, _tmp45_);
							iter = _tmp46_;
						}
						_tmp43_ = FALSE;
						_tmp47_ = iter;
						_tmp48_ = self->priv->dee_categories_model;
						_tmp49_ = dee_model_get_last_iter ((DeeModel*) _tmp48_);
						if (!(_tmp47_ != _tmp49_)) {
							break;
						}
						_tmp50_ = self->priv->dee_categories_model;
						_tmp51_ = iter;
						unity_tester_unity_tool_ui_categories_row_added_cb (self, (DeeModel*) _tmp50_, _tmp51_);
					}
				}
			}
			_tmp52_ = self->priv->search_type_global_rbutton;
			is_global = gtk_toggle_button_get_active ((GtkToggleButton*) _tmp52_);
			if (is_global) {
				_tmp53_ = 1;
			} else {
				_tmp53_ = 0;
			}
			_tmp54_ = self->priv->scope_proxy;
			_tmp55_ = g_hash_table_new_full (NULL, NULL, _g_free0_, _g_variant_unref0_);
			_tmp56_ = _tmp55_;
			unity_protocol_scope_service_open_channel (_tmp54_, (guint) _tmp53_, _tmp56_, NULL, NULL, _____lambda10__gasync_ready_callback, g_object_ref (self));
			_g_hash_table_unref0 (_tmp56_);
			_tmp57_ = unity_tester_options_scope_dbus_name;
			_tmp58_ = unity_tester_options_scope_dbus_path;
			_tmp59_ = g_strdup_printf ("Connected to: %s, %s\n", _tmp57_, _tmp58_);
			_tmp60_ = _tmp59_;
			unity_tester_unity_tool_ui_append_log_message (self, _tmp60_);
			_g_free0 (_tmp60_);
		...
		__catch0_g_io_error:
		{
			...
			unity_tester_unity_tool_ui_handle_error (self, _tmp62_);
			_g_error_free0 (e);
		}
		__finally0:
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
	...
	if (gtk_dialog_run ((GtkDialog*) _tmp6_) == 1) {
		{
			...
			_tmp9_ = _tmp8_;
			unity_tester_get_scope_params_from_file (_tmp9_, &_inner_error0_);
			_g_free0 (_tmp9_);
			if (G_UNLIKELY (_inner_error0_ != NULL)) {
				goto __catch0_g_error;
			}
              ...
              GAsyncResult* res)
{
	...
	g_return_if_fail (res != NULL);
	{
		...
		_tmp0_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (obj, UNITY_PROTOCOL_TYPE_SCOPE_SERVICE) ? ((UnityProtocolScopeService*) obj) : NULL);
		proxy = _tmp0_;
		_tmp1_ = unity_protocol_scope_service_search_finish (proxy, res, &_inner_error0_);
		_result_ = _tmp1_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			_g_object_unref0 (proxy);
			goto __catch0_g_error;
...
unity_tester_unity_tool_ui_dump_activation_reply (UnityProtocolActivationReplyRaw* reply)
{
	...
	_tmp3_ = *reply;
	_tmp4_ = (*g_enum_get_value (_tmp2_, (gint) _tmp3_.handled)).value_name;
	...
	g_hash_table_foreach (_tmp10_, ___lambda13__gh_func, _data10_);
	g_string_append (_data10_->bld, "\n\t}\n}");
	_tmp11_ = _data10_->bld->str;
                                         ...
                                         const gchar* message)
{
	...
	gtk_spinner_stop (_tmp0_);
	_tmp1_ = self->priv->statusbar;
	gtk_statusbar_pop (_tmp1_, self->priv->statusbar_error_ctx);
	_tmp2_ = self->priv->statusbar;
	gtk_statusbar_push (_tmp2_, self->priv->statusbar_error_ctx, message);
	_tmp3_ = g_strconcat (message, "\n", NULL);
	_tmp4_ = _tmp3_;
...
unity_tester_unity_tool_ui_send_activate_co (UnityTesterUnityToolUiSendActivateData* _data_)
{
	...
	_data_->_state_ = 1;
	unity_protocol_scope_service_activate (_data_->_tmp4_, _data_->channel_id, _data_->result_arr, (gint) _data_->result_arr_length1, _data_->action_type, _data_->_tmp5_, NULL, unity_tester_unity_tool_ui_send_activate_ready, _data_);
	return FALSE;
	_state_1:
	unity_protocol_scope_service_activate_finish (_data_->_tmp4_, _data_->_res_, &_data_->_tmp6_, &_data_->_inner_error0_);
             ...
             GAsyncResult* res)
{
	...
	g_return_if_fail (res != NULL);
	{
		...
		UnityProtocolActivationReplyRaw _tmp6_;
		GtkNotebook* _tmp7_;
		unity_tester_unity_tool_ui_send_activate_finish (self, res, &_tmp0_, &_inner_error0_);
		__vala_UnityProtocolActivationReplyRaw_free0 (_data11_->reply_struct);
		_tmp1_ = _tmp0_;
		_tmp2_ = _tmp1_;
                                             ...
                                             gint result_arr_length1)
{
	...
	unity_tester_unity_tool_ui_send_activate (self, channel_id, result_arr, (gint) result_arr_length1, (guint) UNITY_PROTOCOL_ACTION_TYPE_PREVIEW_RESULT, NULL, ___lambda14__gasync_ready_callback, block11_data_ref (_data11_));
                                               ...
                                               UnityTesterUnityToolUi* self)
{
	...
	if (_tmp3_) {
		...
		_tmp7_ = iter;
		_tmp8_ = __vala_GtkTreeIter_copy0 (&_tmp7_);
		__vala_GtkTreeIter_free0 (self->priv->last_active_iter);
		...
		unity_tester_unity_tool_ui_activate_preview (self, _tmp9_, _tmp13_, (gint) _tmp11_);
                                                    ...
                                                    UnityTesterUnityToolUi* self)
{
	...
	if (_tmp5_) {
		...
		unity_tester_unity_tool_ui_activate_preview (self, _tmp13_, _tmp14_, (gint) _tmp14__length1);
		_tmp15_ = model;
		_tmp16_ = iter;
                                               ...
                                               UnityTesterUnityToolUi* self)
{
	...
	unity_tester_unity_tool_ui_send_activate (self, _tmp3_, result_arr, (gint) result_arr_length1, (guint) UNITY_PROTOCOL_ACTION_TYPE_ACTIVATE_RESULT, NULL, ___lambda18__gasync_ready_callback, block12_data_ref (_data12_));
	result_arr = (_vala_array_free (result_arr, result_arr_length1, (GDestroyNotify) g_variant_unref), NULL);
                                                        ...
                                                        gint* result_length1)
{
	...
	if (_tmp3_) {
		...
		_tmp11_ = model;
		_tmp12_ = iter;
		gtk_tree_model_get_value (_tmp11_, &_tmp12_, 1, &_tmp13_);
		G_IS_VALUE (&value) ? (g_value_unset (&value), NULL) : NULL;
		value = _tmp13_;
		_tmp14_ = result_props;
		_tmp14__length1 = result_props_length1;
		_tmp15_ = g_value_get_string (&value);
		_tmp16_ = _variant_new5 (_tmp15_);
		_g_variant_unref0 (_tmp14_[1]);
		_tmp14_[1] = _tmp16_;
		_tmp17_ = model;
		_tmp18_ = iter;
		gtk_tree_model_get_value (_tmp17_, &_tmp18_, 2, &_tmp19_);
		G_IS_VALUE (&value) ? (g_value_unset (&value), NULL) : NULL;
		value = _tmp19_;
		_tmp20_ = result_props;
		_tmp20__length1 = result_props_length1;
		_tmp21_ = _variant_new6 (g_value_get_uint (&value));
		_g_variant_unref0 (_tmp20_[2]);
		_tmp20_[2] = _tmp21_;
		_tmp22_ = model;
		_tmp23_ = iter;
		gtk_tree_model_get_value (_tmp22_, &_tmp23_, 3, &_tmp24_);
		G_IS_VALUE (&value) ? (g_value_unset (&value), NULL) : NULL;
		value = _tmp24_;
		_tmp25_ = result_props;
		_tmp25__length1 = result_props_length1;
		_tmp26_ = _variant_new7 (g_value_get_uint (&value));
		_g_variant_unref0 (_tmp25_[3]);
		_tmp25_[3] = _tmp26_;
		_tmp27_ = model;
		_tmp28_ = iter;
		gtk_tree_model_get_value (_tmp27_, &_tmp28_, 4, &_tmp29_);
		G_IS_VALUE (&value) ? (g_value_unset (&value), NULL) : NULL;
		value = _tmp29_;
		_tmp30_ = result_props;
		_tmp30__length1 = result_props_length1;
		_tmp31_ = g_value_get_string (&value);
		_tmp32_ = _variant_new8 (_tmp31_);
		_g_variant_unref0 (_tmp30_[4]);
		_tmp30_[4] = _tmp32_;
		_tmp33_ = model;
		_tmp34_ = iter;
		gtk_tree_model_get_value (_tmp33_, &_tmp34_, 5, &_tmp35_);
		G_IS_VALUE (&value) ? (g_value_unset (&value), NULL) : NULL;
		value = _tmp35_;
		_tmp36_ = result_props;
		_tmp36__length1 = result_props_length1;
		_tmp37_ = g_value_get_string (&value);
		_tmp38_ = _variant_new9 (_tmp37_);
		_g_variant_unref0 (_tmp36_[5]);
		_tmp36_[5] = _tmp38_;
		_tmp39_ = model;
		_tmp40_ = iter;
		gtk_tree_model_get_value (_tmp39_, &_tmp40_, 6, &_tmp41_);
		G_IS_VALUE (&value) ? (g_value_unset (&value), NULL) : NULL;
		value = _tmp41_;
		_tmp42_ = result_props;
		_tmp42__length1 = result_props_length1;
		_tmp43_ = g_value_get_string (&value);
		_tmp44_ = _variant_new10 (_tmp43_);
		_g_variant_unref0 (_tmp42_[6]);
		_tmp42_[6] = _tmp44_;
		_tmp45_ = model;
		_tmp46_ = iter;
		gtk_tree_model_get_value (_tmp45_, &_tmp46_, 7, &_tmp47_);
		G_IS_VALUE (&value) ? (g_value_unset (&value), NULL) : NULL;
		value = _tmp47_;
		_tmp48_ = result_props;
		_tmp48__length1 = result_props_length1;
		_tmp49_ = g_value_get_string (&value);
		_tmp50_ = _variant_new11 (_tmp49_);
		_g_variant_unref0 (_tmp48_[7]);
		_tmp48_[7] = _tmp50_;
		_tmp51_ = model;
		_tmp52_ = iter;
		gtk_tree_model_get_value (_tmp51_, &_tmp52_, 8, &_tmp53_);
		G_IS_VALUE (&value) ? (g_value_unset (&value), NULL) : NULL;
		value = _tmp53_;
		_tmp55_ = g_value_get_string (&value);
		_tmp56_ = g_variant_parse (NULL, _tmp55_, NULL, NULL, &_inner_error0_);
		_tmp54_ = _tmp56_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			G_IS_VALUE (&value) ? (g_value_unset (&value), NULL) : NULL;
			_g_object_unref0 (model);
		...
		_tmp57_ = result_props;
		_tmp57__length1 = result_props_length1;
		_tmp58_ = _tmp54_;
		_tmp54_ = NULL;
		_g_variant_unref0 (_tmp57_[8]);
		_tmp57_[8] = _tmp58_;
		_g_variant_unref0 (_tmp54_);
		G_IS_VALUE (&value) ? (g_value_unset (&value), NULL) : NULL;
	}
	_tmp59_ = result_props;
	_tmp59__length1 = result_props_length1;
	if (result_length1) {
                                                    ...
                                                    UnityProtocolActivationReplyRaw* reply_struct)
{
	...
	_g_free0 (_tmp2_);
	_tmp7_ = *reply_struct;
	if (_tmp7_.handled == ((guint) UNITY_HANDLED_TYPE_SHOW_PREVIEW)) {
		UnityProtocolActivationReplyRaw _tmp8_;
		GHashTable* _tmp9_;
		_tmp8_ = *reply_struct;
		_tmp9_ = _tmp8_.hints;
		if (g_hash_table_contains (_tmp9_, "preview")) {
			UnityProtocolActivationReplyRaw _tmp10_;
			GHashTable* _tmp11_;
			gconstpointer _tmp12_;
			_tmp10_ = *reply_struct;
			_tmp11_ = _tmp10_.hints;
			_tmp12_ = g_hash_table_lookup (_tmp11_, "preview");
			unity_tester_unity_tool_ui_handle_preview (self, (GVariant*) _tmp12_);
		} else {
...
unity_tester_unity_tool_ui_update_preview (UnityTesterUnityToolUi* self)
{
	...
	if (_tmp0_ != NULL) {
		...
		if (UNITY_TESTER_IS_SERIES_PREVIEW_RENDERER (_tmp3_)) {
			...
			if (UNITY_TESTER_IS_MUSIC_PREVIEW_RENDERER (_tmp5_)) {
				...
				_tmp7_ = _g_object_ref0 (UNITY_TESTER_IS_MUSIC_PREVIEW_RENDERER (_tmp6_) ? ((UnityTesterMusicPreviewRenderer*) _tmp6_) : NULL);
				renderer = _tmp7_;
				_tmp8_ = renderer;
                                                      ...
                                                      const gchar* action_id)
{
	...
	unity_tester_unity_tool_ui_send_activate (self, _tmp3_, _tmp7_, (gint) _tmp5_, (guint) UNITY_PROTOCOL_ACTION_TYPE_PREVIEW_ACTION, hints, ___lambda15__gasync_ready_callback, block13_data_ref (_data13_));
             ...
             GAsyncResult* res)
{
	...
	g_return_if_fail (res != NULL);
	{
		...
		unity_tester_unity_tool_ui_send_update_finish (self, res, &_tmp0_, &_inner_error0_);
		_g_hash_table_unref0 (_data14_->ht);
		_data14_->ht = _tmp0_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			if (_inner_error0_->domain == G_IO_ERROR) {
	...
	g_return_if_fail (res != NULL);
	{
		...
		if (_data15_->ht != NULL) {
			...
			if (g_hash_table_contains (_data15_->ht, "preview")) {
				...
				if (UNITY_TESTER_IS_SERIES_PREVIEW_RENDERER (_tmp7_)) {
					...
					_tmp11_ = _tmp10_;
					unity_tester_series_preview_renderer_update_child_preview (UNITY_TESTER_IS_SERIES_PREVIEW_RENDERER (_tmp8_) ? ((UnityTesterSeriesPreviewRenderer*) _tmp8_) : NULL, _tmp11_);
					_g_object_unref0 (_tmp11_);
					unity_tester_unity_tool_ui_update_preview (self);
				}
			}
                                                   ...
                                                   UnityTesterUnityToolUi* self)
{
	...
	if (_tmp0_) {
		GtkMenu* _tmp1_;
		_tmp1_ = self->priv->results_popup_menu;
                                       ...
                                       gpointer klass_data)
{
	...
	g_type_class_adjust_private_offset (klass, &UnityTesterUnityToolUi_private_offset);
                                          ...
                                          gpointer klass)
{
	gchar* _tmp0_;
	gchar* _tmp1_;
	self->priv = unity_tester_unity_tool_ui_get_instance_private (self);
	self->priv->preview_renderer = NULL;
	self->priv->scope_proxy = NULL;
	self->priv->dbus_watcher_id = (guint) 0;
...
static GType
unity_tester_unity_tool_ui_get_type_once (void)
{
	...
	UnityTesterUnityToolUi_private_offset = g_type_add_instance_private (unity_tester_unity_tool_ui_type_id, sizeof (UnityTesterUnityToolUiPrivate));
	return unity_tester_unity_tool_ui_type_id;
}

GType
unity_tester_unity_tool_ui_get_type (void)
{
	static volatile gsize unity_tester_unity_tool_ui_type_id__once = 0;
	if (g_once_init_enter (&unity_tester_unity_tool_ui_type_id__once)) {
		GType unity_tester_unity_tool_ui_type_id;
		unity_tester_unity_tool_ui_type_id = unity_tester_unity_tool_ui_get_type_once ();
		g_once_init_leave (&unity_tester_unity_tool_ui_type_id__once, unity_tester_unity_tool_ui_type_id);
	}
	return unity_tester_unity_tool_ui_type_id__once;
}
