/* unity-extra-utils.c generated by valac 0.56.19, the Vala compiler
...
typedef struct _UnityExtrasFileManagerInterfaceShowItemsReadyData UnityExtrasFileManagerInterfaceShowItemsReadyData;
...
struct _UnityExtrasFileManagerInterfaceShowItemsReadyData {
...
VALA_EXTERN void unity_extras_file_manager_interface_show_items_finish (UnityExtrasFileManagerInterface* self,
                                                            GAsyncResult* _res_,
                                                            GError** error);
static GType unity_extras_file_manager_interface_get_type_once (void);
...
static const GDBusArgInfo _unity_extras_file_manager_interface_dbus_arg_info_show_items_uris = {-1, "uris", "as", NULL};
static const GDBusArgInfo _unity_extras_file_manager_interface_dbus_arg_info_show_items_startup_id = {-1, "startup_id", "s", NULL};
...
static const GDBusMethodInfo _unity_extras_file_manager_interface_dbus_method_info_show_items = {-1, "ShowItems", (GDBusArgInfo **) (&_unity_extras_file_manager_interface_dbus_arg_info_show_items_in), (GDBusArgInfo **) (&_unity_extras_file_manager_interface_dbus_arg_info_show_items_out), NULL};
...
static const GDBusInterfaceInfo _unity_extras_file_manager_interface_dbus_interface_info = {-1, "org.freedesktop.FileManager1", (GDBusMethodInfo **) (&_unity_extras_file_manager_interface_dbus_method_info), (GDBusSignalInfo **) (&_unity_extras_file_manager_interface_dbus_signal_info), (GDBusPropertyInfo **) (&_unity_extras_file_manager_interface_dbus_property_info), NULL};
...
unity_extras_file_manager_interface_show_items (UnityExtrasFileManagerInterface* self,
                                                ...
                                                gpointer _user_data_)
{
	UnityExtrasFileManagerInterfaceIface* _iface_;
	_iface_ = UNITY_EXTRAS_FILE_MANAGER_INTERFACE_GET_INTERFACE (self);
	if (_iface_->show_items) {
		_iface_->show_items (self, uris, uris_length1, startup_id, _callback_, _user_data_);
	}
}
                                                       ...
                                                       GError** error)
{
	UnityExtrasFileManagerInterfaceIface* _iface_;
	_iface_ = UNITY_EXTRAS_FILE_MANAGER_INTERFACE_GET_INTERFACE (self);
	if (_iface_->show_items_finish) {
		_iface_->show_items_finish (self, _res_, error);
	}
}
...
static GType
unity_extras_file_manager_interface_get_type_once (void)
{
	...
	return unity_extras_file_manager_interface_type_id;
}

GType
unity_extras_file_manager_interface_get_type (void)
{
	static volatile gsize unity_extras_file_manager_interface_type_id__once = 0;
	if (g_once_init_enter (&unity_extras_file_manager_interface_type_id__once)) {
		GType unity_extras_file_manager_interface_type_id;
		unity_extras_file_manager_interface_type_id = unity_extras_file_manager_interface_get_type_once ();
		g_once_init_leave (&unity_extras_file_manager_interface_type_id__once, unity_extras_file_manager_interface_type_id);
	}
	return unity_extras_file_manager_interface_type_id__once;
}
...
{
	g_dbus_proxy_set_interface_info (G_DBUS_PROXY (self), (GDBusInterfaceInfo *) (&_unity_extras_file_manager_interface_dbus_interface_info));
}
                                                      ...
                                                      GDBusMethodInvocation* invocation)
{
	...
	UnityExtrasFileManagerInterfaceShowItemsReadyData* _ready_data;
	GVariant* _tmp17_;
	gchar** _tmp18_;
	gint _tmp18__length;
	gint _tmp18__size;
	...
	_ready_data = g_slice_new0 (UnityExtrasFileManagerInterfaceShowItemsReadyData);
	...
	_ready_data->uris_length1 = _tmp18__length1;
	_tmp18_[_tmp18__length] = NULL;
	_ready_data->uris = _tmp18_;
	g_variant_unref (_tmp17_);
	_tmp21_ = g_variant_iter_next_value (&_arguments_iter);
	_ready_data->startup_id = g_variant_dup_string (_tmp21_, NULL);
	g_variant_unref (_tmp21_);
	unity_extras_file_manager_interface_show_items (self, _ready_data->uris, _ready_data->uris_length1, _ready_data->startup_id, (GAsyncReadyCallback) _dbus_unity_extras_file_manager_interface_show_items_ready, _ready_data);
	_error:
	;
}
                                                            ...
                                                            gpointer _user_data_)
{
	...
	_g_free0 (_ready_data->startup_id);
	g_slice_free (UnityExtrasFileManagerInterfaceShowItemsReadyData, _ready_data);
}
		...
		if (_data_->_tmp6_ != NULL) {
			{
				...
				return FALSE;
				_state_1:
				_data_->_tmp7_ = (UnityExtrasFileManagerInterface*) g_async_initable_new_finish ((GAsyncInitable *) _data_->_source_object_, _data_->_res_, &_data_->_inner_error0_);
				...
				_data_->_state_ = 2;
				unity_extras_file_manager_interface_show_items (_data_->_tmp8_, _data_->_tmp9_, (gint) _data_->_tmp9__length1, "", unity_extras_show_in_folder_ready, _data_);
				return FALSE;
				_state_2:
				unity_extras_file_manager_interface_show_items_finish (_data_->_tmp8_, _data_->_res_, &_data_->_inner_error0_);
				if (G_UNLIKELY (_data_->_inner_error0_ != NULL)) {
...
"%s', uri '%s'", _data_->_tmp11_, _data_->uri);
			...
			g_app_info_launch_default_for_uri (_data_->_tmp14_, NULL, &_data_->_inner_error0_);
                                  ...
                                  GError** error)
{
	...
	_tmp10_ = _result_;
	g_variant_get (_tmp10_, "(b)", &_tmp11_, NULL);
	has_owner = _tmp11_;
	result = has_owner;
                            ...
                            GError** error)
{
	...
	app = NULL;
	_tmp0_ = unity_extras_dbus_name_has_owner (name, &_inner_error0_);
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		g_propagate_error (error, _inner_error0_);
