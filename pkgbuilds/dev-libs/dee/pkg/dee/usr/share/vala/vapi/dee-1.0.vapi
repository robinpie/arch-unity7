...
namespace Dee {
	...
	[CCode (cheader_filename = "dee-icu.h", cprefix = "DEE_ICU_ERROR_", has_type_id = false)]
	...
	[CCode (cheader_filename = "dee.h", cprefix = "DEE_SHARED_MODEL_ERROR_LEADER_", has_type_id = false)]
	...
	[Version (replacement = "Filter.new_collator")]
	public static Dee.Filter filter_new_collator (uint column);
	[CCode (cheader_filename = "dee.h")]
	[Version (replacement = "Filter.new_collator_desc")]
	public static Dee.Filter filter_new_collator_desc (uint column);
	[CCode (cheader_filename = "dee.h")]
	[Version (replacement = "Filter.new_for_any_column")]
	public static Dee.Filter filter_new_for_any_column (uint column, GLib.Variant value);
	[CCode (cheader_filename = "dee.h")]
	[Version (replacement = "Filter.new_for_key_column")]
	public static Dee.Filter filter_new_for_key_column (uint column, string key);
	[CCode (cheader_filename = "dee.h")]
	[Version (replacement = "Filter.new_regex")]
	public static Dee.Filter filter_new_regex (uint column, GLib.Regex regex);
	[CCode (cheader_filename = "dee.h")]
	[Version (replacement = "Filter.new_sort")]
	public static Dee.Filter filter_new_sort (owned Dee.CompareRowFunc cmp_row);
	[CCode (cheader_filename = "dee.h")]
	[Version (replacement = "ModelReader.new")]
	public static Dee.ModelReader model_reader_new (owned Dee.ModelReaderFunc reader_func);
	[CCode (cheader_filename = "dee.h")]
	[Version (replacement = "ModelReader.new_for_int32_column")]
	public static Dee.ModelReader model_reader_new_for_int32_column (uint column);
	[CCode (cheader_filename = "dee.h")]
	[Version (replacement = "ModelReader.new_for_string_column")]
	public static Dee.ModelReader model_reader_new_for_string_column (uint column);
	[CCode (cheader_filename = "dee.h")]
	[Version (replacement = "ModelReader.new_for_uint32_column")]
	public static Dee.ModelReader model_reader_new_for_uint32_column (uint column);
}
