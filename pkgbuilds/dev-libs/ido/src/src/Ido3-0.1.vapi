/* Ido3-0.1.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "Ido", gir_namespace = "Ido3", gir_version = "0.1", lower_case_cprefix = "ido_")]
namespace Ido {
	[CCode (cheader_filename = "Ido3-0.1.h", type_id = "ido_calendar_menu_item_get_type ()")]
	...
	[CCode (cheader_filename = "Ido3-0.1.h", type_id = "ido_entry_menu_item_get_type ()")]
	...
	[CCode (cheader_filename = "Ido3-0.1.h", type_id = "ido_message_dialog_get_type ()")]
	public class MessageDialog : Gtk.MessageDialog, Atk.Implementor, Gtk.Buildable {
		[CCode (has_construct_function = false)]
		protected MessageDialog ();
	}
	[CCode (cheader_filename = "Ido3-0.1.h", type_id = "ido_range_get_type ()")]
	...
	[CCode (cheader_filename = "Ido3-0.1.h", type_id = "ido_scale_menu_item_get_type ()")]
	...
	[CCode (cheader_filename = "Ido3-0.1.h", type_id = "ido_switch_menu_item_get_type ()")]
	...
	[CCode (cheader_filename = "Ido3-0.1.h", type_id = "ido_timeline_get_type ()")]
	...
	[CCode (cheader_filename = "Ido3-0.1.h", cprefix = "IDO_RANGE_STYLE_", has_type_id = false)]
	public enum RangeStyle {
		DEFAULT,
		SMALL
	}
	[CCode (cheader_filename = "Ido3-0.1.h", cprefix = "IDO_SCALE_MENU_ITEM_STYLE_", has_type_id = false)]
	public enum ScaleMenuItemStyle {
		NONE,
		IMAGE,
		LABEL
	}
	[CCode (cheader_filename = "Ido3-0.1.h", cprefix = "IDO_TIMELINE_DIRECTION_", has_type_id = false)]
	public enum TimelineDirection {
		FORWARD,
		BACKWARD
	}
	[CCode (cheader_filename = "Ido3-0.1.h", cprefix = "IDO_TIMELINE_PROGRESS_", has_type_id = false)]
