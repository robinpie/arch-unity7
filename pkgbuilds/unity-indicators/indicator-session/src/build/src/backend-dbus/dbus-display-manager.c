...
static const GDBusArgInfo * const _display_manager_seat_method_info_switch_to_user_IN_ARG_pointers[] =
{
  &_display_manager_seat_method_info_switch_to_user_IN_ARG_username.parent_struct,
  &_display_manager_seat_method_info_switch_to_user_IN_ARG_session_name.parent_struct,
  NULL
};
...
static const GDBusArgInfo * const _display_manager_seat_method_info_switch_to_guest_IN_ARG_pointers[] =
{
  &_display_manager_seat_method_info_switch_to_guest_IN_ARG_session_name.parent_struct,
  NULL
};
...
static const GDBusMethodInfo * const _display_manager_seat_method_info_pointers[] =
{
  &_display_manager_seat_method_info_switch_to_greeter.parent_struct,
  &_display_manager_seat_method_info_switch_to_user.parent_struct,
  &_display_manager_seat_method_info_switch_to_guest.parent_struct,
  &_display_manager_seat_method_info_lock.parent_struct,
  NULL
};
...
static const GDBusPropertyInfo * const _display_manager_seat_property_info_pointers[] =
{
  &_display_manager_seat_property_info_can_switch.parent_struct,
  &_display_manager_seat_property_info_has_guest_account.parent_struct,
  &_display_manager_seat_property_info_sessions.parent_struct,
  NULL
};
...
inline static void
display_manager_seat_method_marshal_switch_to_greeter (
    GClosure     *closure,
    GValue       *return_value,
    unsigned int  n_param_values,
    const GValue *param_values,
...
inline static void
display_manager_seat_method_marshal_switch_to_user (
    GClosure     *closure,
    GValue       *return_value,
    unsigned int  n_param_values,
    const GValue *param_values,
...
inline static void
display_manager_seat_method_marshal_switch_to_guest (
    GClosure     *closure,
    GValue       *return_value,
    unsigned int  n_param_values,
    const GValue *param_values,
...
inline static void
display_manager_seat_method_marshal_lock (
    GClosure     *closure,
    GValue       *return_value,
    unsigned int  n_param_values,
    const GValue *param_values,
...
{
  g_return_val_if_fail (IS_DISPLAY_MANAGER_SEAT (object), FALSE);
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use display_manager_seat_dup_sessions() if on another thread.
 *
...
{
  g_return_val_if_fail (IS_DISPLAY_MANAGER_SEAT (object), NULL);
...
void
display_manager_seat_complete_switch_to_greeter (
    DisplayManagerSeat *object G_GNUC_UNUSED,
...
G_DEFINE_TYPE_WITH_CODE (DisplayManagerSeatProxy, display_manager_seat_proxy, G_TYPE_DBUS_PROXY,
                         G_ADD_PRIVATE (DisplayManagerSeatProxy)
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = (const _ExtendedGDBusPropertyInfo *) _display_manager_seat_property_info_pointers[prop_id - 1];
...
display_manager_seat_proxy_get_sessions (DisplayManagerSeat *object)
{
  ...
  value = g_datalist_get_data (&proxy->priv->qdata, "Sessions");
  if (value != NULL)
    return value;
  ...
  if (variant != NULL)
    {
      ...
      g_datalist_set_data_full (&proxy->priv->qdata, "Sessions", (gpointer) value, g_free);
      g_variant_unref (variant);
    }
  return value;
}
...
{
#if GLIB_VERSION_MAX_ALLOWED >= GLIB_VERSION_2_38
  proxy->priv = display_manager_seat_proxy_get_instance_private (proxy);
#else
...
display_manager_seat_skeleton_dbus_interface_get_info (GDBusInterfaceSkeleton *skeleton G_GNUC_UNUSED)
{
  return display_manager_seat_interface_info ();
}

static GDBusInterfaceVTable *
display_manager_seat_skeleton_dbus_interface_get_vtable (GDBusInterfaceSkeleton *skeleton G_GNUC_UNUSED)
{
...
G_DEFINE_TYPE_WITH_CODE (DisplayManagerSeatSkeleton, display_manager_seat_skeleton, G_TYPE_DBUS_INTERFACE_SKELETON,
                         G_ADD_PRIVATE (DisplayManagerSeatSkeleton)
  ...
  GParamSpec *pspec G_GNUC_UNUSED)
{
  ...
  if (skeleton->priv->changed_properties != NULL &&
      skeleton->priv->changed_properties_idle_source == NULL)
    {
      ...
      g_source_set_name (skeleton->priv->changed_properties_idle_source, "[generated] _display_manager_seat_emit_changed");
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL &&
        ...
        _display_manager_seat_schedule_emit_changed (skeleton, info, prop_id, &skeleton->priv->properties[prop_id - 1]);
...
{
#if GLIB_VERSION_MAX_ALLOWED >= GLIB_VERSION_2_38
  skeleton->priv = display_manager_seat_skeleton_get_instance_private (skeleton);
#else
