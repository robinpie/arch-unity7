...
public interface GreeterBroadcast : Object {
  // methods
  // unused public abstract async void RequestApplicationStart(string name, string appid) throws GLib.Error;
  // unused public abstract async void RequestHomeShown(string name) throws GLib.Error;
