...
TEST_F(TestIndicator, DISABLED_PhoneCheckRootIcon)
{
    ...
    QStringList mutedIcon = {"audio-volume-muted-panel", "audio-volume-muted", "audio-volume", "audio", "audio-volume-muted-panel-symbolic", "audio-volume-muted-symbolic", "audio-volume-symbolic", "audio-symbolic"};
    EXPECT_EQ(getRootIconValue(), mutedIcon);

    QStringList lowVolumeIcon = {"audio-volume-low-panel", "audio-volume-low", "audio-volume", "audio", "audio-volume-low-panel-symbolic", "audio-volume-low-symbolic", "audio-volume-symbolic", "audio-symbolic"};
    ...
    QStringList mediumVolumeIcon = {"audio-volume-medium-panel", "audio-volume-medium", "audio-volume", "audio", "audio-volume-medium-panel-symbolic", "audio-volume-medium-symbolic", "audio-volume-symbolic", "audio-symbolic"};
    ...
    QStringList highVolumeIcon = {"audio-volume-high-panel", "audio-volume-high", "audio-volume", "audio", "audio-volume-high-panel-symbolic", "audio-volume-high-symbolic", "audio-volume-symbolic", "audio-symbolic"};
        ...
        .item(mh::MenuItemMatcher()
            ...
            .item(mh::MenuItemMatcher()
                ...
                .item(mh::MenuItemMatcher()
                    ...
                    .label("TestPlayer1")
                    .themed_icon("icon", {"testplayer", "testplayer-symbolic"})
