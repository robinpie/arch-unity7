...
struct _IndicatorMessagesServiceIface
{
  ...
  gboolean (*handle_application_stopped_running) (
...
void indicator_messages_service_complete_application_stopped_running (
    IndicatorMessagesService *object,
    GDBusMethodInvocation *invocation);
...
void indicator_messages_service_call_application_stopped_running (
    IndicatorMessagesService *proxy,
    const gchar *arg_desktop_id,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean indicator_messages_service_call_application_stopped_running_finish (
    IndicatorMessagesService *proxy,
    GAsyncResult *res,
    GError **error);

gboolean indicator_messages_service_call_application_stopped_running_sync (
    IndicatorMessagesService *proxy,
    const gchar *arg_desktop_id,
    GCancellable *cancellable,
    GError **error);
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC (IndicatorMessagesServiceProxy, g_object_unref)
#endif
...
#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (IndicatorMessagesServiceSkeleton, g_object_unref)
#endif
