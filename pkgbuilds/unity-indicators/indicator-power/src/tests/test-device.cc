...
TEST_F(DeviceTest, IconNames)
{
  ...
  g_object_set (o, INDICATOR_POWER_DEVICE_KIND, UP_DEVICE_KIND_LINE_POWER,
                   NULL);
  EXPECT_ICON_NAMES_EQ("unity-ac-adapter-symbolic;"
                       "unity-ac-adapter;"
                       "ac-adapter-symbolic;"
                       "ac-adapter",
                       device);
  ...
  g_object_set (o, INDICATOR_POWER_DEVICE_KIND, UP_DEVICE_KIND_MONITOR,
                   NULL);
  EXPECT_ICON_NAMES_EQ("unity-gpm-monitor-symbolic;"
                       "unity-gpm-monitor;"
  ...
  for (int i=0, n=G_N_ELEMENTS(devices); i<n; i++)
    {
      ...
      g_object_set (o, INDICATOR_POWER_DEVICE_KIND, kind,
                       ...
                       NULL);
      g_string_append_printf (expected, "unity-%s-empty-symbolic;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-empty;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-000;", kind_str);
      g_string_append_printf (expected, "unity-%s-empty;", kind_str);
      ...
      g_object_set (o, INDICATOR_POWER_DEVICE_KIND, kind,
                       ...
                       NULL);
      g_string_append_printf (expected, "unity-%s-full-charged-symbolic;", kind_str);
      g_string_append_printf (expected, "unity-%s-full-charging-symbolic;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-full;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-100;", kind_str);
      g_string_append_printf (expected, "unity-%s-full-charged;", kind_str);
      g_string_append_printf (expected, "unity-%s-full-charging;", kind_str);
      ...
      g_object_set (o, INDICATOR_POWER_DEVICE_KIND, kind,
                       ...
                       NULL);
      g_string_append_printf (expected, "unity-%s-100-charging;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-100-charging;", kind_str);
      ...
      g_string_append_printf (expected, "%s-full-charging-symbolic;", kind_str);
      g_string_append_printf (expected, "%s-full-charging;", kind_str);
      g_string_append_printf (expected, "unity-%s-100;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-100;", kind_str);
      g_string_append_printf (expected, "%s-100;", kind_str);
      g_string_append_printf (expected, "gpm-%s-100;", kind_str);
      g_string_append_printf (expected, "unity-%s-full-symbolic;", kind_str);
      g_string_append_printf (expected, "unity-%s-full;", kind_str);
      ...
      g_object_set (o, INDICATOR_POWER_DEVICE_KIND, kind,
                       ...
                       NULL);
      g_string_append_printf (expected, "unity-%s-090-charging;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-090-charging;", kind_str);
      g_string_append_printf (expected, "%s-090-charging;", kind_str);
      g_string_append_printf (expected, "gpm-%s-090-charging;", kind_str);
      g_string_append_printf (expected, "unity-%s-080-charging;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-080-charging;", kind_str);
      ...
      g_string_append_printf (expected, "%s-full-charging-symbolic;", kind_str);
      g_string_append_printf (expected, "%s-full-charging;", kind_str);
      g_string_append_printf (expected, "unity-%s-090;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-090;", kind_str);
      g_string_append_printf (expected, "%s-090;", kind_str);
      g_string_append_printf (expected, "gpm-%s-090;", kind_str);
      g_string_append_printf (expected, "unity-%s-080;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-080;", kind_str);
      ...
      g_object_set (o, INDICATOR_POWER_DEVICE_KIND, kind,
                       ...
                       NULL);
      g_string_append_printf (expected, "unity-%s-050-charging;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-050-charging;", kind_str);
      g_string_append_printf (expected, "%s-050-charging;", kind_str);
      g_string_append_printf (expected, "gpm-%s-050-charging;", kind_str);
      g_string_append_printf (expected, "unity-%s-060-charging;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-060-charging;", kind_str);
      g_string_append_printf (expected, "%s-060-charging;", kind_str);
      g_string_append_printf (expected, "gpm-%s-060-charging;", kind_str);
      g_string_append_printf (expected, "unity-%s-good-charging-symbolic;", kind_str);
      g_string_append_printf (expected, "unity-%s-good-charging;", kind_str);
      ...
      g_string_append_printf (expected, "unity-%s-050;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-050;", kind_str);
      g_string_append_printf (expected, "%s-050;", kind_str);
      g_string_append_printf (expected, "gpm-%s-050;", kind_str);
      g_string_append_printf (expected, "unity-%s-060;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-060;", kind_str);
      g_string_append_printf (expected, "%s-060;", kind_str);
      g_string_append_printf (expected, "gpm-%s-060;", kind_str);
      g_string_append_printf (expected, "unity-%s-good-symbolic;", kind_str);
      g_string_append_printf (expected, "unity-%s-good;", kind_str);
      ...
      g_object_set (o, INDICATOR_POWER_DEVICE_KIND, kind,
                       ...
                       NULL);
      g_string_append_printf (expected, "unity-%s-030-charging;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-030-charging;", kind_str);
      g_string_append_printf (expected, "%s-030-charging;", kind_str);
      g_string_append_printf (expected, "gpm-%s-030-charging;", kind_str);
      g_string_append_printf (expected, "unity-%s-040-charging;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-040-charging;", kind_str);
      g_string_append_printf (expected, "%s-040-charging;", kind_str);
      g_string_append_printf (expected, "gpm-%s-040-charging;", kind_str);
      g_string_append_printf (expected, "unity-%s-low-charging-symbolic;", kind_str);
      g_string_append_printf (expected, "unity-%s-low-charging;", kind_str);
      g_string_append_printf (expected, "%s-low-charging-symbolic;", kind_str);
      g_string_append_printf (expected, "%s-low-charging;", kind_str);
      g_string_append_printf (expected, "unity-%s-030;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-030;", kind_str);
      g_string_append_printf (expected, "%s-030;", kind_str);
      g_string_append_printf (expected, "gpm-%s-030;", kind_str);
      g_string_append_printf (expected, "unity-%s-040;", kind_str);
      ...
      g_string_append_printf (expected, "unity-%s-low-symbolic;", kind_str);
      g_string_append_printf (expected, "unity-%s-low;", kind_str);
      ...
      g_object_set (o, INDICATOR_POWER_DEVICE_KIND, kind,
                       ...
                       NULL);
      g_string_append_printf (expected, "unity-%s-010-charging;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-010-charging;", kind_str);
      g_string_append_printf (expected, "%s-010-charging;", kind_str);
      g_string_append_printf (expected, "gpm-%s-010-charging;", kind_str);
      g_string_append_printf (expected, "unity-%s-000-charging;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-000-charging;", kind_str);
      g_string_append_printf (expected, "%s-000-charging;", kind_str);
      g_string_append_printf (expected, "gpm-%s-000-charging;", kind_str);
      g_string_append_printf (expected, "unity-%s-caution-charging-symbolic;", kind_str);
      g_string_append_printf (expected, "unity-%s-caution-charging;", kind_str);
      ...
      g_string_append_printf (expected, "unity-%s-010;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-010;", kind_str);
      g_string_append_printf (expected, "%s-010;", kind_str);
      g_string_append_printf (expected, "gpm-%s-010;", kind_str);
      g_string_append_printf (expected, "unity-%s-000;", kind_str);
      g_string_append_printf (expected, "unity-gpm-%s-000;", kind_str);
      g_string_append_printf (expected, "%s-000;", kind_str);
      g_string_append_printf (expected, "gpm-%s-000;", kind_str);
      g_string_append_printf (expected, "unity-%s-caution-symbolic;", kind_str);
      g_string_append_printf (expected, "unity-%s-caution;", kind_str);
